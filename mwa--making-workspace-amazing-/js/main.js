const appData = {
  "brand": {
    "name": "MWA Projects",
    "tagline": "Innovative Spaces, Inspired Design",
    "category": "Commercial Interiors",
    "location": "United Kingdom",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Seamless Office Solutions",
    "title": "Effortlessly manage your office needs.",
    "description": "MWA Projects ensures compliance and provides 24/7 support while centralizing documentation for hassle-free management.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our professional photography captures real-world office transformations to inspire your next project."
      },
      {
        "title": "Clear Services",
        "description": "Our services are clearly categorized, ensuring clients understand offerings at a glance."
      },
      {
        "title": "Credibility",
        "description": "A strong hero image establishes our firm's credibility and expertise in commercial interiors."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive design and build solutions tailored for commercial and retail spaces.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Interior Design & Build",
        "description": "Craft bespoke interiors with our expert team, from concept to completion."
      },
      {
        "icon": "🛠",
        "title": "Facilities Maintenance",
        "description": "Ensure your facilities run smoothly with our 24/7 support and PPM scheduling."
      },
      {
        "icon": "🪑",
        "title": "Furniture Supply",
        "description": "Source and install the perfect furniture for your office or retail space."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "MWA Projects has been crafting exceptional commercial spaces in the UK for over two decades. We specialize in design, build, and maintenance.",
      "Our repeatable workflows and strong client focus make us a perfect fit for automated solutions that enhance transparency and efficiency."
    ],
    "image": "https://images.pexels.com/photos/5483233/pexels-photo-5483233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "MWA Projects transformed our office with precision and style. Their support is unmatched.",
        "name": "Sarah Douglas",
        "role": "Facilities Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "The team at MWA ensures compliance and ease of maintenance across all our sites.",
        "name": "James Turner",
  ...
  "visit": {
    ...
    "description": "Discover our projects across the UK, where innovation meets practicality.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Reach out to MWA Projects to discuss your next interior project and see how we can help.",
    "consent": "I consent to receiving communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline with AI",
    "description": "Enhance your operations with our AI-driven solutions.",
    "bullets": [
      "Automate PPM scheduling and reminders.",
      "Track jobs with a client portal.",
      "Efficient helpdesk automation."
    ],
    "offer": "Mention MWA Projects for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "MWA Projects delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
