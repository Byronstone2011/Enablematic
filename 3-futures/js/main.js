const appData = {
  "brand": {
    ...
    "category": "Building & Property Services",
    "location": "Unknown",
    "phone": "01489 332061"
  },
  "hero": {
    "eyebrow": "Quality & Innovation",
    "title": "Simplify your property projects today",
    "description": "3 Futures offers seamless online booking and instant quotes. Experience the future of building services with us.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our team ensures every project meets the highest standards of quality."
      },
      {
        "title": "Proven Technology",
        "description": "We leverage cutting-edge technology for innovative property solutions."
      },
      {
        "title": "Trust & Reliability",
        "description": "Accreditations and high client ratings back our commitment to excellence."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services tailored to your needs, from installations to construction.",
    "cards": [
      {
        "icon": "⚡",
        "title": "Electrical Installations",
        "description": "Safe and efficient electrical systems tailored for your properties."
      },
      {
        "icon": "🚿",
        "title": "Plumbing",
      ...
      },
      {
        "icon": "🏗",
        "title": "Construction",
        "description": "Comprehensive construction services for any project scale."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "3 Futures began with a vision for quality and innovative building services. We serve diverse sectors, ensuring every project is a success.",
      "Our integration of technology enhances client experiences, making 3 Futures a leader in property solutions. Trust us to transform your spaces."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "3 Futures transformed our workspace efficiently and professionally. Highly recommend!",
        "name": "John Smith",
        "role": "Office Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "The online booking and quick quotes made managing our project a breeze.",
        "name": "Lisa Green",
        "role": "Homeowner",
  ...
  "visit": {
    "eyebrow": "Find Us",
    "title": "Our Location",
    "description": "Visit us at our office to discuss your project needs.",
    "address": "Unknown",
    "website": "www.3futures.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us Today",
    "description": "Reach out for consultations or to book a service.",
  ...
  "byronCallout": {
    ...
    "bullets": [
      "Streamline bookings with our online system.",
      "Get instant service quotes with our tool.",
      "Automated follow-ups keep you updated."
    ],
    "offer": "Mention 3 Futures for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "3 Futures delivers unforgettable experiences.",
    "address": "Unknown",
    "email": "",
    "socials": [
      {
