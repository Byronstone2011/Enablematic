const appData = {
  "brand": {
    "name": "MARCH PROJECTS",
    "tagline": "Steel Structures, Built Right",
    "category": "Construction",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Steel Frame Experts",
    "title": "Navigate building regulations effortlessly",
    "description": "We design, manufacture, and erect steel buildings, ensuring durability and timely completion.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Experience your project in detail with our stunning 3D visualizations."
      },
      {
        "title": "Proven Expertise",
        "description": "Our team brings decades of experience, delivering excellence in every build."
      },
      {
        "title": "Strong Reputation",
        "description": "Our projects across the UK showcase our commitment to quality and trust."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Expertly crafted steel frame solutions for diverse sectors.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Bespoke Buildings",
        "description": "Custom design and manufacture of steel frames for agriculture, industry, and equestrian uses."
      },
      {
        "icon": "🔧",
        "title": "Turnkey Projects",
        "description": "Complete project delivery from materials to construction, ensuring a seamless process."
      },
      {
        "icon": "🛠",
        "title": "Maintenance & Repairs",
        "description": "Regular upkeep and refurbishment to extend the life of your building."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded with a vision to revolutionize steel frame buildings, we cater to agricultural, industrial, and equestrian sectors.",
      "We excel in delivering bespoke projects, leveraging digital automation for seamless planning and execution."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "MARCH PROJECTS streamlined our build process, saving us time and money.",
        "name": "Sarah Thompson",
        "role": "Farm Manager",
        "avatar": "https://images.pexels.com/photos/17482906/pexels-photo-17482906.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their expertise in navigating regulations was invaluable for our new facility.",
        "name": "John Peters",
        "role": "Equestrian Center Owner",
        "avatar": "https://images.unsplash.com/photo-1556989173-59258cf988b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlRTIlODAlOTQlMjBzdGVlbCUyMGZyYW1lJTIwYWdyaWN1bHR1cmFsJTJDJTIwaW5kdXN0cmlhbCUyMGFuZCUyMGVxdWVzdHJpYW4lMjBidWlsZGluZ3MlMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODc1NXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "title": "Visit Us",
    "description": "Explore our projects across the UK, showcasing our quality and expertise.",
    "address": "UK",
    "website": "www.marchprojects.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Contact Us Today",
    "description": "Reach out for a consultation or quote on your next project.",
    "consent": "By submitting, you agree to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation Excellence",
    "description": "Enhancing efficiency with cutting-edge technology.",
    "bullets": [
      "Automated quoting speeds up project estimates.",
      "CRM tracks prospects, improving engagement.",
      "Digital tools for easy building customization."
    ],
    "offer": "Mention MARCH PROJECTS for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "MARCH PROJECTS delivers unforgettable experiences.",
    "address": "UK",
    "email": "",
    "socials": [
      {
