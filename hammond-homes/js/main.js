const appData = {
  "brand": {
    ...
    "category": "Residential Homebuilder",
    "location": "Hull & Humber, UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Luxurious New-Builds",
    "title": "Streamline Your Home Buying Experience",
    "description": "Discover personalized luxury homes with seamless purchasing. We simplify your journey.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/31370888/pexels-photo-31370888.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our professional images bring your dream home to life, showcasing every detail."
      },
      {
        "title": "Clear Information",
        "description": "We present clear, organized info to guide you through your home buying journey."
      },
      {
        "title": "Trust & Stability",
        "description": "Our consistent design conveys reliability, ensuring peace of mind for buyers."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our comprehensive range of services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Land & Development",
        "description": "Expert land sourcing and property development for prime locations."
      },
      {
        "icon": "🏠",
        "title": "Luxury New-Builds",
        "description": "Design and build of exquisite new homes, tailored to your vision."
      },
      {
        "icon": "🛋",
        "title": "Home Customization",
        "description": "Personalize with bespoke bathrooms, designer kitchens, and more."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Hammond Homes offers luxurious new builds in Hull & Humber. Personalize your dream home with top-notch features.",
      "Our brand's scale and credibility ensure seamless workflow and high lead conversions for a customized home experience."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Hammond Homes made the buying process easy and stress-free. Their attention to detail is unmatched.",
        "name": "Alice Johnson",
      ...
      {
        "quote": "The customization options were fantastic. We love our bespoke kitchen and fitted bedroom.",
        "name": "Mark Thompson",
        "role": "Happy Buyer",
        "avatar": "https://images.unsplash.com/photo-1730963477258-78f199bf79d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxSZXNpZGVudGlhbCUyMGhvbWVidWlsZGluZyUyMCUyRiUyME5ldy1idWlsZCUyMGhvdXNlJTIwZGV2ZWxvcGVyJTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI3MjU1ODR8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Our Showroom",
    "description": "Explore our showcase homes and see the luxury firsthand in Hull & the Humber.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us today to start your journey to a luxury home.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation Benefits",
    "description": "Enhance your home buying experience with cutting-edge automation.",
    "bullets": [
      "Automate lead capture for efficient follow-ups.",
      "Book viewings or consultations online quickly.",
      "Personalize finishes with an online configurator."
    ],
    "offer": "Mention Hammond Homes for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Hammond Homes delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
