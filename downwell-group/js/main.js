const appData = {
  "brand": {
    "name": "Downwell Group",
    "tagline": "Your Civils Enabling Partner",
  ...
  "hero": {
    ...
    "title": "Streamline your site preparation with ease.",
    "description": "Downwell Group ensures timely site readiness, regulatory compliance, and sustainability reporting for your projects.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We handle complex schedules across trades, minimizing risks of delays."
      },
      {
        "title": "Regulatory Compliance",
        "description": "Our team ensures all safety standards are met, reducing project risks."
      },
      {
        "title": "Sustainability Focus",
        "description": "We provide detailed waste tracking and reporting for sustainability goals."
      }
    ]
  },
  "offerings": {
    ...
    "cards": [
      {
        "icon": "🏗",
        "title": "Groundworks",
        "description": "Prepare your site with precision and reliability for any project scale."
      },
      {
        "icon": "🔨",
        "title": "Demolition",
        "description": "Safe and efficient demolition services to clear the way for new builds."
      },
      {
        "icon": "🛠",
        "title": "Asbestos Removal",
        "description": "Licensed removal ensuring safety and compliance in hazardous environments."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Downwell Group has been a leader in civils enabling, providing comprehensive site preparation solutions throughout London and the South East.",
      "Our focus on automation and compliance makes us the ideal partner for developers needing efficient project management and sustainable practices."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Downwell Group's efficient coordination kept our project on track and compliant.",
        "name": "Sarah Johnson",
        "role": "Project Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their waste tracking system helped us achieve our sustainability targets.",
        "name": "Tom Williams",
  ...
  "visit": {
    ...
    "description": "Meet us in London and the South East to discuss your next project.",
    "address": "",
    "website": "www.downwell.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request a Consultation",
    "description": "Contact us today to discuss your project needs and how we can assist.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate for Efficiency",
    "description": "Leverage our technology to streamline your construction projects.",
    "bullets": [
      "Instant online quotes for faster project planning.",
      "Integrated CRM for seamless coordination and updates.",
      "Automated compliance and safety documentation."
    ],
    "offer": "Mention Downwell Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Downwell Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
