const appData = {
  "brand": {
    "name": "J. Robertshaw",
    "tagline": "Bespoke shading solutions",
    "category": "Retail",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Custom shading solutions",
    "title": "Streamline your shading with ease.",
    "description": "Our bespoke awnings and blinds simplify orders and installation. Enjoy seamless service.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We showcase our work with full-width images for a lasting impression."
      },
      {
        "title": "Minimalist Design",
        "description": "Our clean layouts highlight our products without distractions."
      },
      {
        "title": "Credible Testimonials",
        "description": "Client stories reinforce trust in our products and services."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our range of tailored shading solutions, designed for excellence.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Bespoke Awnings",
        "description": "Custom-designed awnings to fit any space, crafted with precision."
      },
      {
        "icon": "🛡",
        "title": "Blinds",
        "description": "Stylish blinds that add elegance and privacy to your windows."
      },
      {
        "icon": "🧰",
        "title": "Motorised Awnings",
        "description": "Automated awning solutions for ultimate convenience and control."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "James Robertshaw designs and crafts bespoke awnings and blinds for trade, commercial and property clients.",
      "We modernize your spaces with innovative solutions, meeting unique needs with expert craftsmanship."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "James Robertshaw transformed our shop with stunning awnings. Seamless process!",
        "name": "Alex Moore",
        "role": "Market Vendor",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their bespoke blinds perfectly fit our home. Excellent service!",
        "name": "Lisa Johnson",
        "role": "Homeowner",
  ...
  "visit": {
    ...
    "description": "Explore our range of products and consult with our experts.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us to discuss your bespoke shading needs.",
  ...
  "byronCallout": {
    ...
    "bullets": [
      "Online quoting tool for custom orders.",
      "Automated scheduling and tracking.",
      "CRM integration for seamless follow-ups."
    ],
    "offer": "Mention J. Robertshaw for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "J. Robertshaw delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
