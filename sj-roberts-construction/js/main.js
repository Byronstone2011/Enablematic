const appData = {
  "brand": {
    ...
    "location": "Shropshire & Mid",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Leading Contractors",
    "title": "Streamline your projects with our expertise.",
    "description": "SJ Roberts optimizes project efficiency with advanced management and communication solutions.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our skilled team ensures quality in every build, using top techniques."
      },
      {
        "title": "Stunning Visuals",
        "description": "Professional photography showcases our completed projects beautifully."
      },
      {
        "title": "Seamless Navigation",
        "description": "Our user-friendly site design makes finding information easy."
      }
    ]
  },
  "offerings": {
    ...
    "cards": [
      {
        ...
        "description": "We create stunning homes with precision and care for every client."
      },
      {
        "icon": "🏢",
        "title": "Commercial Projects",
        "description": "Transform spaces for businesses with our expert construction solutions."
      },
      {
        "icon": "🏭",
        "title": "Industrial Developmen",
        "description": "Specializing in large-scale industrial projects and efficient delivery."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "SJ Roberts Construction Ltd is the premier contractor in Shropshire and Mid Wales. We deliver quality across all sectors.",
      "Our expertise in managing projects ensures seamless delivery and client satisfaction. We focus on every development stage."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "SJ Roberts streamlined our project with excellent communication and efficiency.",
        "name": "John Davies",
        "role": "Property Developer",
        "avatar": "https://images.pexels.com/photos/6474481/pexels-photo-6474481.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their professionalism and attention to detail were outstanding.",
        "name": "Sarah Lewis",
        "role": "Homeowner",
  ...
  "visit": {
    ...
    "description": "Explore our projects in the beautiful Shropshire and Mid Wales area.",
    "address": "",
    "website": "www.sjroberts.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Contact Us Today",
    "description": "Reach out to plan your next project with our experienced team.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Projects",
    "description": "Leverage AI to enhance efficiency and client communication.",
    "bullets": [
      "Use online forms for quick quotes and lead capture.",
      "Implement CRM for automated lead nurturing.",
      "Coordinate teams with automated task management."
    ],
    "offer": "Mention SJ Roberts for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "SJ Roberts delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
