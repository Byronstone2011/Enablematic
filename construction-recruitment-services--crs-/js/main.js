const appData = {
  "brand": {
    "name": "CRS LTD",
    "tagline": "Find skilled workers fast",
    "category": "Construction Recruitment",
    "location": "UK",
    "phone": "0800-123-4567"
  },
  "hero": {
    "eyebrow": "Efficient Staffing Solutions",
    "title": "Quickly find and retain top talent.",
    "description": "We streamline recruitment, manage temp assignments, and maintain an updated candidate pool.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Expert Team",
        "description": "Our experienced recruiters understand the industry nuances."
      },
      {
        "title": "Job Board Access",
        "description": "Navigate our user-friendly job board to find the perfect match."
      },
      {
        "title": "Trusted Partners",
        "description": "We work with reputable partners to ensure quality placements."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our recruitment services cater to diverse construction needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Permanent Hire",
        "description": "We provide direct hire solutions for long-term needs."
      },
      {
        "icon": "🛠",
        "title": "Freelance Labor",
        "description": "Flexible staffing for temporary and project-based roles."
      },
      {
        "icon": "📊",
        "title": "Account Management",
        "description": "Dedicated support to ensure a seamless recruitment process."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded to bridge the gap in construction recruitment, we excel in connecting skilled workers with leading contractors.",
      "With our focus on innovation and automation, we enhance efficiency, reduce manual tasks, and speed up placements."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "CRS helped us fill critical positions quickly and efficiently.",
        "name": "John Smith",
        "role": "Project Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their expertise in sourcing talent is unmatched in the industry.",
        "name": "Emily Davis",
        "role": "HR Director",
  ...
  "visit": {
    ...
    "description": "Join us in the heart of the UK for personalized recruitment solutions.",
    "address": "123 Construction Lane, London, UK",
    "website": "www.crservicesuk.net",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Request a Consultation",
    "description": "Contact us for tailored recruitment strategies.",
    "consent": "Your data is secure with us."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Harness the Power of AI",
    "description": "Optimize recruitment with AI-driven solutions.",
    "bullets": [
      "Automated candidate sourcing expands reach.",
      "ATS speeds up candidate screening.",
      "Automated job alerts engage candidates."
    ],
    "offer": "Mention CRS LTD for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "CRS LTD delivers unforgettable experiences.",
    "address": "123 Construction Lane, London, UK",
    "email": "",
    "socials": [
      {
