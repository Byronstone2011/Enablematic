const appData = {
  "brand": {
    "name": "Now Construction",
    "tagline": "Integrity in every project",
  ...
  "hero": {
    ...
    "description": "We simplify complex builds with expert solutions tailored to your needs. Partner with us for seamless results.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/5693845/pexels-photo-5693845.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Decades of experience ensure projects are completed on time and on budget."
      },
      {
        "title": "Trusted Partnerships",
        "description": "Collaborating closely with clients builds trust and lasting relationships."
      },
      {
        "title": "Innovative Solutions",
        "description": "We deliver tailored, cutting-edge approaches to meet client needs."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services for construction, fit-outs, and refurbishments.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Structural Alterations",
        "description": "Expert changes to buildings for improved functionality and design."
      },
      {
        "icon": "🎨",
        "title": "Fit-outs & Decorations",
        "description": "Transform interiors with precision and style for any business or institution."
      },
      {
        "icon": "🛋",
        "title": "Specialist Furniture",
        "description": "Supply and installation of custom furniture for tailored spaces."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Now Construction Limited has built a reputation for integrity and precision. Decades of expertise empower us to deliver every project seamlessly.",
      "We specialize in complex builds for schools, trusts, and commercial properties, offering tailored solutions that exceed expectations."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Now Construction transformed our school with minimal disruption and outstanding results.",
        "name": "Helen Johnson",
        "role": "Headteacher",
        "avatar": "https://images.pexels.com/photos/17482906/pexels-photo-17482906.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their dedication and precision made our fit-out project a success. Highly recommended!",
        "name": "Mark Davis",
        "role": "Facility Manager",
        "avatar": "https://images.unsplash.com/photo-1646227655718-dd721b681d91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMkYlMjBCdWlsZGluZyUyMCUyNiUyMEZpdC1vdXQlMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjM4MDA3OXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Explore our portfolio to see how we bring visions to life across the UK.",
    "address": "Available upon request",
    "website": "www.nowconstruction.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in touch",
    "title": "Start your project today",
    "description": "Contact us for expert consultations and tailored solutions for your build.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline construction management",
    "description": "Harness AI to simplify project processes and improve efficiency.",
    "bullets": [
      "Automate project quotes and proposals.",
      "Integrate CRM for seamless client tracking.",
      "Keep clients updated with automated scheduling."
    ],
    "offer": "Mention Now Construction for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Now Construction delivers unforgettable experiences.",
    "address": "Available upon request",
    "email": "",
    "socials": [
      {
