const appData = {
  "brand": {
    "name": "V3 Group",
    "tagline": "Elevating Construction",
  ...
  "hero": {
    ...
    "title": "Simplify facade projects and compliance.",
    "description": "V3 Group excels in facade projects with seamless coordination and compliance solutions.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We use a strong minimalist aesthetic to stand out."
      },
      {
        "title": "Professional Imagery",
        "description": "Showcase projects with stunning architectural photos."
      },
      {
        "title": "Modern Elements",
        "description": "Innovative geometric design enhances our presentations."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive facade and roofing services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Façade Contracting",
        "description": "Principal contractor for all facade needs."
      },
      {
        "icon": "🔧",
        "title": "Roofing & Cladding",
        "description": "Expert roofing and cladding solutions."
      },
      {
        "icon": "🔍",
        "title": "Glazing Systems",
        "description": "Advanced commercial glazing installations."
      }
    ]
  },
  "story": {
    ...
    "title": "Meet V3 Group",
    "paragraphs": [
      "Led by Tom Gent, V3 Group is a leader in construction, driven by skilled professionals with vast experience.",
      "We are a perfect fit for tech-enhanced projects, focusing on compliance, coordination, and sustainability."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "V3 Group streamlined our facade project, addressing every compliance concern superbly.",
        "name": "Alex Thompson",
        "role": "Property Developer",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their glazing systems were installed with precision and speed, meeting all our needs.",
        "name": "Samantha Lee",
        "role": "Architect",
  ...
  "visit": {
    ...
    "description": "Located in the heart of the UK, we offer easy access for all clients.",
    "address": "Unknown",
    "website": "v3-group.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us",
    "description": "Reach out today to discuss your project needs.",
    "consent": "I agree to the terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline with AI",
    "description": "Harness AI to transform your construction process.",
    "bullets": [
      "Centralized compliance management.",
      "Automated lead capture and follow-ups.",
      "Digital quoting and client portal."
    ],
    "offer": "Mention V3 Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "V3 Group delivers unforgettable experiences.",
    "address": "Unknown",
    "email": "",
    "socials": [
      {
