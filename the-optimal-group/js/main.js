const appData = {
  "brand": {
    "name": "The Optimal Group",
    "tagline": "Property Development Redefined",
    "category": "Real Estate",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Effortless property solutions",
    "title": "Sell fast, stress-free, and profitably.",
    "description": "We simplify property sales and development, minimizing hassle and maximizing returns.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our projects feature captivating designs and superior craftsmanship."
      },
      {
        "title": "Solid Reputation",
        "description": "Clients trust our consistent quality and dedication to excellence."
      },
      {
        "title": "Seamless Experience",
        "description": "We deliver smooth transactions with our expertise and resources."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our comprehensive property services designed to meet your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Residential Development",
        "description": "We create vibrant living spaces that enhance communities."
      },
      {
        "icon": "🏢",
        "title": "Mixed-Use Projects",
        "description": "Our developments blend commercial and residential spaces seamlessly."
      },
      {
        "icon": "💼",
        "title": "Property Acquisition",
        "description": "We help landlords sell properties quickly and efficiently."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded to transform property development, we focus on innovative solutions that meet market needs.",
      "Our expertise in automation and strategy ensures optimal results for every project."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Selling my rental property was hassle-free with The Optimal Group. Highly recommend!",
        "name": "Sarah Johnson",
        "role": "Landlord",
        "avatar": "https://images.pexels.com/photos/34558071/pexels-photo-34558071.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their mixed-use project exceeded our expectations. A seamless process!",
        "name": "Michael Lee",
        "role": "Investor",
        "avatar": "https://images.unsplash.com/photo-1760802136542-0cefb143f1f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxSZWFsJTIwZXN0YXRlJTIwJTJGJTIwUHJvcGVydHklMjBkZXZlbG9wbWVudCUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNzI1NTQ4fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Discover our projects and experience the quality we offer firsthand.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Reach out to discuss your property needs and discover our solutions.",
    "consent": "Yes, I agree to the terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Sales",
    "description": "Automate processes to save time and boost efficiency.",
    "bullets": [
      "Instant property value assessments.",
      "Automated lead management for faster responses.",
      "E-signatures for quick, secure transactions."
    ],
    "offer": "Mention The Optimal Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "The Optimal Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
