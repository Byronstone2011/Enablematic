const appData = {
  "brand": {
    "name": "German Kitchens",
    "tagline": "Design Elegance, German Precision",
    "category": "Kitchen Retail",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Bespoke German Kitchens",
    "title": "Seamless design and installation solutions",
    "description": "Experience the precision of German engineering. Book appointments online for personalized consultations.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our consistent red accents showcase a strong brand identity."
      },
      {
        "title": "Quality Photography",
        "description": "High-quality images highlight our stunning kitchen designs."
      },
      {
        "title": "Organized Content",
        "description": "Clear hierarchy makes finding information a breeze."
      }
    ]
  },
  "offerings": {
    ...
    "description": "High-end German kitchen solutions tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "German Kitchens",
        "description": "Supplying top-tier German cabinetry and components."
      },
      {
        "icon": "💼",
        "title": "Design Consultations",
        "description": "Schedule a viewing to explore our bespoke designs."
      },
      {
        "icon": "🔧",
        "title": "Installation & Manage",
        "description": "Our team ensures flawless installation and project oversight."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Perfect Kitchens",
    "paragraphs": [
      "Founded to deliver the elegance of German kitchens to UK homes, we pride ourselves on quality and precision.",
      "We blend showroom experiences with digital solutions, ensuring seamless service from consultation to completion."
    ],
    "image": "https://images.pexels.com/photos/15124970/pexels-photo-15124970.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "German Kitchen Projects transformed my kitchen into a masterpiece.",
        "name": "Emily Richards",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/8978598/pexels-photo-8978598.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their design expertise and management made our project stress-free.",
        "name": "David Thompson",
  ...
  "visit": {
    ...
    "description": "Discover our exquisite kitchens in person at our UK showrooms.",
    "address": "Available upon appointment",
    "website": "germankitchenprojects.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Book a Consultation",
    "description": "Contact us to schedule your personalized kitchen consultation.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline with Automation",
    "description": "Enhance your experience with our automated solutions.",
    "bullets": [
      "Automated booking for easy appointments.",
      "Lead capture forms to keep in touch.",
      "Email follow-ups for promotions and updates."
    ],
    "offer": "Mention German Kitchens for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "German Kitchens delivers unforgettable experiences.",
    "address": "Available upon appointment",
    "email": "",
    "socials": [
      {
