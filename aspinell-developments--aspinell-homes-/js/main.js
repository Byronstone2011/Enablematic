const appData = {
  "brand": {
    "name": "Aspinell Homes",
    "tagline": "Crafting Bespoke Living Spaces",
    "category": "Property Development",
    "location": "London, Essex, Ken",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Design-conscious builds",
    "title": "Transforming living spaces with precision.",
    "description": "Streamline land acquisition and enhance buyer experiences with automated solutions.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our projects harmonize with their localities, maximizing living space beauty."
      },
      {
        "title": "Exceptional Quality",
        "description": "We maintain high standards in every build, ensuring durability and style."
      },
      {
        "title": "Customer Focused",
        "description": "We prioritize client satisfaction with comprehensive aftercare services."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our bespoke housing solutions and comprehensive services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "New-Build Development",
        "description": "We create bespoke homes that maximize living space in urban areas."
      },
      {
        "icon": "🔨",
        "title": "In-House Construction",
        "description": "Our team delivers high-quality construction and site management."
      },
      {
        "icon": "🏡",
        "title": "Land Acquisition",
        "description": "We provide expertise in land acquisition and feasibility assessments."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Aspinell Homes specializes in creating bespoke housing in London, Essex, and Kent. We ensure our designs fit seamlessly into their environments.",
      "Our full lifecycle approach allows us to innovate and improve lead-to-sale conversions. We enhance the buyer experience with efficient processes."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Aspinell transformed our land into a beautiful development, exceeding our expectations.",
        "name": "Sarah J.",
        "role": "Land Owner",
        "avatar": "https://images.pexels.com/photos/34558071/pexels-photo-34558071.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their attention to detail and customer service made buying a new home a pleasure.",
        "name": "David R.",
        "role": "Home Buyer",
        "avatar": "https://images.unsplash.com/photo-1738929185055-3dfc9e924823?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxSZXNpZGVudGlhbCUyMHByb3BlcnR5JTIwZGV2ZWxvcG1lbnQlMjAlMjYlMjBjb25zdHJ1Y3Rpb24lMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODMwNXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Explore Our Sites",
    "title": "Visit Our Developments",
    "description": "Discover our latest projects in thriving communities across the region.",
    "address": "London, Essex, Kent",
    "website": "www.aspinell.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Schedule a Consultation",
    "description": "Contact us to discuss your property development needs.",
    "consent": "By submitting, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation Excellence",
    "description": "Enhance efficiency and customer satisfaction with our AI-driven solutions.",
    "bullets": [
      "Automated lead qualification improves sales conversion.",
      "Online booking streamlines site visits and showings.",
      "Automated land appraisal speeds up transactions."
    ],
    "offer": "Mention Aspinell Homes for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Aspinell Homes delivers unforgettable experiences.",
    "address": "London, Essex, Kent",
    "email": "",
    "socials": [
      {
