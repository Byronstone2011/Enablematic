const appData = {
  "brand": {
    "name": "Wainwright & Co",
    "tagline": "Building the South West",
    "category": "Construction Materials",
    "location": "South West",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Trusted since 1891",
    "title": "Streamlining your construction needs",
    "description": "We simplify ordering and compliance with efficient digital solutions, ensuring reliable service.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We showcase real operations to build trust with clients and partners."
      },
      {
        "title": "Clear Information",
        "description": "Our site presents information clearly, aiding decision-making for your projects."
      },
      {
        "title": "Professional Palette",
        "description": "Our color choices ensure readability and highlight key actions."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Delivering top-quality materials and services for your projects.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Aggregate Processing",
        "description": "We extract and process premium basalt for all construction needs."
      },
      {
        "icon": "🛣",
        "title": "Asphalt Supply",
        "description": "Our asphalt is produced and supplied with precision and reliability."
      },
      {
        "icon": "🚧",
        "title": "Surfacing Services",
        "description": "We provide expert surfacing for highways and civil works."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Since 1891, John Wainwright & Co Ltd has been dedicated to quality service in the South West. Our legacy is built on trust and reliability.",
      "Our B2B processes align with modern solutions, optimizing operations and ensuring compliance. We bring efficiency to construction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Wainwright's digital solutions made our ordering process seamless and efficient.",
        "name": "Sarah Jenkins",
        "role": "Infrastructure Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their commitment to quality and service is unmatched in the industry.",
        "name": "Mark Thompson",
  ...
  "visit": {
    ...
    "description": "Explore our services in the heart of the South West, where tradition meets innovation.",
    "address": "",
    "website": "www.wainwright.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Ready to Start?",
    "description": "Contact us for consultations or to place an order. We're here to help.",
    "consent": "I agree to the processing of my data."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Operations",
    "description": "Leverage AI to enhance efficiency and streamline processes.",
    "bullets": [
      "Online quoting and e-signatures simplify contracts.",
      "Automate delivery scheduling and notifications.",
      "Streamline compliance reporting with dashboards."
    ],
    "offer": "Mention Wainwright & Co for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Wainwright & Co delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
