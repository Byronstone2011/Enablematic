const appData = {
  "brand": {
    ...
    "tagline": "Affordable kitchen updates",
    "category": "Home Improvement",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Affordable Renovations",
    "title": "Transform your kitchen quickly and affordably.",
    "description": "Say goodbye to costly and messy renovations. We offer stylish, affordable solutions with minimal disruption.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/8134772/pexels-photo-8134772.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our layouts showcase transformations with a clean, professional touch."
      },
      {
        "title": "High-Quality Imagery",
        "description": "See the beauty of our makeovers through vivid, high-quality images."
      },
      {
        "title": "Clear Service Breakdown",
        "description": "Understand our services easily with detailed, card-based layouts."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Choose from our variety of kitchen services tailored to your needs.",
    "cards": [
      {
        "icon": "👨",
        "title": "Cabinet Refacing",
        "description": "Refresh your kitchen with our cabinet refacing and replacement doors."
      },
      {
        "icon": "🛠",
        "title": "Worktop Supply & Fit",
        "description": "Get beautiful worktops in laminate, quartz, stone, or wood."
      },
      {
        "icon": "🚰",
        "title": "Sinks & Accessories",
        "description": "Upgrade with our range of sinks, taps, and kitchen accessories."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Story",
    "title": "A Passion for Kitchens",
    "paragraphs": [
      "Kitchen Makeovers offers affordable solutions in the UK. Discover new kitchens, renovations, and doors.",
      "With repeatable, high-leverage services, our automation ensures efficiency and satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Kitchen Makeovers transformed our space swiftly and affordably. Highly recommend!",
        "name": "Emily Brown",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/7217987/pexels-photo-7217987.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their quick, clean process made renovating a breeze. Fantastic results!",
        "name": "Mark Thompson",
        "role": "Landlord",
        "avatar": "https://images.unsplash.com/photo-1639036910954-27b2fe434fb1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxLaXRjaGVuJTIwcmVub3ZhdGlvbiUyMCUyRiUyMGhvbWUlMjBpbXByb3ZlbWVudCUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4NjI1fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "See our transformations and consult with experts about your kitchen dreams.",
    "address": "",
    "website": "kitchenmakeovers.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Book a Consultation",
    "description": "Contact us for a free on-site quote and consultation today.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Makeover",
    "description": "Harness AI for a seamless renovation journey.",
    "bullets": [
      "Schedule online with calendar integration.",
      "Get instant quotes with our pricing tool.",
      "Visualize with our digital product configurator."
    ],
    "offer": "Mention Kitchen Makeovers for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Kitchen Makeovers delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
