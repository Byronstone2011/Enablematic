const appData = {
  "brand": {
    ...
    "location": "Aberdeeshire, Mora",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Bespoke home builders",
    "title": "Streamlined, custom home solutions",
    "description": "We ease your home building process with tailored solutions, efficient communications, and skilled workforce.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We showcase clear service visuals with organized content that guides you smoothly."
      },
      {
        "title": "Proven Track Record",
        "description": "Our successful projects and happy clients testify to our exceptional craftsmanship."
      },
      {
        "title": "Client Focused",
        "description": "Our priority is your satisfaction through personalized and transparent service."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our bespoke services cater to all your home building needs, from design to completion.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Home Design & Build",
        "description": "Tailor-made solutions from concept to completion, ensuring a perfect fit for you."
      },
      {
        "icon": "📐",
        "title": "Architectural Design",
        "description": "We provide comprehensive design and drawings to bring your vision to life."
      },
      {
        "icon": "🛠",
        "title": "Project Management",
        "description": "Expert management to ensure your project runs smoothly and on schedule."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Building Dreams, Crafting Homes",
    "paragraphs": [
      "Excel Scotland specializes in bespoke homes across Aberdeeshire, Moray, and Inverness. We offer comprehensive solutions from design to turnkey developments.",
      "Our tailored approach and skilled team ensure quality and satisfaction. We address communication and staffing challenges with innovative solutions."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Excel Scotland made our dream home a reality with their seamless process and expert team.",
        "name": "John Doe",
        "role": "Homeowner",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their project management was outstanding, keeping us informed every step of the way.",
        "name": "Jane Smith",
        "role": "Landowner",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Explore Our Region",
    "description": "Discover the scenic beauty and rich heritage of Aberdeeshire, Moray, and Inverness while building your dream home.",
    "address": "",
  ...
  "inquiry": {
    ...
    "description": "Contact us today to discuss your bespoke home project and transform your vision into reality.",
    "consent": "I agree to the terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance with Automation",
    "description": "Leverage AI to streamline your home building process and improve client interactions.",
    "bullets": [
      "Automate lead capture and follow-ups for better conversion.",
      "Offer online booking and quoting tools for convenience.",
      "Use a client portal for real-time project updates."
    ],
    "offer": "Mention Excel Scotland for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Excel Scotland delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
