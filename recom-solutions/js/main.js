const appData = {
  "brand": {
    "name": "RECOM Solutions",
    "tagline": "Your Maintenance Experts",
    "category": "Construction Services",
    "location": "United Kingdom",
    "phone": "+44 123 456 7890"
  },
  "hero": {
    "eyebrow": "Reliable Maintenance",
    "title": "Efficiently Manage Defects and Emergencies",
    "description": "We streamline defect management and rapid repairs, ensuring high satisfaction and swift response.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our projects showcase a strong visual hierarchy for clarity and impact."
      },
      {
        "title": "Credibility Focus",
        "description": "We build trust with an extensive display of accreditations."
      },
      {
        "title": "Professional Aesthetic",
        "description": "Our clean design and consistent branding enhance professionalism."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services to manage all your construction maintenance needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "General Maintenance",
        "description": "Routine upkeep and defect rectification for sustained quality."
      },
      {
        "icon": "⚙️",
        "title": "Emergency Response",
        "description": "24/7 rapid response for unexpected issues and emergencies."
      },
      {
        "icon": "🔍",
        "title": "Warranty Management",
        "description": "Efficiently handle NHBC claims and warranty support."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "RECOM Solutions was founded to provide unmatched construction aftercare. We focus on quality and reliability.",
      "Our expertise in automated solutions enhances efficiency, ensuring peace of mind for all stakeholders."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "RECOM's quick defect resolution saved us time and maintained our reputation.",
        "name": "Sarah Johnson",
        "role": "Property Manager",
        "avatar": "https://images.pexels.com/photos/1139743/pexels-photo-1139743.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their emergency response team is always ready, ensuring minimal downtime.",
        "name": "Mark Thompson",
        "role": "Facilities Manager",
        "avatar": "https://images.unsplash.com/photo-1603516270950-26e4f5004ffd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMkYlMjBGYWNpbGl0aWVzJTIwTWFpbnRlbmFuY2UlMjAlMkYlMjBDb25zdHJ1Y3Rpb24lMjBBZnRlcmNhcmUlMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODQ1N3ww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Located in the heart of the UK, easily accessible for all your needs.",
    "address": "123 Main Street, Anytown, UK",
    "website": "www.recomsolutions.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us Today",
    "description": "Reach out for consultations or to book our services.",
    "consent": "I agree to the privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Workflow",
    "description": "Leverage AI for seamless construction management.",
    "bullets": [
      "Automate repair scheduling and dispatching.",
      "Track warranties and claims effortlessly.",
      "Enhance communication with automated updates."
    ],
    "offer": "Mention RECOM Solutions for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "RECOM Solutions delivers unforgettable experiences.",
    "address": "123 Main Street, Anytown, UK",
    "email": "",
    "socials": [
      {
