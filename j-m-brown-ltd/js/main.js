const appData = {
  "brand": {
    ...
    "category": "Façade Restoration",
    "location": "South & Home Count",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Your Trusted Partner",
    "title": "Enhance your building's legacy today",
    "description": "We streamline restoration with digital solutions, ensuring impeccable results and heritage compliance.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/20693160/pexels-photo-20693160.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our website offers a clean, professional design with easy navigation."
      },
      {
        "title": "Icon-based Navigation",
        "description": "Find services quickly with intuitive icon-based navigation."
      },
      {
        "title": "Consistent Branding",
        "description": "Enjoy a seamless experience with consistent brand colors."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our expert façade restoration and cleaning services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Façade Restoration",
        "description": "We repair and restore building façades with precision and care."
      },
      {
        "icon": "🧽",
        "title": "Specialist Cleaning",
        "description": "Our team excels in heritage cleaning and graffiti removal."
      },
      {
        "icon": "🔨",
        "title": "Stone Repairs",
        "description": "Expert stone, stucco, and lime work to preserve structures."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Since our inception, J M Brown Ltd has been dedicated to restoring beauty to buildings across the South. Our skilled team ensures every project meets heritage standards.",
      "With tailored digital solutions, we offer streamlined operations for our clients. This approach delivers value and measurable ROI through enhanced efficiency."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "J M Brown transformed our building. Their digital processes made everything seamless.",
        "name": "Sarah L.",
        "role": "Architect",
        "avatar": "https://images.pexels.com/photos/2918150/pexels-photo-2918150.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their heritage compliance was crucial for us. Highly recommend them.",
        "name": "Mark T.",
        "role": "Building Owner",
        "avatar": "https://images.unsplash.com/photo-1635847422748-0305f64c284b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxGYSVDMyVBN2FkZSUyMHJlc3RvcmF0aW9uJTIwJTI2JTIwZXh0ZXJpb3IlMjBjbGVhbmluZyUyMCUyOGJ1aWxkaW5nJTIwcmVzdG9yYXRpb24lMjklMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODYxMXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Located in the heart of the South, we serve London and beyond.",
    "address": "",
    "website": "https://www.jmbrownltd.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us Today",
    "description": "Reach out for consultations or quotes. We're here to help.",
    "consent": "I consent to data processing."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate for Success",
    "description": "Leverage AI to enhance your restoration projects.",
    "bullets": [
      "Add online quote forms for instant estimates.",
      "Automate scheduling with calendar invites.",
      "Use CRM for seamless follow-ups and proposals."
    ],
    "offer": "Mention J M Brown for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "J M Brown delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
