const appData = {
  "brand": {
    "name": "Selo Doorsets",
    "tagline": "Concealed door solutions",
    "category": "Construction",
    "location": "Unknown",
    "phone": "Unknown"
  },
  "hero": {
    "eyebrow": "Fire safety assured",
    "title": "Prevent delays with compliant doorsets.",
    "description": "Selo Doorsets ensures regulatory compliance and seamless installations, reducing project delays.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/3964519/pexels-photo-3964519.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our doorsets are showcased in real environments, enhancing project visualization."
      },
      {
        "title": "Organized Structure",
        "description": "We provide a clear, organized product category display for easy navigation."
      },
      {
        "title": "Modern Design",
        "description": "A consistent color scheme enhances our modern, airy design feel."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our range of innovative, fire-safe door solutions tailored for complex projects.",
    "cards": [
      {
        "icon": "🔥",
        "title": "Fire-rated Doors",
        "description": "Our fire-rated metal riser doors enhance safety and meet compliance standards."
      },
      {
        "icon": "🏗",
        "title": "Concealed Frames",
        "description": "Concealed frame door sets and pocket doors offer sleek, modern solutions."
      },
      {
        "icon": "🛡",
        "title": "Access Panels",
        "description": "Our access panels and smoke control dampers ensure safety and accessibility."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Innovating Door Solutions",
    "paragraphs": [
      "Selo Doorsets specializes in concealed riser doors, access panels, and reusable temporary fire doors. We serve architects, designers, and contractors.",
      "We improve lead capture and project workflows with automation. Our focus on project support aligns perfectly with industry needs."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Selo Doorsets helped us pass inspections seamlessly. Their products are top-notch!",
        "name": "Jane Smith",
        "role": "Architect",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their doorsets saved us time and fit perfectly, preventing project delays.",
        "name": "Mark Johnson",
        "role": "Contractor",
        "avatar": "https://images.unsplash.com/photo-1713689824343-77d2f99e19b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMkYlMjBGaXJlJTIwc2FmZXR5JTIwJTI2JTIwYnVpbGRpbmclMjBwcm9kdWN0cyUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4MTQ0fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "title": "Visit Us",
    "description": "Located conveniently for project consultations. Contact us for details.",
    "address": "Unknown",
    "website": "www.selo-uk.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us",
    "description": "Reach out to us for bookings and consultations. We're here to help.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline with AI",
    "description": "Harness automation to enhance your projects.",
    "bullets": [
      "Automate project quoting for efficiency.",
      "Generate digital compliance documents.",
      "Create seamless project handover packs."
    ],
    "offer": "Mention Selo Doorsets for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Selo Doorsets delivers unforgettable experiences.",
    "address": "Unknown",
    "email": "",
    "socials": [
      {
