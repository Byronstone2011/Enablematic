const appData = {
  "brand": {
    "name": "Duncross Media",
    "tagline": "Digital success simplified",
    "category": "Digital Marketing",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Expert marketing solutions",
    "title": "Boost visibility and drive leads fast",
    "description": "We help businesses grow with tailored SEO, PPC, and digital strategies that maximize ROI and save time.",
    "highlights": [
      {
        "label": "PPC Campaigns Managed",
        "value": "2,000+"
      },
      {
    ...
    "image": "https://images.pexels.com/photos/942331/pexels-photo-942331.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our campaigns consistently deliver measurable outcomes and long-term growth."
      },
      {
        "title": "Streamlined Design",
        "description": "We leverage intuitive layouts to maximize user engagement and conversions."
      },
      {
        "title": "Credibility Display",
        "description": "Showcasing your successes builds trust and attracts potential clients."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We provide tailored marketing services for businesses of all sizes.",
    "cards": [
      {
        "icon": "💻",
        "title": "PPC Management",
        "description": "Optimize ad spend and target the right audience with precision campaigns."
      },
      {
        "icon": "🔍",
        "title": "SEO Services",
        "description": "Improve organic rankings to boost visibility and attract traffic."
      },
      {
        "icon": "📱",
        "title": "Social Media Marketin",
        "description": "Engage audiences and drive brand growth across social platforms."
      }
    ]
  },
  "story": {
    "eyebrow": "Our journey",
    "title": "Driving digital growth for businesses",
    "paragraphs": [
      "Duncross Media was founded to help businesses thrive in the digital world. We specialize in strategies that deliver impactful results.",
      "By combining expertise and automation, we streamline campaigns, saving clients time while enhancing efficiency and visibility."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Duncross Media transformed our SEO rankings and helped us generate consistent leads. Highly recommend!",
        "name": "Sarah Mills",
        "role": "Marketing Manager",
        "avatar": "https://images.pexels.com/photos/33100455/pexels-photo-33100455.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their PPC strategies increased our ROI significantly. A professional and results-driven team.",
        "name": "John Patel",
        "role": "Business Owner",
        "avatar": "https://images.unsplash.com/photo-1597576299498-81ef252890db?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxEaWdpdGFsJTIwTWFya2V0aW5nJTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI0MzMyOTV8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Our team is here to help businesses worldwide achieve their marketing goals.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us to discuss your needs and explore solutions tailored for success.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Smart automation tools",
    "description": "Enhance efficiency with our cutting-edge AI solutions.",
    "bullets": [
      "Automated campaign reporting for real-time insights.",
      "Streamlined client onboarding and maintenance.",
      "Effortless content scheduling across platforms."
    ],
    "offer": "Mention Duncross Media for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Duncross Media delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
