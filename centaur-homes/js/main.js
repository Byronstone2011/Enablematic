const appData = {
  "brand": {
    "name": "Centaur Homes",
    "tagline": "Quality by Design",
    "category": "Residential Construction",
    "location": "Gloucestershire,",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Innovative Homebuilding",
    "title": "Transforming dreams into reality online.",
    "description": "Centaur Homes enhances your online experience with clear service details and seamless lead capture.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Clean Design",
        "description": "Our site boasts a minimal layout with ample whitespace for easy navigation."
      },
      {
        "title": "Professional Photography",
        "description": "High-quality images showcase our homes beautifully, enhancing visual appeal."
      },
      {
        "title": "Trust Signals",
        "description": "We use badges effectively to build trust and confidence in our services."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We provide comprehensive residential development services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "New Home Construction",
        "description": "We build bespoke homes tailored to your specifications and lifestyle."
      },
      {
        "icon": "🏡",
        "title": "Property Development",
        "description": "Our team develops residential properties to meet market demands."
      },
      {
        "icon": "🔑",
        "title": "Property Sales",
        "description": "We manage the sale of properties, ensuring a smooth transaction process."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Homes with Passion",
    "paragraphs": [
      "Founded on principles of craftsmanship, Centaur Homes prides itself on creating quality residences.",
      "With minimal online presence, we leverage automation to capture leads and enhance visibility."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Centaur Homes made our dream home a reality with clarity and precision.",
        "name": "Emily Jones",
        "role": "Homebuyer",
        "avatar": "https://images.pexels.com/photos/6196233/pexels-photo-6196233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "The team’s professionalism and attention to detail were outstanding.",
        "name": "James Smith",
  ...
  "visit": {
    ...
    "title": "Visit Us in Gloucestershire",
    "description": "Explore our properties in the heart of Gloucestershire, where quality meets lifestyle.",
    "address": "Gloucestershire, UK",
    "website": "www.centaurhomes.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Book a Consultation",
    "description": "Contact us today to discuss your homebuilding needs and secure your dream home.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline with Automation",
    "description": "Enhance efficiency and client engagement with AI solutions.",
    "bullets": [
      "Automate lead capture with a CRM.",
      "Schedule viewings with online tools.",
      "Boost local SEO visibility."
    ],
    "offer": "Mention Centaur Homes for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Centaur Homes delivers unforgettable experiences.",
    "address": "Gloucestershire, UK",
    "email": "",
    "socials": [
      {
