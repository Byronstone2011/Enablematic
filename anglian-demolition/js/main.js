const appData = {
  "brand": {
    "name": "Anglian",
    "tagline": "Safe. Efficient. Reliable.",
    "category": "Demolition & Civil Engineering",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Experts in demolition",
    "title": "One-stop solution for safe demolition and waste management",
    "description": "We streamline complex projects, ensuring regulatory compliance and sustainable waste disposal.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/14475736/pexels-photo-14475736.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our experienced team ensures seamless project execution every time."
      },
      {
        "title": "Sustainable Practices",
        "description": "Committed to eco-friendly waste recycling and asbestos management."
      },
      {
        "title": "Comprehensive Services",
        "description": "From demolition to scaffolding, we handle all aspects of your project."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our services cover all aspects of demolition and waste management.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Demolition",
        "description": "Expert demolition services with a focus on safety and efficiency."
      },
      {
        "icon": "🚧",
        "title": "Asbestos Removal",
        "description": "Safe asbestos surveys and removal to ensure compliance and safety."
      },
      {
        "icon": "♻️",
        "title": "Waste Recycling",
        "description": "Eco-friendly waste recycling and skip hire for all project needs."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Anglian Demolition and Asbestos Ltd has been a leader in the industry, providing top-notch demolition and waste management services.",
      "Our focus on safety, sustainability, and efficiency ensures that we meet our clients' needs while exceeding their expectations."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Anglian made asbestos removal stress-free and compliant with all regulations.",
        "name": "John Smith",
        "role": "Property Developer",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their demolition services were efficient, and the waste management was eco-friendly.",
        "name": "Jane Doe",
  ...
  "visit": {
    ...
    "description": "We are located in the heart of East Anglia, offering easy access to our services.",
    "address": "",
    "website": "www.angliandemo.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Request a Consultation",
    "description": "Contact us today to discuss your project needs and receive a tailored solution.",
    "consent": "By submitting, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Projects",
    "description": "Leverage AI to enhance efficiency and compliance in your projects.",
    "bullets": [
      "Automate quoting for faster estimates.",
      "Integrate scheduling with project management.",
      "Digital compliance for safety certificates."
    ],
    "offer": "Mention Anglian for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Anglian delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
