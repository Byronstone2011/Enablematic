const appData = {
  "brand": {
    "name": "Thomann-Hanry",
    "tagline": "Facade cleaning experts",
    "category": "Facade Cleaning",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Scaffold-free solutions",
    "title": "Restore facades without disruption.",
    "description": "Thomann-HanryÂ® cleans and restores facades without scaffolding, saving time and cost for busy sites.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/28633922/pexels-photo-28633922.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We use scaffold-free techniques to minimize disruption."
      },
      {
        "title": "Expert Team",
        "description": "Our skilled team ensures top-quality facade restoration."
      },
      {
        "title": "Comprehensive Services",
        "description": "We offer cleaning, restoration, and full refurbishments."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Specializing in scaffold-free façade services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Façade Gommage®",
        "description": "Gentle cleaning without scaffolding for pristine facades."
      },
      {
        "icon": "🛠",
        "title": "Stone Restoration",
        "description": "Restore the beauty and integrity of stone surfaces."
      },
      {
        "icon": "📊",
        "title": "Surveys & MEWP Hire",
        "description": "Comprehensive surveys with access platform hire."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Thomann-HanryÂ® revolutionized facade cleaning by eliminating the need for scaffolding. Our unique approach saves time and minimizes disruption.",
      "Our commitment to quality and innovation makes us the top choice for facade restoration. We use advanced techniques for seamless results."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Thomann-HanryÂ® transformed our building without any disruption. Their scaffold-free method is a game changer.",
        "name": "Jane Doe",
        "role": "Property Manager",
        "avatar": "https://images.pexels.com/photos/6888778/pexels-photo-6888778.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Exceptional service! Our facade looks new again, and we avoided the hassle of scaffolding.",
        "name": "John Smith",
        "role": "Building Owner",
  ...
  "visit": {
    ...
    "description": "Discover how we enhance facades across the UK with minimal disruption.",
    "address": "",
    "website": "www.thomann-hanry.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Contact Us",
    "title": "Get a Free Quote",
    "description": "Reach out today for your scaffold-free facade solution.",
    "consent": "I agree to be contacted by Thomann-HanryÂ®."
  },
  "byronCallout": {
    ...
    "bullets": [
      "Automate lead capture for quick responses.",
      "CRM integration for seamless follow-ups.",
      "Schedule MEWPs efficiently."
    ],
    "offer": "Mention Thomann-Hanry for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Thomann-Hanry delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
