const appData = {
  "brand": {
    "name": "London Pools",
    "tagline": "Crafting Luxurious Pools",
    "category": "Construction & Maintenance",
    "location": "London",
    "phone": "Unavailable"
  },
  "hero": {
    "eyebrow": "Bespoke pool solutions",
    "title": "Transform your old pool into a modern oasis.",
    "description": "With expert construction and design, we revitalize outdated pools and offer reliable maintenance.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/34053445/pexels-photo-34053445.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We deliver high-quality pool installations with precision and care."
      },
      {
        "title": "Stunning Designs",
        "description": "Our designs elevate your space with elegant and innovative pool concepts."
      },
      {
        "title": "Reliable Maintenance",
        "description": "Count on us for dependable servicing that keeps your pool pristine."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our premium swimming pool services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Bespoke Pool Design",
        "description": "We create custom pools for outdoor, indoor, and basement spaces."
      },
      {
        "icon": "🔧",
        "title": "Pool Refurbishment",
        "description": "Revitalize and update your existing pool or spa with us."
      },
      {
        "icon": "🛠",
        "title": "Maintenance Services",
        "description": "Ensure your pool stays in top condition with our expert maintenance."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Decades of Pool Excellence",
    "paragraphs": [
      "Founded with a passion for design, we've built a reputation in London for crafting exquisite pools.",
      "Our service-led approach, combined with digital enhancements, ensures unmatched client experiences."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "London Pools transformed our outdated pool into a stunning retreat. Exceptional service!",
        "name": "Sarah Thompson",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/18834987/pexels-photo-18834987.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their maintenance team is reliable and professional. Our pool has never looked better.",
        "name": "Mark Johnson",
        "role": "Property Developer",
        "avatar": "https://images.unsplash.com/photo-1697779055997-627444414abd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxTd2ltbWluZyUyMHBvb2wlMjBjb25zdHJ1Y3Rpb24lMjAlMjYlMjBtYWludGVuYW5jZSUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4Mzk1fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Discover our pool designs and talk to our experts in the heart of London.",
    "address": "Unavailable",
    "website": "londonswimmingpools.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Book a Consultation",
    "description": "Contact us today to discuss your pool project or maintenance needs.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Efficient Pool Management",
    "description": "Leverage automation for streamlined pool services.",
    "bullets": [
      "Automate inquiries with CRM integration.",
      "Online booking for easy maintenance scheduling.",
      "Manage projects with automated client updates."
    ],
    "offer": "Mention London Pools for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "London Pools delivers unforgettable experiences.",
    "address": "Unavailable",
    "email": "",
    "socials": [
      {
