const appData = {
  ...
  "hero": {
    ...
    "title": "Streamline Your Projects with Speed",
    "description": "RMI (Midlands) Ltd accelerates your projects with efficient quoting and expert management.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our team delivers expert engineering solutions tailored to your needs."
      },
      {
        "title": "Proven Track Record",
        "description": "With over 20 years of experience, we ensure successful project outcomes."
      },
      {
        "title": "Certified Excellence",
        "description": "ISO certified and LEEA members, guaranteeing quality and trust."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive engineering services tailored for you.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Project Management",
        "description": "We manage your projects with precision and expertise."
      },
      {
        "icon": "🔧",
        "title": "Installation Services",
        "description": "Specializing in material handling and storage solutions."
      },
      {
        "icon": "⚙️",
        "title": "Fabrication Solutions",
        "description": "Custom fabrication including laser cutting and welding."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "RMI (Midlands) Ltd began with a vision to provide superior engineering solutions. We quickly became a leader in the industry.",
      "Our commitment to innovation and client satisfaction drives us to deliver exceptional results every time."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "RMI streamlined our project timelines significantly. Communication was seamless.",
        "name": "John Smith",
        "role": "Warehouse Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their precision and efficiency were evident in every phase of the project.",
        "name": "Jane Doe",
  ...
  "visit": {
    ...
    "title": "Visit Us in the Midlands",
    "description": "Located in the heart of the Midlands, we are easily accessible for all your engineering needs.",
    "address": "Midlands, UK",
    "website": "www.rmimidlands.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us Today",
    "description": "Reach out to discuss your project needs. We're here to help!",
    "consent": "By contacting us, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Success",
    "description": "Embrace AI to enhance efficiency and service delivery.",
    "bullets": [
      "Instant online quotes streamline processes.",
      "Automated CRM improves lead management.",
      "Schedule jobs efficiently with AI tools."
    ],
    "offer": "Mention RMI Midlands for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "RMI Midlands delivers unforgettable experiences.",
    "address": "Midlands, UK",
    "email": "",
    "socials": [
      {
