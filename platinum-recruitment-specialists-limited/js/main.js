const appData = {
  ...
  "hero": {
    "eyebrow": "Trusted recruitment partner",
    "title": "Reliable staffing solutions, fast.",
    "description": "We connect skilled trades and labour to top UK firms, solving delays and compliance risks efficiently.",
    "highlights": [
      {
        "label": "Operatives Placed",
        "value": "5,000+"
      },
      {
        "label": "Recruitment Expertise",
        "value": "12 year"
      },
      {
    ...
    "image": "https://images.pexels.com/photos/17588750/pexels-photo-17588750.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We simplify recruitment with efficient systems for quick placements."
      },
      {
        "title": "Quality Assurance",
        "description": "Our team ensures all candidates meet rigorous skill standards."
      },
      {
        "title": "Nationwide Reach",
        "description": "We serve leading firms across the UK with tailored workforce solutions."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We deliver tailored recruitment services for trades and labour needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Trade Recruitment",
        "description": "Connecting skilled tradespeople to construction and engineering firms."
      },
      {
        "icon": "💼",
        "title": "Temp Staffing",
        "description": "Quick access to reliable temporary staff for short-term projects."
      },
      {
        "icon": "🔧",
        "title": "Workforce Solutions",
        "description": "Custom contractor supply for M&E and facilities management needs."
      }
    ]
  },
  "story": {
    "eyebrow": "Our journey",
    "title": "Committed to excellence in recruitment",
    "paragraphs": [
      "Platinum Recruitment Specialists Ltd has built a reputation for connecting skilled tradespeople with top UK firms. Our focus is on reliability and quality.",
      "With advanced systems and tailored solutions, we meet the unique needs of construction and engineering industries nationwide."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Platinum Recruitment always delivers skilled operatives on time, solving our staffing challenges efficiently.",
        "name": "James Carter",
      ...
      {
        "quote": "Their streamlined onboarding and compliance checks are second to none. A true recruitment partner!",
        "name": "Sarah Evans",
        "role": "Operations Director, M&E Firm",
        "avatar": "https://images.unsplash.com/photo-1573798484153-da43eda898f6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxSZWNydWl0bWVudCUyMCUyRiUyMFN0YWZmaW5nJTIwJTI4VHJhZGVzJTIwJTI2JTIwTGFib3VyJTI5JTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjIzNTYzNjd8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "From major cities to local projects, we provide skilled trades and labour wherever needed.",
    "address": "Available across the UK",
    "website": "www.platinumrs.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in touch",
    "title": "Let's find the right talent",
    "description": "Contact us today to discuss your staffing needs. Reliable, skilled operatives await.",
    "consent": "We value your privacy and handle your data securely."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation for recruitment success",
    "description": "Boost efficiency and reduce delays with AI-driven recruitment tools.",
    "bullets": [
      "Automated candidate sourcing for fast placements.",
      "Streamlined onboarding and compliance checks.",
      "Real-time booking through online portals."
    ],
    "offer": "Mention Platinum Recruitmen for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Platinum Recruitmen delivers unforgettable experiences.",
    "address": "Available across the UK",
    "email": "",
    "socials": [
      {
