const appData = {
  ...
  "hero": {
    ...
    "title": "Streamline your projects with JMAC Group",
    "description": "Overcome delays with automated solutions that enhance efficiency and compliance.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/17527969/pexels-photo-17527969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Showcasing our equipment in action, emphasizing quality and reliability."
      },
      {
        "title": "Consistent Branding",
        "description": "Our brand identity is clear and compelling, ensuring trust and recognition."
      },
      {
        "title": "Professional Photograph",
        "description": "Our visuals highlight product quality and enhance client engagement."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our comprehensive construction and industrial services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Scaffolding Services",
        "description": "NASC, RISQS, and ISO accredited scaffolding solutions for all projects."
      },
      {
        "icon": "🔧",
        "title": "Industrial Services",
        "description": "Expert services for Oil & Gas, Infrastructure, and Utilities industries."
      },
      {
        "icon": "🛡",
        "title": "Asset Integrity",
        "description": "Comprehensive inspection and asset surveying to ensure safety."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Welcome to JMAC Group, your trusted partner with over 40 years of expertise in scaffolding, contracting, and industrial services.",
      "Our diverse service mix and commitment to quality align perfectly with digital automation solutions."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "JMAC's automation solutions streamlined our operations, saving us valuable time.",
        "name": "Chris Johnson",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/6196233/pexels-photo-6196233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their expertise in scaffolding and asset integrity is unmatched.",
        "name": "Sarah Lee",
  ...
  "visit": {
    ...
    "title": "Visit JMAC Group",
    "description": "Discover our services and meet our team for tailored solutions.",
    "address": "",
    "website": "jmacgroupltd.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us Today",
    "description": "Reach out for consultations or bookings tailored to your needs.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Empower Your Projects",
    "description": "Harness AI to elevate your operations.",
    "bullets": [
      "Automate quotes and bookings for faster service.",
      "Enhance asset management with digital tools.",
      "Optimize resource allocation with scheduling AI."
    ],
    "offer": "Mention JMAC Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "JMAC Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
