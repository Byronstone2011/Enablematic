const appData = {
  ...
  "hero": {
    ...
    "title": "Building Your Vision with Precision and Care",
    "description": "We solve your construction needs with expert craftsmanship and reliable service. Enhance your space with us.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Navigate our site with ease, thanks to our clean structure."
      },
      {
        "title": "Strong Brand Identity",
        "description": "Consistent colors and design enhance our trustworthiness."
      },
      {
        "title": "Professional Typography",
        "description": "Clear text ensures you get the information you need fast."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our comprehensive construction services tailored for you.",
    "cards": [
      {
        "icon": "🏗",
        "title": "General Construction",
        "description": "Delivering top-quality builds, tailored to your specifications."
      },
      {
        "icon": "🔨",
        "title": "Renovation & Refurbishm",
        "description": "Transforming spaces with precision and attention to detail."
      },
      {
        "icon": "🛠",
        "title": "Maintenance & Repairs",
        "description": "Keeping your buildings in top condition with expert care."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Francis Construction has been dedicated to delivering exceptional building services in Berkshire. We pride ourselves on quality and reliability.",
      "Our focus on customer needs and embracing modern solutions sets us apart. We offer seamless experiences with measurable results."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Francis Construction transformed our home beautifully. Their service was seamless!",
        "name": "Jane Doe",
        "role": "Homeowner",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their team was professional and precise. Highly recommend for any renovation project!",
        "name": "John Smith",
        "role": "Business Owner",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Our Location",
    "description": "Visit us in the heart of Berkshire, where tradition meets innovation.",
  ...
  "inquiry": {
    ...
    "description": "Contact us for a free quote or consultation today.",
  ...
  "byronCallout": {
    ...
    "bullets": [
      "Automated lead capture for quick responses.",
      "Email automation for consistent client follow-up.",
      "Calendar integration for seamless scheduling."
    ],
    "offer": "Mention Francis Constructio for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Francis Constructio delivers unforgettable experiences.",
    "address": "Berkshire, UK",
    "email": "",
    "socials": [
      {
