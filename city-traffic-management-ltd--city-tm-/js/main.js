const appData = {
  "brand": {
    "name": "City Traffic",
    "tagline": "Managing roads safely",
    "category": "Traffic Management",
    "location": "London & Home Coun",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Rapid Response Experts",
    "title": "Efficient solutions for traffic woes",
    "description": "We streamline traffic control and training with fast, reliable services.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Iconic Navigation",
        "description": "Easy-to-use icon-based navigation for quick service access."
      },
      {
        "title": "Safety First",
        "description": "High-visibility branding ensures on-site safety and awareness."
      },
      {
        "title": "Real Photography",
        "description": "Authentic images showcase our team in action on-site."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive traffic management and training services.",
    "cards": [
      {
        "icon": "🚦",
        "title": "Traffic Services",
        "description": "Expert site traffic control with rapid response in London."
      },
      {
        "icon": "🎓",
        "title": "Training Courses",
        "description": "Nationally delivered traffic management training sessions."
      },
      {
        "icon": "🛡",
        "title": "Health & Safety",
        "description": "Specialized health and safety certifications for your team."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded with a mission to ensure road safety, we have grown to become leaders in traffic management.",
      "Our blend of training and on-site services supports clients with innovative digital tools."
    ],
    "image": "https://images.pexels.com/photos/8761665/pexels-photo-8761665.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "City Traffic's quick response time has transformed our operations.",
        "name": "Jane Doe",
        "role": "Project Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their training courses are comprehensive and convenient.",
        "name": "John Smith",
  ...
  "visit": {
    ...
    "description": "Located in the heart of London, serving the entire Home Counties.",
    "address": "",
    "website": "citytm.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Book Your Consultation",
    "description": "Contact us to arrange your traffic management needs today.",
    "consent": "I agree to the terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate and Optimize",
    "description": "Leverage AI to enhance your traffic management strategies.",
    "bullets": [
      "Online course booking for seamless training access.",
      "Automated scheduling ensures prompt site responses.",
      "CRM integration for effective lead management."
    ],
    "offer": "Mention City Traffic for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "City Traffic delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
