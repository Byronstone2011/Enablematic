const appData = {
  "brand": {
    "name": "Flexible Fire Inspections",
    "tagline": "",
    "category": "",
    "location": "",
    "phone": ""
  ...
  "hero": {
    ...
    "title": "Eliminate Compliance Risks, Ensure Safety",
    "description": "Flexible Fire Inspections helps building owners and managers achieve full compliance with Fire Safety Regulations while minimizing liability and ensuring occupant",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Certified by leading fire safety organizations, we deliver trusted compliance solutions backed by credentials like"
      },
      {
        "title": "Precise Reporting",
        "description": "Our detailed inspections and reports provide clear, actionable insights that protect your property and occupants."
      },
      {
        "title": "Dedicated Service",
        "description": "With a hands-on, personalized approach, we tailor solutions to fit the unique needs of your site and building"
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive fire safety services designed to ensure compliance and protect your property.",
    "cards": [
      {
        "icon": "🛋️",
        "title": "Passive Fire Protection",
        "description": "Thorough assessments to identify risks in fire doors, seals, and compartmentation."
      },
      {
        "icon": "🛠️",
        "title": "Fire Extinguisher Servi",
        "description": "BS 5306-compliant servicing to ensure extinguishers are ready for emergencies."
      },
      {
        "icon": "🎥",
        "title": "Compliance Reporting",
        "description": "Expert consultancy for fire safety compliance with detailed certification and reports."
      }
    ]
  },
  "story": {
    "eyebrow": "Our journey",
    "title": "Passionate About Fire Safety",
    "paragraphs": [
      "Founded in London, Flexible Fire Inspections was built to address critical gaps in fire safety compliance. With a small, dedicated team, we focus on providing personalized, high-quality inspection services tailored to the",
      "Our mission is to simplify compliance and safeguard lives. By leveraging our expertise and commitment to precision, we deliver unparalleled services that reduce liability, meet regulations, and offer peace of mind to building managers and contractors."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Flexible Fire Inspections helped us identify critical fire safety issues we never noticed. Their report was detailed and gave us practical",
        "name": "Rachel Simmons",
        "role": "Property Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their inspections are thorough and professional, helping us meet compliance regulations without stress. A reliable partner for fire",
        "name": "James Turner",
        "role": "Building Owner",
  ...
  "visit": {
    ...
    "description": "Located in the heart of London, Flexible Fire Inspections is proud to serve the community with reliable fire safety solutions. Our central location ensures we",
    "address": "London, England",
    "website": "www.flexiblefire.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get started today",
    "title": "Schedule your inspection now",
    "description": "Contact us to book your fire safety inspection or consultation. Ensure compliance and protect your property with our expert services.",
    "consent": "By submitting your request, you agree to receive communications from Flexible Fire Inspections."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Fire Safety Compliance",
    "description": "Leverage AI and automation to simplify your fire safety processes and enhance efficiency.",
    "bullets": [
      "Automated scheduling for inspections and servicing.",
      "Instant PDF reports and certifications stored in secure client portals.",
      "Mobile inspection apps to accelerate audits and ensure accuracy."
    ],
    "offer": "Mention Flexible Fire Inspections for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Flexible Fire Inspections delivers unforgettable experiences.",
    "address": "London, England",
    "email": "",
    "socials": [
      {
