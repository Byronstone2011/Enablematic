const appData = {
  ...
  "hero": {
    ...
    "title": "Overcome development hurdles with ease",
    "description": "Byoot transforms challenges into opportunities, offering tailored solutions for developers.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7937667/pexels-photo-7937667.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Decades of experience ensure reliable and efficient project delivery."
      },
      {
        "title": "Seamless Execution",
        "description": "Streamlined processes guarantee smooth transitions from plan to build."
      },
      {
        "title": "Client Focused",
        "description": "Tailored solutions meet specific client needs, ensuring satisfaction."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive property development services from planning to completion.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Turnkey Development",
        "description": "From planning to funding and building, we handle it all."
      },
      {
        "icon": "🏢",
        "title": "Main Contracting",
        "description": "Expert construction services for various property types."
      },
      {
        "icon": "🔄",
        "title": "Project Rescue",
        "description": "Reviving stalled projects with strategic intervention."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Byoot has been a beacon in property development, transforming dreams into tangible assets. We specialize in comprehensive solutions.",
      "Our expertise and automation align perfectly with modern needs, delivering efficient projects with measurable ROI."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Byoot rescued our stalled project, turning it into a success. Their expertise is unmatched.",
        "name": "John Smith",
        "role": "Property Investor",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their turnkey solutions made our first development smooth and profitable.",
        "name": "Emily Jones",
  ...
  "visit": {
    "eyebrow": "Find Us",
    "title": "Visit Byoot",
    "description": "Discover a strategic partner for your property development needs.",
    "address": "",
    "website": "www.byoot.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Let's Talk",
    "title": "Start Your Project",
    "description": "Contact us to discuss your development needs and get expert advice.",
    "consent": "I agree to be contacted by Byoot."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Efficiency Through AI",
    "description": "Leverage automation to streamline property development.",
    "bullets": [
      "Automate lead capture and qualification.",
      "Integrated CRM for seamless follow-ups.",
      "Digital proposals with easy e-signature."
    ],
    "offer": "Mention Byoot for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Byoot delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
