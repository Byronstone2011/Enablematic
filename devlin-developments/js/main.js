const appData = {
  "brand": {
    "name": "Devlin Developments",
    "tagline": "Sustainable luxury homes",
  ...
  "hero": {
    ...
    "title": "Navigate plots and permits effortlessly.",
    "description": "We simplify plot selection and permits, while building bespoke, eco-friendly homes to minimize costs.",
    "highlights": [
      {
        "label": "Homes Built",
        "value": "150+"
    ...
    "image": "https://images.pexels.com/photos/233267/pexels-photo-233267.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our high-quality images showcase the beauty and sustainability of each home."
      },
      {
        "title": "Elegant Design",
        "description": "We use a clean, spacious layout that enhances readability and conveys trust."
      },
      {
        "title": "Luxury and Trust",
        "description": "Our color palette and typography exude elegance and reliability."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our services cover every phase of homebuilding, ensuring satisfaction and sustainability.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Bespoke Design",
        "description": "Custom design-led home building tailored to your needs and lifestyle."
      },
      {
        "icon": "🌿",
        "title": "Eco-Friendly Builds",
        "description": "Sustainable construction using natural materials for a greener future."
      },
      {
        "icon": "🔑",
        "title": "Project Management",
        "description": "Comprehensive management from site selection to handover."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Sustainable Dreams",
    "paragraphs": [
      "Devlin Developments builds bespoke, sustainable homes across Norfolk. We focus on modern, comfortable living with eco-friendly methods.",
      "We streamline complex builds with automation, enhancing client interaction and project throughput, creating exceptional homes efficiently."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Devlin made plot finding and permits a breeze, delivering our dream eco-home.",
        "name": "Sarah L.",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/15456627/pexels-photo-15456627.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their sustainable builds are top-notch and energy-efficient. Highly recommend!",
        "name": "James T.",
  ...
  "visit": {
    ...
    "title": "Visit Us in Norfolk",
    "description": "Explore Norfolk's beauty while discovering your dream home. Contact us for a visit.",
    "address": "Norfolk, UK",
    "website": "www.devlindevelopments.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Book a Consultation",
    "description": "Contact us to discuss your bespoke home project. Let's build your dream.",
    "consent": "By submitting, you agree to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation for Builders",
    "description": "Enhance your building process with AI-driven solutions.",
    "bullets": [
      "Capture leads efficiently with CRM integration.",
      "Automate quotes and proposals for fast responses.",
      "Offer clients a portal for updates and payments."
    ],
    "offer": "Mention Devlin Developments for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Devlin Developments delivers unforgettable experiences.",
    "address": "Norfolk, UK",
    "email": "",
    "socials": [
      {
