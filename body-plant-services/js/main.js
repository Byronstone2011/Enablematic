const appData = {
  "brand": {
    "name": "BODY PLANT",
    "tagline": "Machines that move you",
    "category": "Machinery Sales",
    "location": "UK",
    "phone": "123-456-7890"
  },
  "hero": {
    "eyebrow": "Trusted Machinery Experts",
    "title": "Streamline Your Machinery Buying Process",
    "description": "Get accurate quotes fast with online requests. View available stock instantly.",
    "highlights": [
      {
        "label": "Machines Sold",
        "value": "5,000+"
    ...
    "image": "https://images.pexels.com/photos/29491531/pexels-photo-29491531.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "All our machinery prices are clear and easily accessible."
      },
      {
        "title": "Diverse Inventory",
        "description": "We offer a wide range of machinery for all construction needs."
      },
      {
        "title": "Reliable Support",
        "description": "Our team provides exceptional customer support at every step."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our specialized services tailored for construction.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Buy Machinery",
        "description": "Purchase quality used machinery with confidence."
      },
      {
        "icon": "💰",
        "title": "Sell Machinery",
        "description": "Get the best value when selling your machinery with us."
      },
      {
        "icon": "📊",
        "title": "Free Valuations",
        "description": "Receive honest and free machinery valuations and quotes."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Building Trust and Machinery",
    "paragraphs": [
      "BODY PLANT SERVICES LTD is dedicated to simplifying the process of buying and selling construction machinery.",
      "Our streamlined online process ensures a smooth experience, maximizing client satisfaction and efficiency."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "The online quote system is a game-changer for our business.",
        "name": "John D.",
        "role": "Contractor",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their customer service is top-notch and very responsive.",
        "name": "Sarah L.",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Experience Our Inventory",
    "description": "Discover our wide range of machinery in person and speak with our experts.",
    "address": "123 Machinery Lane, UK",
    "website": "www.bodyplant.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request a Quote",
    "description": "Contact us today for a personalized machinery quote.",
    "consent": "I consent to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Success",
    "description": "Leverage AI to boost your sales process.",
    "bullets": [
      "Automate quote requests for quick responses.",
      "Search online inventory with ease.",
      "CRM integration for seamless tracking."
    ],
    "offer": "Mention BODY PLANT for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "BODY PLANT delivers unforgettable experiences.",
    "address": "123 Machinery Lane, UK",
    "email": "",
    "socials": [
      {
