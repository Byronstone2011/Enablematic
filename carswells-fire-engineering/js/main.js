const appData = {
  "brand": {
    "name": "Carswells Fire Engineering",
    "tagline": "",
    "category": "",
    "location": "",
    "phone": ""
  ...
  "hero": {
    ...
    "title": "Compliance-driven Fire Safety Solutions",
    "description": "At Carswells Fire Engineering, we design, supply, install, and maintain fire suppression systems to protect lives and assets. Our LPS 1048-approved services ensure",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "LPS 1048-approved systems ensure regulatory compliance and peace of mind."
      },
      {
        "title": "Turnkey Accountability",
        "description": "Single-point project management keeps deadlines and operations on track."
      },
      {
        "title": "Nationwide Support",
        "description": "Maintenance and servicing ensure uninterrupted protection across the UK."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Carswells Fire Engineering delivers comprehensive fire protection solutions tailored to your needs.",
    "cards": [
      {
        "icon": "🛋️",
        "title": "Design & Planning",
        "description": "Expert design of fire suppression systems to meet LPS 1048 standards."
      },
      {
        "icon": "🛠️",
        "title": "Installation Services",
        "description": "Professional supply and installation of fire sprinkler and foam systems."
      },
      {
        "icon": "🎥",
        "title": "Maintenance & Support",
        "description": "Scheduled servicing and nationwide support to ensure system reliability."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Legacy of Safety",
    "title": "Protecting What Matters Most",
    "paragraphs": [
      "Since our founding, Carswells Fire Engineering has been dedicated to designing and delivering fire suppression systems that safeguard lives and assets. We specialize in compliance-driven solutions tailored for commercial and",
      "Our commitment to reliability and single-point accountability makes us the trusted choice for global brands needing expert fire protection. With advanced engineering and seamless project management, we help you focus on running your business safely."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Carswells provided seamless project management and ensured our fire systems met strict compliance standards. Their expertise is unmatched.",
        "name": "Jane Porter",
        "role": "Facilities Manager, GlobalTech",
        "avatar": "https://images.pexels.com/photos/4427610/pexels-photo-4427610.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their maintenance services are exceptional—always on time and keeping our systems reliable. Highly recommend!",
        "name": "Mark Stevenson",
        "role": "Operations Director, Premier Logistic",
  ...
  "visit": {
    ...
    "title": "Located in Milton Keynes",
    "description": "Based in the heart of England, our Milton Keynes office is easily accessible and serves as the hub for our nationwide operations.",
  ...
  "inquiry": {
    ...
    "description": "Contact us today to discuss your fire protection needs. Let’s ensure your operations stay safe and compliant.",
    "consent": "By submitting, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Fire Safety Operations",
    "description": "Leverage AI and automation to simplify fire protection workflows and compliance.",
    "bullets": [
      "Automated service scheduling and reminders for hassle-free maintenance.",
      "Client portal for instant access to compliance reports and",
      "Digital quoting and project dashboards to track deadlines and resources."
    ],
    "offer": "Mention Carswells Fire Engineering for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Carswells Fire Engineering delivers unforgettable experiences.",
    "address": "Milton Keynes, England",
    "email": "",
    "socials": [
      {
