const appData = {
  ...
  "hero": {
    ...
    "title": "Streamline your projects with OCL's expertise",
    "description": "OCL optimizes construction processes with digital tools, ensuring efficient project management and scheduling for seamless delivery.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "OCL's industry certifications guarantee unmatched quality and reliability in every project."
      },
      {
        "title": "Dynamic Services",
        "description": "Clear service categorization ensures clients find exactly what they need, quickly."
      },
      {
        "title": "Vibrant Branding",
        "description": "Our strong yellow branding ensures visibility and conveys energy and commitment."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our comprehensive services cover every aspect of construction, from groundwork to final touches.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Civils & Groundwork",
        "description": "Expert civil engineering and groundwork services for robust infrastructure."
      },
      {
        "icon": "💡",
        "title": "Electrical Installation",
        "description": "Comprehensive electrical services ensuring safety and efficiency."
      },
      {
        "icon": "🔨",
        "title": "Brickwork & Blockwork",
        "description": "Precise brickwork and blockwork for durable, lasting structures."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded with a vision to transform construction, OCL excels in rail, infrastructure, and domestic projects, driven by innovation.",
      "Our expertise in digital transformation enhances project delivery, making us an ideal partner for modern construction needs."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "OCL's streamlined processes made our project a breeze. Their digital tools are top-notch.",
        "name": "Sarah Johnson",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their expertise in construction is unmatched. OCL delivered on time and on budget.",
        "name": "Tom Reed",
        "role": "Construction Director",
        "avatar": "https://images.unsplash.com/photo-1688841747582-41097036109d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxSYWlsJTIwJTI2JTIwY29uc3RydWN0aW9uJTIwY29udHJhY3RpbmclMjAlMjhjaXZpbHMlMkMlMjBidWlsZGluZyUyQyUyMGVsZWN0cmljYWwlMjklMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODMyMXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
  ...
  "inquiry": {
    ...
    "consent": "I consent to the use of my data for communication."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate with OCL",
    "description": "Enhance efficiency with OCL's automation solutions.",
    "bullets": [
      "Streamlined project scheduling and management.",
      "Automated invoicing and payment tracking.",
      "Digital documentation for SHEQ compliance."
    ],
    "offer": "Mention OCL for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "OCL delivers unforgettable experiences.",
    "address": "Nationwide, UK",
    "email": "",
    "socials": [
      {
