const appData = {
  "brand": {
    "name": "Peter Lee Fire Company - Churches Fire & Security (CFS)",
    "tagline": "",
    "category": "",
    "location": "",
    "phone": ""
  ...
  "hero": {
    "eyebrow": "Innovative Fire Safety Solution",
    "title": "Stay Compliant, Safe, and Protected",
    "description": "Peterlee Fire Company helps facilities stay ahead of changing regulations with tailored fire protection services, ensuring compliance and reducing liability risks.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7443617/pexels-photo-7443617.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We leverage the latest advancements to deliver bespoke fire safety solutions that meet modern compliance standards."
      },
      {
        "title": "Trusted Expertise",
        "description": "With over a decade of experience, our team ensures reliable service tailored to your facility's needs."
      },
      {
        "title": "Unmatched Support",
        "description": "Our proactive customer service keeps you informed, compliant, and protected every step of the way."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Peterlee Fire Company provides comprehensive fire safety and protection services tailored to your facility's needs.",
    "cards": [
      {
        "icon": "🛋️",
        "title": "Fire Safety Consultation",
        "description": "Expert guidance on compliance requirements, foam replacements, and tailored safety strategies."
      },
      {
        "icon": "🛠️",
        "title": "Fire Protection Systems",
        "description": "Installation and maintenance of modern fire protection systems for maximum safety and reliability."
      },
      {
        "icon": "🎥",
        "title": "Security Systems",
        "description": "Advanced monitoring solutions to safeguard your facilities around the clock."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Leading Fire Safety Innovation",
    "paragraphs": [
      "Peterlee Fire Company was founded to address the growing complexities of fire safety regulations. Our bespoke solutions empower facilities to remain compliant while prioritizing safety and innovation.",
      "With a focus on cutting-edge technology and proactive service, we ensure our clients navigate regulatory challenges seamlessly, reducing liability risks and enhancing operational safety."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Peterlee Fire Company helped us replace outdated firefighting foam, ensuring compliance and reducing environmental risks. Their expertise",
        "name": "Sarah Thompson",
        "role": "Facility Manager, Institutional",
        "avatar": "https://images.pexels.com/photos/8774427/pexels-photo-8774427.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Thanks to Peterlee, staying ahead of regulations has never been easier. Their proactive updates and tailored solutions are a",
        "name": "John Eldridge",
        "role": "Health & Safety Officer, Church",
  ...
  "visit": {
    ...
    "description": "Connect with us to explore tailored solutions for your facility’s fire safety and protection needs.",
    "address": "",
    "website": "www.peterleefire.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Request a Consultation Today",
    "description": "Contact us to schedule a consultation and ensure your facilities are compliant, safe, and protected.",
    "consent": "By submitting, I agree to Peterlee Fire Company's privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Smarter Fire Safety Management",
    "description": "Harness AI and automation to simplify compliance, scheduling, and inventory tracking.",
    "bullets": [
      "Automated regulatory updates keep you informed of changes.",
      "Online booking ensures seamless scheduling and service renewals.",
      "Track foam and equipment inventory effortlessly with smart tools."
    ],
    "offer": "Mention Peter Lee Fire Company - Churches Fire & Security (CFS) for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Peter Lee Fire Company - Churches Fire & Security (CFS) delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
