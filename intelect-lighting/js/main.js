const appData = {
  "brand": {
    "name": "Intelect Lighting",
    "tagline": "Brighten Your Business",
    "category": "LED Lighting Solutions",
    "location": "UK Nationwide",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Energy Savings Experts",
    "title": "Reduce costs with efficient LED installations.",
    "description": "Cut energy expenses by 70-85% with our tailored LED lighting. Enjoy a free survey and no-obligation quote today!",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Clients save up to 85% on energy costs with our solutions."
      },
      {
        "title": "Expert Design",
        "description": "Our designs improve efficiency and meet lighting standards."
      },
      {
        "title": "Comprehensive Service",
        "description": "From surveys to installation, we handle everything seamlessly."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive LED solutions for industries across the UK.",
    "cards": [
      {
        "icon": "💡",
        "title": "Site Surveys",
        "description": "Get a detailed analysis with our expert site lighting surveys."
      },
      {
        "icon": "🔧",
        "title": "LED Design",
        "description": "Customized LED designs including emergency lighting solutions."
      },
      {
        "icon": "🏗",
        "title": "Installation",
        "description": "Professional on-site installation, with out-of-hours options."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Innovating Lighting Solutions",
    "paragraphs": [
      "Founded to deliver energy-efficient LED systems, Intelect Lighting Ltd has been transforming spaces across the UK.",
      "Our solutions offer measurable ROI by automating processes, reducing costs, and ensuring seamless installations."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Our energy bills dropped significantly. Their service was outstanding!",
        "name": "Jane Smith",
        "role": "Facilities Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "The LED design and installation were impeccable. Highly recommend!",
        "name": "John Doe",
  ...
  "visit": {
    ...
    "description": "Explore our solutions at our central office, located in the heart of the UK.",
    "address": "Address not available",
    "website": "www.intelectlighting.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request a Free Survey",
    "description": "Contact us today to book your complimentary lighting survey.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Savings",
    "description": "Streamline processes and maximize efficiency with AI solutions.",
    "bullets": [
      "Online survey form with automated follow-ups.",
      "ROI calculators for instant proposals.",
      "Automated case-study pages to boost trust."
    ],
    "offer": "Mention Intelect Lighting for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Intelect Lighting delivers unforgettable experiences.",
    "address": "Address not available",
    "email": "",
    "socials": [
      {
