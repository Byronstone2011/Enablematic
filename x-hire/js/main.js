const appData = {
  "brand": {
    "name": "X-Hire Platforms",
    "tagline": "Hire smarter, work safer",
    "category": "Equipment Rental",
    "location": "Nationwide UK",
    "phone": "0800 123 456"
  },
  "hero": {
    "eyebrow": "Efficient Equipment Hire",
    "title": "Streamline your projects with fast, reliable access hire.",
    "description": "X-Hire Platforms offers quick quotes and efficient scheduling to keep your projects on track.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Find the right equipment easily with our advanced search and filter options."
      },
      {
        "title": "Customer Trust",
        "description": "Trust badges and testimonials underscore our commitment to excellence."
      },
      {
        "title": "Dynamic Dispatch",
        "description": "Optimized dispatch ensures timely delivery for your urgent needs."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Versatile solutions for all your site needs, from access towers to plant hire.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Powered Access Hire",
        "description": "Boom lifts, scissor lifts, and cherry pickers for any height requirement."
      },
      {
        "icon": "🛠",
        "title": "Plant Hire",
        "description": "Comprehensive range of plant machinery for construction sites."
      },
      {
        "icon": "🚚",
        "title": "Logistics & Delivery",
        "description": "Efficient transport solutions ensure equipment arrives when needed."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Built on Trust and Efficiency",
    "paragraphs": [
      "X-Hire Platforms has been a leader in powered access hire, offering a wide range of equipment like boom and scissor lifts. We provide free quotes and reliable service.",
      "Our digital transformation enhances client experience with online bookings and automated systems, ensuring seamless operations and meeting industry needs effectively."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "X-Hire's quick delivery and easy booking process have transformed our site operations.",
        "name": "John Smith",
        "role": "Construction Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "The range of equipment and customer service is unmatched. Highly recommend X-Hire!",
        "name": "Emma Brown",
  ...
  "visit": {
    ...
    "description": "Discover our full range of services and equipment solutions.",
    "address": "N/A",
    "website": "www.x-hire.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get a Quote",
    "title": "Request Your Free Quote",
    "description": "Contact us today for a no-obligation quote tailored to your project needs.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Rental",
    "description": "Harness AI for seamless equipment hire management.",
    "bullets": [
      "Instant online quotes and bookings streamline your process.",
      "Automated dispatch optimizes fleet use for faster delivery.",
      "CRM integration captures leads efficiently, boosting engagement."
    ],
    "offer": "Mention X-Hire Platforms for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "X-Hire Platforms delivers unforgettable experiences.",
    "address": "N/A",
    "email": "",
    "socials": [
      {
