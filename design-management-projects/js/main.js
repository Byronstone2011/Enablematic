const appData = {
  ...
  "hero": {
    "eyebrow": "Expert Fitout Services",
    "title": "Efficient spaces, on budget, on time.",
    "description": "We manage projects seamlessly, ensuring timeliness and budget adherence. Transform your office effortlessly.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our designs are bespoke, focusing on functionality and aesthetics for every client."
      },
      {
        "title": "Seamless Management",
        "description": "We ensure smooth project flow with clear communication and efficient execution."
      },
      {
        "title": "Proven Expertise",
        "description": "Over a decade of experience delivering tailored solutions with precision and care."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Versatile fitout services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Office Fitout",
        "description": "Transform office spaces into productive and inspiring environments."
      },
      {
        "icon": "🛠",
        "title": "Retail Fitout",
        "description": "Create inviting retail spaces that enhance customer experience."
      },
      {
        "icon": "🏠",
        "title": "Home Office",
        "description": "Design functional home offices for remote work efficiency."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Spaces, Building Futures",
    "paragraphs": [
      "MD Interior Fitout Specialists, with over 10 years of expertise, transform spaces in the North West. We deliver bespoke designs and seamless project management.",
      "We embrace technology to improve client communication and efficiency, ensuring every project is a success from start to finish."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "MD Fitout transformed our office, keeping us informed and on budget. Exceptional service!",
        "name": "Jane Doe",
        "role": "Office Manager",
        "avatar": "https://images.pexels.com/photos/5201930/pexels-photo-5201930.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their project management was seamless. Our new retail space exceeded expectations.",
        "name": "John Smith",
        "role": "Retail Owner",
  ...
  "visit": {
    ...
    "description": "Located in the vibrant North West, our office is at the heart of innovation.",
    "address": "North West, UK",
    "website": "https://mdfitout.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Contact Us",
    "title": "Ready to Transform?",
    "description": "Contact us today for a consultation and start your fitout journey.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Efficiency with AI",
    "description": "Automate your projects with our advanced AI solutions.",
    "bullets": [
      "Automate lead capture and follow-up.",
      "Utilize our client portal for easy updates.",
      "Streamline invoicing and procurement."
    ],
    "offer": "Mention MD Fitout for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "MD Fitout delivers unforgettable experiences.",
    "address": "North West, UK",
    "email": "",
    "socials": [
      {
