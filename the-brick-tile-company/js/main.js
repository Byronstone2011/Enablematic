const appData = {
  ...
  "hero": {
    ...
    "title": "Simplify Your Brick Tile Projects",
    "description": "We help you visualize blends, calculate needs, and install with ease.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our brick slips are genuine clay, ensuring durability and style."
      },
      {
        "title": "Innovative Tools",
        "description": "Use our visualiser to effortlessly plan your project with precision."
      },
      {
        "title": "Expert Support",
        "description": "Access guides and installers for seamless installation processes."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our diverse range of products and services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Real Clay Slips",
        "description": "Choose from a variety of real clay brick slips for any project."
      },
      {
        "icon": "🛠",
        "title": "Accessories",
        "description": "Find all the consumables you need, from adhesives to spacers."
      },
      {
        "icon": "📦",
        "title": "Sample Panels",
        "description": "Order sample panels to see and feel our products before you buy."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "The Brick Tile Company started with a passion for authentic materials. Our brick slips are crafted from genuine clay, offering timeless beauty.",
      "Our commitment to quality and customer satisfaction sets us apart. We integrate technology to enhance your buying experience."
    ],
    "image": "https://images.pexels.com/photos/6474294/pexels-photo-6474294.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "The visualiser made planning easy and accurate. Highly recommend!",
        "name": "John D.",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/6474294/pexels-photo-6474294.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Installation was a breeze with their expert guides. Excellent service!",
        "name": "Sarah T.",
  ...
  "visit": {
    ...
    "description": "Experience our products firsthand and consult with our experts.",
    "address": "Visit us in the UK",
    "website": "brickhunter.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request a Consultation",
    "description": "Contact us to discuss your project needs and get expert advice.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Your Workflow",
    "description": "Automate your project planning and execution with our tools.",
    "bullets": [
      "Auto-generate quotes and proposals.",
      "Streamline sample order and tracking.",
      "Automate inventory alerts and schedules."
    ],
    "offer": "Mention Brick Tile Co. for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Brick Tile Co. delivers unforgettable experiences.",
    "address": "Visit us in the UK",
    "email": "",
    "socials": [
      {
