const appData = {
  "brand": {
    "name": "Marcon Construct",
    "tagline": "Building futures, preserving values",
    "category": "Construction",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Service & professionalism",
    "title": "Streamline your construction process with Marcon",
    "description": "We automate project management and enhance client onboarding for efficiency and growth.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/8469983/pexels-photo-8469983.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Decades of experience ensuring project excellence and client trust."
      },
      {
        "title": "Visual Impact",
        "description": "Showcasing projects with professional photography and clear design."
      },
      {
        "title": "Credibility",
        "description": "Accreditations and statistics reinforce our reliability and success."
      }
    ]
  },
  "offerings": {
    ...
    "cards": [
      {
        ...
        "description": "Expertly managing projects from concept to completion."
      },
      {
        "icon": "🏠",
        "title": "Roofing Services",
        "description": "Specialized in advanced roofing solutions for every need."
      },
      {
        "icon": "⚙️",
        "title": "Fast-Track Delivery",
        "description": "Efficiently delivering projects on time, every time."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Since 1996, Marcon Construction has thrived on delivering quality with a touch of tradition. We value professionalism and service above all.",
      "Our commitment to innovation makes us a preferred partner for NHS and commercial projects, addressing client needs with cutting-edge solutions."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Marcon streamlined our project, increasing efficiency and reducing stress.",
        "name": "John Smith",
      ...
      {
        "quote": "Their expertise in roofing services is unmatched in the industry.",
        "name": "Sarah Johnson",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Connect with Marcon",
    "description": "Discover how our construction services can transform your business.",
    "address": "N/A",
    "website": "marcon-construction.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Ready to Start?",
    "description": "Contact us to discuss your next project and see how we can help.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Efficiency with AI",
    "description": "Leverage AI for modern construction challenges.",
    "bullets": [
      "Automate lead capture for improved sales.",
      "Streamline tender processes with digital tools.",
      "Optimize project management through AI scheduling."
    ],
    "offer": "Mention Marcon Construct for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Marcon Construct delivers unforgettable experiences.",
    "address": "N/A",
    "email": "",
    "socials": [
      {
