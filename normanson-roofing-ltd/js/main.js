const appData = {
  "brand": {
    "name": "Normanson Roofing",
    "tagline": "Your Roof, Our Pride",
  ...
  "hero": {
    ...
    "title": "Fix leaks and protect solar panels today",
    "description": "Normanson Roofing offers reliable repairs and solar protection. Get fast quotes and accredited service.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7788269/pexels-photo-7788269.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our team brings over 30 years of experience to every project, ensuring quality results."
      },
      {
        "title": "Accredited Services",
        "description": "We offer certified roofing solutions, guaranteeing compliance and peace of mind."
      },
      {
        "title": "Customer-Centric Approa",
        "description": "Fast, transparent quotes and scheduling to suit your needs and meet your deadlines."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive roofing solutions for homes and developments.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Roof Installations",
        "description": "High-quality roofing installations tailored to your home's needs."
      },
      {
        "icon": "🔧",
        "title": "Roof Repairs",
        "description": "Prompt repair services to fix leaks and maintain roof integrity."
      },
      {
        "icon": "🛡",
        "title": "Solar Protection",
        "description": "Protect solar panels from birds with our effective solutions."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Legacy",
    "title": "Building Trust with Every Roof",
    "paragraphs": [
      "For over 30 years, Normanson Roofing has provided reliable roofing services in Rutland. Our expertise covers all aspects of roofing.",
      "We understand local needs and offer tailored solutions. Our automated tools streamline quotes and scheduling, ensuring efficiency."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Normanson fixed our leaky roof quickly. Their service was exceptional!",
        "name": "Emily Roberts",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Thanks to Normanson, our solar panels are now bird-free. Highly recommend!",
        "name": "John Smith",
        "role": "Property Developer",
        "avatar": "https://images.unsplash.com/photo-1722876720000-f39b65b7d4a1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxSb29maW5nJTIwJTJGJTIwQ29uc3RydWN0aW9uJTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI2NDg3NzB8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Find Us",
    "title": "Serving Rutland and Beyond",
    "description": "Based in Rutland, we serve Oakham and surrounding areas with top-notch roofing solutions.",
    "address": "Rutland, UK",
    "website": "www.normansonroofing.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get a Quote",
    "title": "Request Your Free Quote",
    "description": "Contact us today for a free, no-obligation quote tailored to your roofing needs.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Your Experience",
    "description": "Discover how automation improves our service.",
    "bullets": [
      "Automated quotes for quick estimates.",
      "Schedule appointments online easily.",
      "Digital invoices for hassle-free payments."
    ],
    "offer": "Mention Normanson Roofing for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Normanson Roofing delivers unforgettable experiences.",
    "address": "Rutland, UK",
    "email": "",
    "socials": [
      {
