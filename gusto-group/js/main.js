const appData = {
  "brand": {
    ...
    "location": "Collingham, Nottin",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Sustainable Impact",
    "title": "Streamline operations, maximize growth.",
    "description": "Gusto Group enhances efficiency with centralized CRM and automated workflows, boosting productivity.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We use a clean, minimalist aesthetic to ensure clarity and focus in all our projects."
      },
      {
        "title": "Expert Photography",
        "description": "Professional images highlight the unique aspects and quality of our business units."
      },
      {
        "title": "Organized Content",
        "description": "Clear brand hierarchy and structured content ensure easy navigation and understanding."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our diverse services designed to enhance sustainable living and community well-being.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Low-carbon Homes",
        "description": "We build eco-friendly homes that prioritize energy efficiency and sustainability."
      },
      {
        "icon": "🏢",
        "title": "Coworking Spaces",
        "description": "Our coworking spaces offer flexibility and support for local businesses and entrepreneurs."
      },
      {
        "icon": "🌱",
        "title": "Community Initiatives",
        "description": "We invest in grassroots sports and social projects, fostering community growth."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Gusto Group supports companies in construction, architecture, manufacturing, and community investment. Based in Nottinghamshire, we innovate for a sustainable tomorrow.",
      "Our centralized model allows us to scale efficiently, integrate digital growth, and improve operational workflows, ensuring exceptional service and community impact."
    ],
    "image": "https://images.pexels.com/photos/4491878/pexels-photo-4491878.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Gusto Group's solutions streamlined our operations and boosted our efficiency remarkably.",
        "name": "John Smith",
        "role": "Housing Provider",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their innovative approach to community investment has transformed local projects.",
        "name": "Emily Jones",
  ...
  "visit": {
    "eyebrow": "Location",
    "title": "Visit Us in Collingham",
    "description": "Experience the heart of sustainable innovation in Nottinghamshire, where community and business thrive.",
    "address": "Collingham, Nottinghamshire",
    "website": "https://gusto-uk.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Book a Consultation",
    "description": "Contact us to discuss how Gusto Group can help your business grow sustainably.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Efficiency with AI",
    "description": "Leverage AI to streamline your operations and boost productivity.",
    "bullets": [
      "Centralize CRM to nurture B2B relationships.",
      "Automate finance and project workflows.",
      "Improve lead capture across subsidiaries."
    ],
    "offer": "Mention Gusto Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Gusto Group delivers unforgettable experiences.",
    "address": "Collingham, Nottinghamshire",
    "email": "",
    "socials": [
      {
