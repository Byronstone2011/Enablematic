const appData = {
  "brand": {
    "name": "Playscheme",
    "tagline": "Playground innovation",
    "category": "Outdoor Play Equipment",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Safe, sustainable play",
    "title": "Simplify playground management today",
    "description": "Enhance safety and compliance while easing project management and scheduling.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our colorful designs captivate and engage young minds in play."
      },
      {
        "title": "Proven Expertise",
        "description": "Decades of experience ensure top-notch playground installations."
      },
      {
        "title": "Safety First",
        "description": "We prioritize safety with compliance and sustainability at the core."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Playscheme offers tailored play solutions for various sectors.",
    "cards": [
      {
        "icon": "🎨",
        "title": "Bespoke Design",
        "description": "Creative designs tailored to your specific environment and needs."
      },
      {
        "icon": "🏗",
        "title": "Equipment Installation",
        "description": "Quality installation of outdoor play equipment by experts."
      },
      {
        "icon": "🔧",
        "title": "Maintenance & Repair",
        "description": "Regular maintenance and repair services to ensure safety and longevity."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Playful Spaces",
    "paragraphs": [
      "Playscheme began with a passion for creating safe, fun play areas. Our commitment to quality and innovation has driven us to be leaders in design and installation.",
      "We offer tailored solutions, leveraging technology to streamline processes, ensuring safety and satisfaction for clients across diverse sectors."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Playscheme transformed our playground into a safe, exciting space. Their expertise is unmatched.",
        "name": "Emily Johnson",
        "role": "School Principal",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their attention to compliance and detail made our project seamless. Highly recommend!",
        "name": "Mark Thompson",
        "role": "Parks Manager",
  ...
  "visit": {
    ...
    "title": "Visit Us",
    "description": "Explore our playground innovations and see how we bring play to life.",
    "address": "",
    "website": "https://www.play-scheme.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Request a Consultation",
    "description": "Contact us today for custom playground solutions that meet your needs.",
    "consent": "I consent to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Playground Management",
    "description": "Streamline operations and enhance safety with our AI solutions.",
    "bullets": [
      "Capture leads with automated forms and follow-ups.",
      "Track projects and history with a CRM system.",
      "Automate maintenance scheduling and reminders."
    ],
    "offer": "Mention Playscheme for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Playscheme delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
