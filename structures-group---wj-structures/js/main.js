const appData = {
  ...
  "hero": {
    "eyebrow": "Trusted Structural Experts",
    "title": "Showcase your projects with confidence.",
    "description": "Structures Group excels in structural repair and conservation. We enhance trust with expert case studies and accreditations.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Bold Branding",
        "description": "Our iconic red branding ensures Structures Group leaves a lasting impression."
      },
      {
        "title": "Clean Typography",
        "description": "We use clear typography to communicate professionalism and clarity in all communications."
      },
      {
        "title": "Social Proof",
        "description": "Client testimonials highlight our reliability and excellence in structural projects."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Dedicated to delivering excellence in structural repair and conservation.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Structural Repair",
        "description": "We provide expert repair services to maintain and restore building integrity."
      },
      {
        "icon": "🧱",
        "title": "Masonry Work",
        "description": "Our skilled team excels in masonry, ensuring quality craftsmanship."
      },
      {
        "icon": "🏛",
        "title": "Building Conservation",
        "description": "We specialize in preserving historical structures with meticulous care."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Structures Group has been a leader in structural repair and conservation. We operate as WJ Structures and Structures Housing.",
      "Our expertise in specialized B2B construction ensures that we meet the unique needs of each project with precision."
    ],
    "image": "https://images.pexels.com/photos/2317640/pexels-photo-2317640.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Structures Group transformed our heritage site. Their professionalism set them apart.",
        "name": "Martin Spencer",
        "role": "Project Manager, Heritage Sites",
        "avatar": "https://images.pexels.com/photos/16934775/pexels-photo-16934775.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their masonry work exceeded our expectations, delivering on time and budget.",
        "name": "Sarah Turner",
  ...
  "visit": {
    ...
    "description": "Discover the artistry of Structures Group in Manchester, where history meets innovation.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact Lloyd Jolley at lloyd@structures.co.uk to discuss your next project.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Projects",
    "description": "Automation solutions that increase efficiency and trust.",
    "bullets": [
      "Capture leads with integrated forms and CRM.",
      "Automate quoting and scheduling workflows.",
      "Publish case studies to enhance credibility."
    ],
    "offer": "Mention Structures Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Structures Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
