const appData = {
  ...
  "hero": {
    ...
    "title": "Solutions for Reliable Commercial Roofing",
    "description": "Evermax Ltd solves roofing issues with efficient installations, repairs, and inspections.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our contact form ensures quick responses and seamless communication."
      },
      {
        "title": "Simple Layout",
        "description": "Our website design is clean and easy to navigate for all users."
      },
      {
        "title": "Professional Imagery",
        "description": "Our cityscape images reflect our industry expertise and style."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive commercial roofing services tailored for your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Roof Installation",
        "description": "Expert installation of durable commercial roofs tailored to your property."
      },
      {
        "icon": "🔧",
        "title": "Roof Repair",
        "description": "Reliable repair services to extend the life of your commercial roof."
      },
      {
        "icon": "🛠",
        "title": "Roof Inspection",
        "description": "Thorough inspections to assess and maintain your roof's condition."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Building Trust and Roofs",
    "paragraphs": [
      "Evermax Ltd has been a trusted name in commercial roofing, focusing on quality and reliability.",
      "Our solutions integrate advanced tech to streamline processes, ensuring client satisfaction."
    ],
    "image": "https://images.pexels.com/photos/4344115/pexels-photo-4344115.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Evermax's quick response and expert repairs saved our business from major disruptions.",
        "name": "Alex Johnson",
        "role": "Property Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their installation was flawless and timely. Highly recommend Evermax for any roofing needs.",
        "name": "Sarah Lee",
  ...
  "visit": {
    ...
    "description": "Located in the heart of the UK, our office is easily accessible for all clients.",
    "address": "123 Commercial Rd, City, UK",
    "website": "www.evermaxltd.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us Today",
    "description": "Reach out for consultations or to schedule a service. We’re here to help you.",
    "consent": "I agree to the terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate with AI",
    "description": "Streamline your roofing management with cutting-edge AI solutions.",
    "bullets": [
      "Fix contact form issues with automated confirmations.",
      "Integrate leads into CRM for seamless follow-ups.",
      "Implement online booking for convenient appointments."
    ],
    "offer": "Mention Evermax Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Evermax Ltd delivers unforgettable experiences.",
    "address": "123 Commercial Rd, City, UK",
    "email": "",
    "socials": [
      {
