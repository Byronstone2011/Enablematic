const appData = {
  ...
  "hero": {
    "eyebrow": "High-quality construction",
    "title": "Streamline projects, meet deadlines.",
    "description": "Morganstone Ltd eliminates delays with automated processes, ensuring efficient project completion.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/8961300/pexels-photo-8961300.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our projects are showcased with stunning aerial photography that highlights our expertise."
      },
      {
        "title": "Client Credibility",
        "description": "We feature a comprehensive client logo showcase, building trust and credibility."
      },
      {
        "title": "Multiple CTAs",
        "description": "Our site is designed with multiple CTAs, guiding clients efficiently through our services."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Morganstone Ltd provides comprehensive construction solutions tailored to the public, private, and housing association sectors.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Design",
        "description": "Innovative design solutions tailored to meet the specific needs of each project."
      },
      {
        "icon": "🏗",
        "title": "Construction",
        "description": "High-quality construction services ensuring structural integrity and aesthetic appeal."
      },
      {
        "icon": "🏗",
        "title": "Groundworks",
        "description": "Comprehensive groundwork services laying the foundation for successful projects."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Morganstone Ltd was established to provide high-quality construction solutions in Wales. We focus on delivering excellence across all sectors.",
      "We integrate AI to streamline processes, enhance efficiency, and reduce manual errors, aligning with our growth-oriented approach."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Morganstone's automation has drastically reduced our project delays. They're a reliable partner.",
        "name": "John Davies",
      ...
      {
        "quote": "Their efficient document management system made compliance a breeze for us.",
        "name": "Sarah Williams",
        "role": "Public Sector Coordinator",
        "avatar": "https://images.unsplash.com/photo-1753676531891-c66346f87eac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMkYlMjBEZXZlbG9wbWVudCUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4MjA0fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Located in the heart of Wales, we serve local communities with dedication and expertise.",
    "address": "Wales, UK",
    "website": "https://www.morganstone.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Start Your Project",
    "description": "Contact us today to discuss your construction needs and schedule a consultation.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate & Optimize",
    "description": "Enhance efficiency with our AI-powered solutions.",
    "bullets": [
      "Automate CRM and lead management.",
      "Streamline document compliance.",
      "Integrate project management tools."
    ],
    "offer": "Mention Morganstone Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Morganstone Ltd delivers unforgettable experiences.",
    "address": "Wales, UK",
    "email": "",
    "socials": [
      {
