const appData = {
  "brand": {
    "name": "Utility Site Soluti",
    "tagline": "Hire. Operate. Excel.",
    "category": "Construction & Utilities",
    "location": "Birmingham, UK",
    "phone": "+44 1234 567890"
  },
  "hero": {
    "eyebrow": "Expert Equipment Hire",
    "title": "Efficient solutions for site delays.",
    "description": "We provide reliable vacuum excavation and road sweepers with trained operators to keep your projects on track.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "High-quality, maintained machinery ensures project efficiency and safety."
      },
      {
        "title": "Expert Operators",
        "description": "Our skilled operators guarantee smooth and effective equipment use."
      },
      {
        "title": "Comprehensive Service",
        "description": "From planning to execution, we support each stage of your project."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our range of services meets all your construction and utility needs.",
    "cards": [
      {
        "icon": "🚜",
        "title": "Vacuum Excavation",
        "description": "Safe and efficient excavation services with our operated machinery."
      },
      {
        "icon": "🧹",
        "title": "Road Sweeper Hire",
        "description": "Keep your sites clean with our road sweepers and expert operators."
      },
      {
        "icon": "👷",
        "title": "Site Support",
        "description": "Comprehensive planning and support for your construction projects."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Excellence in Equipment Hire",
    "paragraphs": [
      "Utility Site Solutions Ltd has been a leading provider of operated vacuum excavation and road sweeper equipment in Birmingham and the West Midlands.",
      "Our commitment to reliability and service ensures that clients have access to the equipment and expertise needed to complete their infrastructure projects efficiently."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Utility Site Solutions helped us meet deadlines with their reliable equipment and skilled operators.",
        "name": "John Smith",
        "role": "Project Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "The team provided excellent planning and site support, keeping our project on track.",
        "name": "Sarah Jones",
  ...
  "visit": {
    ...
    "title": "Visit Birmingham",
    "description": "Discover the vibrant cityscape and rich industrial heritage of Birmingham, a hub for innovation and growth.",
    "address": "Birmingham, West Midlands, UK",
    "website": "utilitysitesolutions.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Contact Us Today",
    "description": "Reach out for equipment hire inquiries or project consultations.",
    "consent": "I agree to the privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Workflow",
    "description": "Leverage AI to enhance efficiency and client satisfaction.",
    "bullets": [
      "Real-time booking and availability calendar.",
      "Automated lead capture for swift follow-ups.",
      "CRM integration for seamless communication."
    ],
    "offer": "Mention Utility Site Soluti for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Utility Site Soluti delivers unforgettable experiences.",
    "address": "Birmingham, West Midlands, UK",
    "email": "",
    "socials": [
      {
