const appData = {
  "brand": {
    "name": "Sol Acoustics",
    "tagline": "Sound solutions, expertly crafted",
    "category": "Acoustic Consultancy",
    "location": "UK-based",
    "phone": "Unavailable"
  },
  "hero": {
    "eyebrow": "Acoustic excellence",
    "title": "Ensure compliance with expert acoustic design",
    "description": "Sol Acoustics ensures your projects meet acoustic standards with rapid support and expert solutions.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We bring over 20 years of experience to each project, ensuring top-notch results."
      },
      {
        "title": "Tailored Solutions",
        "description": "Our services are customized to meet the unique needs of every client and project."
      },
      {
        "title": "Client Support",
        "description": "Rapid response and support are available to solve on-site issues quickly."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Discover our comprehensive acoustic services tailored to your needs.",
    "cards": [
      {
        "icon": "💼",
        "title": "Acoustic Consultancy",
        "description": "Expert guidance on achieving perfect sound environments for any project."
      },
      {
        "icon": "📊",
        "title": "Noise Assessments",
        "description": "Thorough assessments and reporting to ensure regulatory compliance."
      },
      {
        "icon": "🏗",
        "title": "Design & Mitigation",
        "description": "Create and implement strategies to manage sound effectively in your space."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Leading with Sound Expertise",
    "paragraphs": [
      "For over 20 years, Sol Acoustics has been a leader in acoustic design, providing top-tier solutions that ensure project success.",
      "We focus on transforming our reputation into reliable, automated leads and streamlined client workflows, enhancing digital presence."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Sol Acoustics helped us meet all regulations swiftly. Their support is unmatched.",
        "name": "Jane Doe",
        "role": "Project Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their expertise and quick problem-solving saved us time and ensured compliance.",
        "name": "John Smith",
        "role": "Architect",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Connect with Sol Acoustics",
    "description": "Explore our services and see how we can enhance your projects.",
    "address": "Contact for details",
    "website": "www.solacoustics.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Ready to enhance your project?",
    "description": "Contact us today to discuss your acoustic needs and schedule a consultation.",
    "consent": "Consent to contact"
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Acoustic Projects",
    "description": "Enhance efficiency with AI-driven solutions.",
    "bullets": [
      "Book consultations online with ease.",
      "Automate proposals for faster client response.",
      "Streamline project updates via client portals."
    ],
    "offer": "Mention Sol Acoustics for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Sol Acoustics delivers unforgettable experiences.",
    "address": "Contact for details",
    "email": "",
    "socials": [
      {
