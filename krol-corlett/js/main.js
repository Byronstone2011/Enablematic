const appData = {
  ...
  "hero": {
    ...
    "title": "Streamlined projects, on time.",
    "description": "With 50+ years of expertise, we simplify procurement, deliver excellence, and reduce manual processes for seamless results.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Over 50 years of delivering high-quality projects with precision and care."
      },
      {
        "title": "On-Time Delivery",
        "description": "We complete projects on schedule and within budget, every time."
      },
      {
        "title": "Exceptional Standards",
        "description": "Our work sets benchmarks in the UK construction industry."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We specialize in tailored construction solutions across diverse sectors.",
    "cards": [
      {
        "icon": "🏗",
        "title": "General Construction",
        "description": "From foundations to finishes, we manage every stage of your build."
      },
      {
        "icon": "⚕️",
        "title": "Healthcare Projects",
        "description": "We create safe, functional spaces for healthcare facilities."
      },
      {
        "icon": "🏛",
        "title": "Heritage Restoration",
        "description": "Preserving history through meticulous restoration work."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Since our founding, Krol Corlett has been committed to delivering quality construction projects across England and North Wales. Our work spans sectors including education, healthcare, and heritage restoration.",
      "We excel in simplifying procurement processes, meeting diverse client needs, and integrating innovative solutions. Our approach ensures efficiency and outstanding results."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Krol Corlett simplified our procurement process and delivered a flawless project on time and within budget.",
        "name": "Sarah James",
        "role": "Public Sector Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their expertise in heritage restoration brought our vision to life while preserving its historical essence.",
        "name": "John Carter",
        "role": "Developer",
  ...
  "visit": {
    ...
    "title": "Building across the UK",
    "description": "We proudly serve England and North Wales, delivering exceptional construction solutions.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us for consultations or bookings. Let’s bring your vision to life.",
    "consent": "Your information is safe with us."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Smart solutions for construction",
    "description": "Streamline workflows and improve efficiency with AI-driven tools.",
    "bullets": [
      "Automate tender and bid tracking for better organization.",
      "Integrate CRM to capture and nurture leads effortlessly.",
      "Provide client portals for real-time project updates."
    ],
