const appData = {
  "brand": {
    "name": "Rollo Dev.",
    "tagline": "Crafting spaces with care",
    "category": "Renovation & Construction",
    "location": "Edinburgh, UK",
    "phone": "0131 210 0074"
  },
  "hero": {
    "eyebrow": "Trusted Renovation Leaders",
    "title": "Quality renovations with clear pricing.",
    "description": "Experience seamless project management and bespoke craftsmanship with transparent pricing.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our clean design enhances every space, creating elegance and functionality."
      },
      {
        "title": "Trusted Partners",
        "description": "We collaborate with certified partners to ensure quality and trust."
      },
      {
        "title": "Visual Impact",
        "description": "Our projects feature striking visuals that captivate and inspire."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our comprehensive renovation services tailored to your needs.",
    "cards": [
      {
        "icon": "🏠",
        "title": "Home Renovations",
        "description": "Transform your living spaces with our expert home renovation services."
      },
      {
        "icon": "🏢",
        "title": "Commercial Renovations",
        "description": "Enhance your business environment with tailored commercial renovations."
      },
      {
        "icon": "🛠",
        "title": "Bespoke Joinery",
        "description": "Custom joinery crafted by Timbex Creations for unique furniture solutions."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Rollo Developments has spent decades perfecting the art of renovation, transforming homes and commercial spaces with precision.",
      "We pride ourselves on delivering bespoke craftsmanship and exceptional service, tailored to meet the unique needs of our clients."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Rollo made our dream home a reality with clear communication and attention to detail.",
        "name": "Jane Smith",
        "role": "Homeowner",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their project management was seamless, making our office renovation stress-free.",
        "name": "Mark Johnson",
        "role": "Business Owner",
  ...
  "visit": {
    ...
    "description": "Discover our completed projects across Edinburgh, showcasing our expertise.",
    "address": "Edinburgh, UK",
    "website": "www.rollodevelopments.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Request a Consultation",
    "description": "Contact us today to start your renovation journey.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Your Experience",
    "description": "Leverage AI for seamless project management and client satisfaction.",
    "bullets": [
      "Instant online quotations for quick estimates.",
      "Real-time project updates via client portal.",
      "Automated follow-ups to keep you informed."
    ],
    "offer": "Mention Rollo Dev. for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Rollo Dev. delivers unforgettable experiences.",
    "address": "Edinburgh, UK",
    "email": "",
    "socials": [
      {
