const appData = {
  ...
  "hero": {
    ...
    "title": "Streamline site security with our expertise",
    "description": "JR Hoarding & Fencing Ltd offers automated solutions for quoting, scheduling, and inventory management to boost efficiency.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We categorize services for easy navigation, ensuring clients find what they need quickly."
      },
      {
        "title": "Certified Quality",
        "description": "Our certifications build trust and demonstrate our commitment to industry standards."
      },
      {
        "title": "Visual Excellence",
        "description": "A strong visual hierarchy makes our site easy to use and visually appealing."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive hoarding and fencing solutions tailored to your construction needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Site Hoarding",
        "description": "We supply and install robust site hoarding to secure your construction perimeter."
      },
      {
        "icon": "🛡",
        "title": "Perimeter Fencing",
        "description": "Install temporary or permanent fencing to protect and manage access to your site."
      },
      {
        "icon": "🔒",
        "title": "Hoarding Hire",
        "description": "Flexible hoarding hire options and security solutions to fit your project's timeline."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "JR Hoarding & Fencing Ltd has been securing construction sites with precision and reliability for over two decades.",
      "Our solutions are designed to address common industry pain points, making us the preferred choice for contractors."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "JR Hoarding streamlined our project with efficient fencing solutions.",
        "name": "Alex Wright",
        "role": "Site Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their automated systems saved us time and reduced costs significantly.",
        "name": "Jordan Lee",
  ...
  "visit": {
    ...
    "description": "We are located in a convenient area with easy access to major construction hubs.",
    "address": "Unknown",
    "website": "www.jrhoarding.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Contact Us Today",
    "description": "Reach out for a consultation or to schedule your next project with us.",
  ...
  "byronCallout": {
    ...
    "bullets": [
      ...
      "Automated scheduling for seamless operations.",
      "Efficient inventory tracking to reduce waste."
    ],
    "offer": "Mention JR Hoarding for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "JR Hoarding delivers unforgettable experiences.",
    "address": "Unknown",
    "email": "",
    "socials": [
      {
