const appData = {
  ...
  "hero": {
    "eyebrow": "Streamlined Fit-Outs",
    "title": "Eliminate delays with expert coordination.",
    "description": "Archer handles complex fit-outs, minimizing risks and optimizing processes for seamless project delivery.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our neon green brand color stands out and ensures memorable recognition."
      },
      {
        "title": "Personal Touch",
        "description": "We focus on building strong relationships through personal, trust-building communication."
      },
      {
        "title": "Expert Photography",
        "description": "Professional founder photography enhances our brand's professional image."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We provide top-notch fit-out services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Cat A Fit-Outs",
        "description": "Transforming spaces to create functional, ready-to-use offices."
      },
      {
        "icon": "🏗",
        "title": "Cat B Fit-Outs",
        "description": "Customizing interiors to meet specific client requirements."
      },
      {
        "icon": "💼",
        "title": "Project Management",
        "description": "Comprehensive management for seamless project execution."
      }
    ]
  },
  "story": {
    ...
    "title": "Our Journey",
    "paragraphs": [
      "Archer was founded to revolutionize commercial fit-outs with a focus on precision and client satisfaction. Our team is passionate about delivering excellence.",
      "We leverage CRM and project automation to streamline operations, enhancing client experience and ensuring timely project delivery."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Archer's coordination significantly reduced our project timeline and budget risks.",
        "name": "Lisa Brown",
        "role": "Property Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their project management automation made our fit-out process seamless.",
        "name": "John Smith",
  ...
  "visit": {
    ...
    "description": "Located in the UK, Archer serves clients across the country with top-notch fit-out solutions.",
    "address": "N/A",
    "website": "archerbuild.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us",
    "description": "Reach out for a consultation and see how we can transform your space.",
    "consent": "By submitting, you agree to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate with Archer",
    "description": "Enhance efficiency and client satisfaction with our automation solutions.",
    "bullets": [
      "Automated CRM for seamless client follow-ups.",
      "Streamlined project management workflows.",
      "Efficient document control and procurement."
    ],
    "offer": "Mention Archer for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Archer delivers unforgettable experiences.",
    "address": "N/A",
    "email": "",
    "socials": [
      {
