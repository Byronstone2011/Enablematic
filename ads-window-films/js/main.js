const appData = {
  "brand": {
    "name": "ADS Window Films",
    "tagline": "Energy-saving solutions",
    "category": "Window Film Installation",
    "location": "Plymouth, Devon",
    "phone": "01752 252583"
  },
  "hero": {
    "eyebrow": "Trusted UK specialists",
    "title": "Effortless film installation made simple",
    "description": "ADS Window Films offers advanced solutions to save energy, enhance privacy, and protect interiors. Call us for expert advice and installation.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "15+ years of experience delivering top-notch window film installations."
      },
      {
        "title": "Unmatched Quality",
        "description": "We use premium-grade materials ensuring long-lasting results every time."
      },
      {
        "title": "Customer First",
        "description": "Dedicated service with personalized solutions tailored to your needs."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our films improve energy efficiency, privacy, and aesthetics for homes, offices, and vehicles.",
    "cards": [
      {
        "icon": "🏠",
        "title": "Residential Films",
        "description": "Boost home comfort with solar, UV-blocking, and privacy window films."
      },
      {
        "icon": "🏢",
        "title": "Commercial Films",
        "description": "Enhance security, branding, and energy savings for your office space."
      },
      {
        "icon": "🚗",
        "title": "Automotive Tints",
        "description": "Improve vehicle privacy and reduce heat with quality car window tints."
      }
    ]
  },
  "story": {
    "eyebrow": "Our journey",
    "title": "Passionate about quality films",
    "paragraphs": [
      "ADS Window Films was founded to provide reliable, energy-saving solutions. We've earned trust through exceptional service and craftsmanship.",
      "Our reputation and expertise allow us to deliver unique value. We use advanced technology to improve efficiency and customer satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "ADS transformed my office with sleek window films. Energy savings were noticeable immediately!",
        "name": "Sarah T.",
        "role": "Office Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their automotive tints exceeded my expectations. Professional, fast, and affordable service!",
        "name": "James R.",
        "role": "Vehicle Owner",
  ...
  "visit": {
    "eyebrow": "Visit us",
    "title": "Serving the South West and UK",
    "description": "We proudly serve Plymouth, Devon, Cornwall, and surrounding areas. Call us to book your consultation today.",
    "address": "Plymouth, UK",
    "website": "www.adswindowfilms.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in touch",
    "title": "Book your consultation now",
    "description": "Contact us today to discuss your window film needs. Call 01752 252583 or email gary@adswindowfilms.co.uk.",
    "consent": "Your information will remain private."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate your business",
    "description": "ADS can streamline operations and enhance customer experience with AI tools.",
    "bullets": [
      "Instant online quotes and booking systems.",
      "Automated lead follow-ups and reminders.",
      "Efficient project scheduling and tracking."
    ],
    "offer": "Mention ADS Window Films for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "ADS Window Films delivers unforgettable experiences.",
    "address": "Plymouth, UK",
    "email": "",
    "socials": [
      {
