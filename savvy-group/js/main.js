const appData = {
  "brand": {
    "name": "Savvy Group",
    "tagline": "Crafting Heritage Elegance",
  ...
  "hero": {
    ...
    "title": "Streamline your construction projects with Savvy.",
    "description": "We enhance efficiency with automated quotes, updates, and client management.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our projects reflect the highest quality and attention to detail."
      },
      {
        "title": "Trusted Partnerships",
        "description": "We partner with recognized institutions for credible results."
      },
      {
        "title": "Innovative Solutions",
        "description": "We integrate modern technology for efficient project management."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Transforming spaces with exceptional construction services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Fine Construction",
        "description": "Delivering excellence in new builds and custom designs."
      },
      {
        "icon": "🏛",
        "title": "Renovation",
        "description": "Breathing new life into existing structures with precision."
      },
      {
        "icon": "🔨",
        "title": "Restoration",
        "description": "Preserving heritage with careful restoration techniques."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Legacy",
    "title": "Building the Future with History",
    "paragraphs": [
      "Savvy Group is renowned for transforming Oxfordshire’s landmarks. Our expertise spans construction and heritage restoration.",
      "Combining tradition with technology, we redefine the construction experience, offering unmatched quality and efficiency."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Savvy Group simplified our complex renovation with seamless communication.",
        "name": "Dr. Emily Carter",
        "role": "Estate Manager",
        "avatar": "https://images.pexels.com/photos/6050250/pexels-photo-6050250.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their automated updates kept our project on track and stress-free.",
        "name": "James Upfield",
        "role": "Library Director",
        "avatar": "https://images.unsplash.com/photo-1762344687817-77fbdeedef99?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMjhmaW5lJTIwY29uc3RydWN0aW9uJTJDJTIwcmVub3ZhdGlvbiUyMCUyNiUyMHJlc3RvcmF0aW9uJTI5JTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI2NDg2ODl8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Explore our work in Oxfordshire's historic sites.",
    "address": "Unknown",
    "website": "www.group-savvy.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Start Your Project",
    "description": "Contact us to discuss your construction needs today.",
    "consent": "We value your privacy. Consent required."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Efficiency",
    "description": "Leverage AI for smarter project management.",
    "bullets": [
      "Automated quotes save time.",
      "Client portal for easy updates.",
      "CRM integration boosts lead capture."
    ],
    "offer": "Mention Savvy Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Savvy Group delivers unforgettable experiences.",
    "address": "Unknown",
    "email": "",
    "socials": [
      {
