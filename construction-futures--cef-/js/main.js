const appData = {
  "brand": {
    "name": "CEF",
    "tagline": "Building Careers, Supporting Growth",
    "category": "Construction Workforce Dev",
    "location": "Nationwide",
    "phone": "Unavailable"
  },
  "hero": {
    "eyebrow": "Empowering Construction",
    "title": "Boost your workforce with CEF solutions.",
    "description": "We attract, develop, and retain talent, enhancing career pathways and mental health support.",
    "highlights": [
      {
        "label": "Career Events",
        "value": "100+"
      ...
      {
        "label": "Retention Programs",
        "value": "85% Succes"
      }
    ],
    "image": "https://images.pexels.com/photos/12129402/pexels-photo-12129402.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our consistent branding builds trust and recognition across the industry."
      },
      {
        "title": "Clear Hierarchy",
        "description": "We offer well-structured programs that meet industry needs effectively."
      },
      {
        "title": "Proven Heritage",
        "description": "Celebrating 80 years of excellence in workforce development."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive programs to support and develop the construction workforce.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Career Events",
        "description": "Open Doors events offer firsthand industry insights to jobseekers."
      },
      {
        "icon": "💼",
        "title": "Workforce Programs",
        "description": "Attract and retain talent with our tailored development programs."
      },
      {
        "icon": "⚕️",
        "title": "Mental Health Support",
        "description": "Join the Building Mental Health Alliance for vital resources."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Leading the Way in Workforce Development",
    "paragraphs": [
      "Since our founding, CEF has championed workforce development in construction. We bridge gaps between employers and skilled workers.",
      "With automation and digital solutions, we enhance engagement and streamline processes, ensuring sector growth and stability."
    ],
    "image": "https://images.pexels.com/photos/8961160/pexels-photo-8961160.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    "eyebrow": "Hear from Our Partners",
    "title": "What Our Clients Say",
    "list": [
      {
        "quote": "CEF helped us attract skilled workers and improved our retention rates significantly.",
        "name": "John Doe",
        "role": "HR Manager",
        "avatar": "https://images.pexels.com/photos/3931131/pexels-photo-3931131.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their mental health support initiatives have been invaluable to our team.",
        "name": "Jane Smith",
        "role": "Project Leader",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Connect with CEF",
    "description": "Join us at events nationwide or connect online to learn more.",
    "address": "Nationwide",
  ...
  "inquiry": {
    ...
    "description": "Contact us to join our mission and enhance your workforce.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance with Automation",
    "description": "Streamline operations with CEF's digital solutions.",
    "bullets": [
      "Automate event registrations and reminders.",
      "Utilize CRM for tracking and engagement.",
      "Implement mental health support tools."
    ],
    "offer": "Mention CEF for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "CEF delivers unforgettable experiences.",
    "address": "Nationwide",
    "email": "",
    "socials": [
      {
