const appData = {
  ...
  "hero": {
    "eyebrow": "Since 1931",
    "title": "Simplify your building journey today.",
    "description": "We tackle audience management, event logistics, and seamless CRM integration, ensuring a streamlined experience for all professionals.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our space boasts a clean, organized layout for easy navigation and engagement."
      },
      {
        "title": "Expert Visuals",
        "description": "We use professional photography to enhance our presentations and exhibitions."
      },
      {
        "title": "Clear Structure",
        "description": "Our content hierarchy is well-organized, ensuring information is easily accessible."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our diverse range of services tailored for the construction industry.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Event & Exhibitions",
        "description": "Join our industry-leading events and exhibitions designed for professionals."
      },
      {
        "icon": "💼",
        "title": "Networking & Membership",
        "description": "Connect with peers through our membership programs and networking events."
      },
      {
        "icon": "📘",
        "title": "Training & CPD",
        "description": "Enhance your skills with our comprehensive training and CPD offerings."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Since 1931, Building Centre has been the cornerstone of the built environment sector, providing a hub for innovation and collaboration.",
      "We cater to varied professional needs through tailored services, leveraging digital solutions to enhance efficiency and engagement."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Building Centre streamlined our event management and improved our member engagement significantly.",
        "name": "Alex Turner",
        "role": "Project Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their CRM integration transformed our lead nurture process, making it more efficient.",
        "name": "Jamie Lee",
  ...
  "visit": {
    ...
    "description": "Visit Building Centre to experience our innovative environment and vibrant community.",
  ...
  "inquiry": {
    ...
    "description": "Reach out for bookings, consultations, or inquiries. We're here to assist you.",
    "consent": "Yes, I agree to the terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance with AI",
    "description": "Leverage automation to elevate your building projects.",
    "bullets": [
      "Automate event workflows for seamless operations.",
      "Personalized content delivery enhances user engagement.",
      "Unify leads with CRM integration for effective campaigns."
    ],
    "offer": "Mention Build Centre for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Build Centre delivers unforgettable experiences.",
    "address": "Details Unavailable",
    "email": "",
    "socials": [
      {
