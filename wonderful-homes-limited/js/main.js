const appData = {
  "brand": {
    "name": "Wonderful Homes Ltd",
    "tagline": "Creating bespoke living spaces",
    "category": "Residential Property Developer",
    "location": "West Midlands, UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Your trusted developer",
    "title": "Transforming land into stunning homes.",
    "description": "We acquire land, design bespoke homes, and simplify off-plan customisation for buyers and agents in the West Midlands.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We craft homes with innovative designs tailored to modern living."
      },
      {
        "title": "Bespoke Customisation",
        "description": "Off-plan buyers enjoy full customisation for truly unique homes."
      },
      {
        "title": "Trusted Expertise",
        "description": "Decades of experience ensure quality and reliability in every project."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our services include land acquisition, bespoke home construction, and expert appraisals.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Land Acquisition",
        "description": "We purchase land and provide free planning appraisals to maximize opportunities."
      },
      {
        "icon": "🏠",
        "title": "Home Development",
        "description": "Design-led construction of bespoke new-build homes tailored to your needs."
      },
      {
        "icon": "📐",
        "title": "Customisation",
        "description": "Off-plan buyers can tweak layouts and finishes for their perfect home."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Wonderful Homes Limited specializes in transforming land into bespoke residential spaces. Focused on quality and innovation, we craft homes that inspire.",
      "With expertise in land acquisition and customisation, we automate buyer journeys for seamless experiences. We ensure satisfaction at every stage."
    ],
    "image": "https://images.pexels.com/photos/8482828/pexels-photo-8482828.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    "eyebrow": "What clients say",
    "title": "Real feedback from landowners and buyers.",
    "list": [
      {
        "quote": "Wonderful Homes made selling our land effortless. Their team handled everything smoothly.",
        "name": "Sarah Johnson",
        "role": "Landowner",
        "avatar": "https://images.pexels.com/photos/34558071/pexels-photo-34558071.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "We loved customising our off-plan home! The process was easy and stress-free.",
        "name": "David Owens",
        "role": "Homebuyer",
        "avatar": "https://images.unsplash.com/photo-1600823921092-3f4f46012566?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxSZXNpZGVudGlhbCUyMHByb3BlcnR5JTIwZGV2ZWxvcG1lbnQlMjAlMkYlMjBob3VzZWJ1aWxkaW5nJTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI0MzMyNjN8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Where we operate",
    "title": "Serving the West Midlands area",
    "description": "From Solihull to Staffordshire, we build homes in vibrant communities across the region.",
    "address": "",
    "website": "www.wonderfulhomes.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Ready to connect?",
    "title": "Contact us today.",
    "description": "Have land to sell or want to discuss your dream home? Reach out for consultations.",
    "consent": "We respect your privacy and only use your data for inquiries."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automated solutions for efficiency",
    "description": "AI-powered tools streamline appraisals, buyer journeys, and customisation processes.",
    "bullets": [
      "Instant appraisal confirmations for landowners.",
      "Automated workflows for off-plan customisation.",
      "Drip campaigns for new developments and updates."
    ],
    "offer": "Mention Wonderful Homes Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Wonderful Homes Ltd delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
