const appData = {
  ...
  "hero": {
    ...
    "title": "Streamline your projects with Carroll Group Ltd",
    "description": "We simplify construction management to keep projects on time and budget, enhancing client satisfaction.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Showcasing our craftsmanship through real construction images."
      },
      {
        "title": "Clear Service Segments",
        "description": "Distinct sections for each service, ensuring clarity."
      },
      {
        "title": "Breezy Layout",
        "description": "Clean design with ample whitespace for a modern look."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our comprehensive services cater to all your construction needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "New Build Construction",
        "description": "Expertly crafted new builds, from design to completion."
      },
      {
        "icon": "🔨",
      ...
      },
      {
        ...
        "description": "Comprehensive roofing solutions for all projects."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Carroll Group Ltd has been a cornerstone in the construction industry, dedicated to quality and innovation.",
      "We leverage technology to enhance efficiency and client relations, ensuring top-notch service."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Carroll Group Ltd kept our project on time and budget. Highly recommend!",
        "name": "John Smith",
        "role": "Property Developer",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their expertise in managing complex workflows is unmatched!",
        "name": "Jane Doe",
  ...
  "visit": {
    ...
    "description": "Explore our projects in the North West UK, where innovation meets excellence.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us for consultations and quotes tailored to your needs.",
    "consent": "We respect your privacy and never share your data."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Harness AI for Efficiency",
    "description": "Revolutionize your operations with automation.",
    "bullets": [
      "Automate lead capture with CRM systems.",
      "Streamline client updates with project portals.",
      "Enhance payments with digital invoicing."
    ],
    "offer": "Mention Carroll Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Carroll Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
