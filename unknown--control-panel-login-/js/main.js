const appData = {
  "brand": {
    "name": "Grove Site Services",
    "tagline": "Streamline Your IT Management",
    "category": "Technology / SaaS / IT",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Leading IT Solutions",
    "title": "Secure and Efficient IT Management",
    "description": "We simplify IT operations with advanced automation, enhancing security and user experience.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our platform features clear branding and simple, effective user interfaces."
      },
      {
        "title": "Strong Security",
        "description": "We ensure robust security with MFA and real-time login alerts."
      },
      {
        "title": "User-Friendly",
        "description": "Our intuitive control panel makes account management a breeze."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive IT management services tailored for administrators and IT staff.",
    "cards": [
      {
        "icon": "🔐",
        "title": "Account Management",
        "description": "Manage accounts effortlessly with our advanced control panel."
      },
      {
        "icon": "🛡",
        "title": "User Authentication",
        "description": "Secure your access with robust authentication solutions."
      },
      {
        "icon": "⚙️",
        "title": "Admin Portal",
        "description": "Customize settings and user roles efficiently with our admin portal."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Grove Site Services was established to transform IT management through innovative solutions. Our goal is to enhance efficiency and security in web hosting.",
      "Our services are tailored for companies needing robust automation and security. We excel in modernizing IT systems, ensuring seamless operations."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Grove Site Services transformed our IT management. Our security issues have vanished!",
        "name": "Anna Smith",
        "role": "IT Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their automation tools saved us time and improved our workflow significantly.",
        "name": "John Doe",
  ...
  "visit": {
    ...
    "description": "Discover how we can optimize your IT management with our innovative solutions.",
    "address": "",
    "website": "grovesiteservices.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us Today",
    "description": "Reach out for a consultation on how Grove can enhance your IT operations.",
    "consent": "I agree to receive communications from Grove."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate with Grove",
    "description": "Leverage AI to streamline your IT processes and enhance security.",
    "bullets": [
      "Automated user provisioning boosts efficiency.",
      "Self-service password resets save time.",
      "Real-time security alerts prevent breaches."
    ],
    "offer": "Mention Grove Site Services for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Grove Site Services delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
