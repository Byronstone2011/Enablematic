const appData = {
  ...
  "story": {
    ...
    "paragraphs": [
      "Retail Fire Limited was founded with one mission: to provide retail businesses with reliable fire safety solutions tailored to their unique needs. From design and installation to maintenance and consulting, we’ve built our",
      "With a focus on retail-specific challenges, we simplify fire safety management through expert service and automation. Our commitment to proactive compliance keeps businesses protected, allowing owners to focus on what matters most—their customers."
    ],
  ...
  "visit": {
    ...
    "description": "Our office in Birmingham serves as the hub for retail fire safety expertise. We’re here to support local businesses with fast, efficient service.",
