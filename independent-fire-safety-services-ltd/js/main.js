const appData = {
  "brand": {
    "name": "Indep. Fire Safety",
    "tagline": "Leading Fire Safety Experts",
    "category": "Fire Safety & Compliance",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "UKAS Accredited Inspections",
    "title": "Stay Compliant, Reduce Risks",
    "description": "We streamline fire safety compliance with expert inspections, automated scheduling, and thorough reporting.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our UKAS accreditation ensures the highest standard of fire door inspections."
      },
      {
        "title": "Comprehensive Service",
        "description": "We offer a full range of services from inspections to training and remedial actions."
      },
      {
        "title": "Advanced Reporting",
        "description": "Automated reports and certificates simplify compliance documentation."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We provide specialized fire safety services to ensure your building's compliance.",
    "cards": [
      {
        "icon": "🔥",
        "title": "Fire Door Inspections",
        "description": "Expert inspections to ensure fire doors meet all safety standards."
      },
      {
        "icon": "🛡",
        "title": "Firestopping Surveys",
        "description": "Identify and address firestopping deficiencies in your building."
      },
      {
        "icon": "💼",
        "title": "Risk Assessments",
        "description": "Comprehensive assessments to mitigate fire risks effectively."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Independent Fire Safety Services Limited champions fire safety through expert inspections and compliance services.",
      "Our automated solutions streamline scheduling and reporting, providing ongoing compliance support."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Their automated scheduling makes compliance effortless. Highly recommend!",
        "name": "Sarah Johnson",
        "role": "Facilities Manager",
        "avatar": "https://images.pexels.com/photos/7831936/pexels-photo-7831936.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Professional service with detailed reports. Our go-to for fire safety.",
        "name": "John Smith",
        "role": "Building Owner",
        "avatar": "https://images.unsplash.com/photo-1713689824343-77d2f99e19b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxGaXJlJTIwc2FmZXR5JTIwJTI2JTIwY29tcGxpYW5jZSUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4MTcyfDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Our Office",
    "description": "Located in the heart of the UK, we serve clients nationwide with dedication.",
    "address": "Unknown",
    "website": "independentfire.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Contact Us",
    "title": "Schedule an Inspection",
    "description": "Reach out to schedule your inspection and ensure compliance today.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation Benefits",
    "description": "Our AI solutions enhance efficiency and compliance.",
    "bullets": [
      "Automated inspection reminders keep you compliant.",
      "Online portal simplifies booking and payments.",
      "Instant report generation with e-signatures."
    ],
    "offer": "Mention Indep. Fire Safety for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Indep. Fire Safety delivers unforgettable experiences.",
    "address": "Unknown",
    "email": "",
    "socials": [
      {
