const appData = {
  "brand": {
    "name": "TM West Plumbing",
    "tagline": "Reliable 24/7 Services",
    "category": "Plumbing & Heating",
    "location": "Leeds, Yorkshire",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Prompt, Professional Service",
    "title": "Effortless plumbing solutions, anytime.",
    "description": "Our 24/7 service and easy booking keep your systems running smoothly, reducing delays and improving efficiency.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our team knows Leeds and Yorkshire, offering personalized service with local knowledge."
      },
      {
        "title": "Diverse Services",
        "description": "From plumbing to renewable heating, we cover all your needs with expert care."
      },
      {
        "title": "Strong Reputation",
        "description": "Highly rated by satisfied clients for reliability and quality workmanship."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services tailored for residential and commercial needs.",
    "cards": [
      {
        "icon": "🚿",
        "title": "Boiler Services",
        "description": "Install, maintain, and service boilers with our expert technicians."
      },
      {
        "icon": "🛠",
        "title": "Gas Services",
        "description": "Detect leaks, upgrade heating systems, and ensure safety."
      },
      {
        "icon": "♻️",
        "title": "Renewable Heating",
        "description": "Eco-friendly solutions for sustainable and efficient heating."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "TM West Plumbing & Heating has been a trusted name, offering extensive services to meet diverse client needs.",
      "Our focus on automation and customer care makes us a preferred choice for reliable and efficient solutions."
    ],
    "image": "https://images.pexels.com/photos/29226620/pexels-photo-29226620.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "TM West's quick response saved us during a plumbing emergency. Highly recommend!",
        "name": "Sarah Johnson",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/11447054/pexels-photo-11447054.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their service quality and professionalism are unmatched in the area.",
        "name": "Mark Collins",
        "role": "Business Owner",
        "avatar": "https://images.unsplash.com/photo-1681249537103-9e0c7316d91e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxQbHVtYmluZyUyMCUyNiUyMEhlYXRpbmclMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjU1NTg5MXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Located in Leeds, we serve Yorkshire and surrounding areas with ease.",
    "address": "Unknown",
    "website": "https://tmwest.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Contact Us Today",
    "description": "Reach out for bookings or inquiries. We're here to help 24/7.",
    "consent": "By contacting us, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Smarter Solutions",
    "description": "Harness the power of AI for seamless service.",
    "bullets": [
      "Book services online with instant confirmation.",
      "Automated dispatch ensures quick emergency response.",
      "CRM system captures leads for better service."
    ],
    "offer": "Mention TM West Plumbing for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "TM West Plumbing delivers unforgettable experiences.",
    "address": "Unknown",
    "email": "",
    "socials": [
      {
