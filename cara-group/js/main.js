const appData = {
  ...
  "hero": {
    ...
    "title": "Streamlined project delivery for complex builds",
    "description": "Cara Group excels in efficient multi-disciplinary contracting, ensuring seamless coordination and compliance for your projects.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our clear service segmentation ensures precise delivery across all disciplines."
      },
      {
        "title": "Visual Appeal",
        "description": "Strong imagery showcases our industrial expertise in every project."
      },
      {
        "title": "Consistent Branding",
        "description": "Experience unified branding that enhances our professional presence."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Cara Group offers comprehensive construction solutions tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Brickwork",
        "description": "Expert brickwork services ensuring quality and durability in every project."
      },
      {
        "icon": "💼",
        "title": "Principal Contractor",
        "description": "Leading construction projects from start to finish with efficiency and expertise."
      },
      {
        "icon": "🌿",
        "title": "Landscape",
        "description": "Transforming spaces with innovative landscaping solutions."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Cara Group has been a trusted name in construction, offering diverse services that meet the evolving needs of our clients.",
      "Our commitment to automation and digital transformation ensures operational efficiency, driving safety and margins higher."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Cara Group's automation made our project seamless and efficient.",
        "name": "John Stevens",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their attention to compliance and safety is unmatched.",
        "name": "Sarah Brooks",
        "role": "Construction Director",
        "avatar": "https://images.unsplash.com/photo-1489515229412-1f3a8f08dc34?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMkYlMjBNdWx0aS1kaXNjaXBsaW5hcnklMjBjb250cmFjdGluZyUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNzI1NTA4fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Discover our work across the UK, from Manchester to Merseyside.",
    "address": "",
    "website": "carabrickwork.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us Today",
    "description": "Reach out to Neil Allen for consultations or project inquiries.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Revolutionize Your Projects",
    "description": "Embrace automation for seamless project management.",
    "bullets": [
      "Automate CRM for lead and contract efficiency.",
      "Streamline estimating and tender processes.",
      "Enhance compliance with digital workflows."
    ],
    "offer": "Mention Cara Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Cara Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
