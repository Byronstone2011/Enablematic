const appData = {
  "brand": {
    "name": "AdvantÃ© Welfare",
    "tagline": "Instant Start Solutions",
    "category": "Construction Welfare",
    "location": "Nationwide UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Innovative Welfare Units",
    "title": "Cut costs and meet eco-goals easily.",
    "description": "Our units offer power-free start and sustainability benefits, reducing noise and emissions on-site.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/6647008/pexels-photo-6647008.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our welfare units are pioneers in self-contained design, ensuring ease of use."
      },
      {
        "title": "Sustainable Solutions",
        "description": "EcoLogic units cut emissions and reduce noise, aligning with environmental targets."
      },
      {
        "title": "Comprehensive Support",
        "description": "We offer specialist transport and service support for seamless operations."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our advanced welfare units tailored for construction needs.",
    "cards": [
      {
        "icon": "⚡",
        "title": "Instant Start Units",
        "description": "Our portable units provide immediate setup without mains power."
      },
      {
        "icon": "🌿",
        "title": "EcoLogic Solar Units",
        "description": "Harness solar power to meet sustainability and air-quality targets."
      },
      {
        "icon": "🔋",
        "title": "Hybrid Welfare Units",
        "description": "Our LPG hybrid units offer flexible energy solutions for diverse sites."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Pioneers in Welfare Solutions",
    "paragraphs": [
      "Founded in 1998, AdvantÃ© transformed site welfare with the Oasis concept. Our units lead the industry with innovative features.",
      "We integrate smart telemetry and automation, maximizing efficiency for large projects, ensuring measurable ROI."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "AdvantÃ© solutions cut our setup time drastically. Their eco-friendly units align perfectly with our green goals.",
        "name": "John Doe",
        "role": "Site Manager",
        "avatar": "https://images.pexels.com/photos/8960993/pexels-photo-8960993.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Innovative and efficient! These welfare units helped us meet strict project timelines seamlessly.",
        "name": "Jane Smith",
        "role": "Project Lead",
  ...
  "visit": {
    ...
    "description": "AdvantÃ© - OasisÂ® Welfare serves construction sites across the UK, providing unrivaled welfare solutions.",
    "address": "",
  ...
  "inquiry": {
    ...
    "description": "Contact us today for tailored welfare solutions that meet your project needs.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline with AI",
    "description": "Enhance productivity with our automated systems.",
    "bullets": [
      "Book units online with ease, anytime.",
      "Receive instant quotes, connected to CRM.",
      "Monitor units remotely with telemetry."
    ],
    "offer": "Mention AdvantÃ© Welfare for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "AdvantÃ© Welfare delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
