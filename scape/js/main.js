const appData = {
  ...
  "hero": {
    ...
    "title": "Simplify public procurement compliance",
    "description": "SCAPE delivers efficient frameworks, reducing compliance complexity and manual processes.",
    "highlights": [
      {
        "label": "Public Bodies Served",
        "value": "335+"
      },
      {
      ...
      {
        "label": "Frameworks Managed",
        "value": "50+"
      }
    ],
    "image": "https://images.pexels.com/photos/8961066/pexels-photo-8961066.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our layout provides a clear information hierarchy for effective decision-making."
      },
      {
        "title": "Visual Impact",
        "description": "We use strong photography to showcase real projects and outcomes."
      },
      {
        "title": "Credible Metrics",
        "description": "We emphasize credibility with impressive statistics and success markers."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our extensive procurement services tailored for public sector needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Construction Frameworks",
        "description": "Access comprehensive construction solutions tailored to public needs."
      },
      {
        "icon": "💼",
        "title": "Consultancy Services",
        "description": "Expert consultancy to streamline procurement and project delivery."
      },
      {
        "icon": "🔧",
        "title": "Infrastructure Procur",
        "description": "Reliable infrastructure procurement for efficient public sector development."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Leading Procurement Experts",
    "paragraphs": [
      "SCAPE is a public-sector owned procurement specialist with frameworks in construction, consultancy, civil engineering, and utilities.",
      "Our expertise in digital transformation and procurement automation sets us apart, ensuring compliance and efficiency."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "SCAPE made procurement compliance effortless, saving us time and resources.",
        "name": "Anna Johnson",
        "role": "Procurement Manager, City Council",
        "avatar": "https://images.pexels.com/photos/34590862/pexels-photo-34590862.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their frameworks streamlined our processes, enhancing efficiency significantly.",
        "name": "David Lee",
        "role": "Director of Operations, NHS Trust",
  ...
  "visit": {
    ...
    "description": "Located in the heart of the UK, our office is a hub for innovation and collaboration.",
    "address": "123 Procurement Lane, UK",
    "website": "https://www.scape.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Our Experts",
    "description": "Reach out today for a consultation and discover how we can assist your organization.",
    "consent": "I agree to the privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Procurement",
    "description": "Leverage AI to enhance your procurement processes with SCAPE.",
    "bullets": [
      "Automate e‑procurement workflows for faster results.",
      "Streamline contract management with real-time analytics.",
      "Enhance compliance with automated reporting tools."
    ],
    "offer": "Mention SCAPE for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "SCAPE delivers unforgettable experiences.",
    "address": "123 Procurement Lane, UK",
    "email": "",
    "socials": [
      {
