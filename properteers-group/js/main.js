const appData = {
  ...
  "hero": {
    "eyebrow": "Innovating Property Development",
    "title": "Streamlined Solutions for Property Investments",
    "description": "Properteers Group transforms property development with efficient lead capture, project transparency, and automated communication, ensuring seamless experiences for",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7937325/pexels-photo-7937325.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Showcasing luxury real estate with bold designs and professional photography, creating lasting impressions."
      },
      {
        "title": "Tailored Transparency",
        "description": "Providing clear project updates and streamlined communication for unmatched client trust."
      },
      {
        "title": "Minimalist Aesthetic",
        "description": "Delivering clean, organized layouts that enhance user experience and elevate brand appeal."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Properteers Group offers premium property development and investment opportunities tailored for success.",
    "cards": [
      {
        "icon": "🛋️",
        "title": "Property Development",
        "description": "Innovative residential, commercial, and mixed-use developments built to perfection."
      },
      {
        "icon": "🛠️",
        "title": "Project Management",
        "description": "Expert oversight ensuring timely delivery and adherence to standards."
      },
      {
        "icon": "🎥",
        "title": "Property Sales & Inve",
        "description": "Strategic investment opportunities and sales for optimal returns."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Built on Vision and Integrity",
    "paragraphs": [
      "Properteers Group was founded with a mission to redefine property development with quality, innovation, and transparency. We are committed to delivering spaces that inspire and investments that yield results.",
      "By leveraging advanced technology and a client-first approach, we ensure seamless experiences from project inception to completion, making us the trusted choice for property investors and buyers."
    ],
    "image": "https://images.pexels.com/photos/7937709/pexels-photo-7937709.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    "eyebrow": "What Clients Say",
    "title": "Trusted by Investors and Buyers",
    "list": [
      {
        "quote": "Properteers Group made investing simple and transparent. Their updates kept me informed every step of the way.",
        "name": "Sarah Johnson",
        "role": "Property Investor",
        "avatar": "https://images.pexels.com/photos/34134899/pexels-photo-34134899.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "The professionalism and quality of their developments are unmatched. I couldn't be happier with my new property.",
        "name": "James Turner",
        "role": "Home Buyer",
  ...
  "visit": {
    ...
    "title": "Visit Properteers Group",
    "description": "Explore our developments and experience firsthand the artistry and innovation that define us.",
    "address": "",
    "website": "www.properteers.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started Today",
    "title": "Contact Properteers Group",
    "description": "Ready to invest or learn more? Reach out to us for tailored property solutions.",
    "consent": "By submitting, you agree to our terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automated Property Solutions",
    "description": "Harness AI and automation to enhance client engagement and streamline operations.",
    "bullets": [
      "Automated lead capture forms integrated with CRM for efficient prospect",
      "Email nurture sequences to keep leads engaged and informed.",
      "Real-time project updates and client portals for full transparency."
    ],
    "offer": "Mention Properteers Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Properteers Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
