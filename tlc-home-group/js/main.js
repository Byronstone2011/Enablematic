const appData = {
  ...
  "hero": {
    ...
    "title": "Simplifying grants and installations",
    "description": "We handle grant applications and expert installations. Affordable, high-quality solutions for your home or business.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/28492754/pexels-photo-28492754.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        "title": "High Trust Ratings",
        "description": "Our Checkatrade 10/10 rating ensures you receive top-notch service."
      },
      {
        "title": "Industry Certified",
        "description": "We display multiple accreditations, guaranteeing quality and safety."
      },
      {
        "title": "Easy Contact",
        "description": "Our accessible contact form ensures quick and easy communication."
      }
    ]
  },
  "offerings": {
    ...
    "description": "TLC Home Group offers comprehensive energy solutions and construction services.",
    "cards": [
      {
        "icon": "💧",
        "title": "Heat Pump Installations",
        "description": "Expert installation of air source heat pumps for efficient heating."
      },
      {
        "icon": "🔋",
        "title": "Renewable Solutions",
        "description": "Explore solar panels and innovative renewable energy options."
      },
      {
        "icon": "🏗",
        "title": "Construction Services",
        "description": "From new builds to renovations, we handle it all with precision."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "TLC Home Group Ltd provides expert solutions in solar, heating, and construction. We are trusted nationwide for quality and affordability.",
      "We leverage digital tools to streamline processes, ensuring a seamless experience. Our automation systems enhance efficiency and customer satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "TLC Home Group made the grant application process stress-free and handled the installation seamlessly.",
        "name": "Sarah Johnson",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/10416862/pexels-photo-10416862.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their expertise in renewable energy solutions helped us save significantly on energy costs.",
  ...
  "visit": {
    ...
    "description": "Reach out to explore how we can help transform your space with sustainable solutions.",
    "address": "",
    "website": "www.tlchomegroup.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Ready for Your Upgrade?",
    "description": "Contact us today to discuss your project and discover available grants.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline with AI",
    "description": "Utilize AI to simplify your energy upgrade process.",
    "bullets": [
      "Automate grant eligibility checks to qualify leads.",
      "Generate instant quotes for common installations.",
      "Schedule and manage installations with reminders."
    ],
    "offer": "Mention TLC Home Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "TLC Home Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
