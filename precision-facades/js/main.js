const appData = {
  "brand": {
    "name": "Precision Facades",
    "tagline": "Facades that Last",
  ...
  "hero": {
    ...
    "title": "Revitalize your building's facade effortlessly.",
    "description": "We provide turnkey solutions for facade upgrades, ensuring compliance and quality across all projects.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our priority is maintaining the highest safety standards in every project."
      },
      {
        "title": "Certified Excellence",
        "description": "We are proud holders of IMETESC and Minster certifications."
      },
      {
        "title": "Professional Imagery",
        "description": "Our portfolio showcases high-quality facade transformations."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive facade solutions tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Turnkey Solutions",
        "description": "Complete building envelope solutions from design to maintenance."
      },
      {
        "icon": "🛠",
        "title": "EWI & Upgrades",
        "description": "Improve insulation and aesthetics with external wall upgrades."
      },
      {
        "icon": "🏢",
        "title": "Refurbishment",
        "description": "Revitalize buildings with our expert facade refurbishment services."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Long-lasting Facades",
    "paragraphs": [
      "Precision Facades began with a vision to enhance building aesthetics and efficiency. Our expert team offers bespoke facade solutions tailored to clients' needs.",
      "We integrate cutting-edge technology and proven techniques, ensuring sustainable, compliant, and impressive results for every project."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Precision Facades transformed our building, ensuring compliance and aesthetic appeal. Truly impressive!",
        "name": "John Smith",
        "role": "Property Developer",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their team coordinated complex projects seamlessly, exceeding our expectations.",
        "name": "Lisa Frank",
  ...
  "visit": {
    ...
    "description": "Located in the heart of the UK, we're easily accessible for consultations.",
    "address": "Unknown",
    "website": "precisionfacades.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request A Consultation",
    "description": "Contact us to discuss your project needs and get a tailored proposal.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Efficiency Through AI",
    "description": "Leveraging AI to streamline operations.",
    "bullets": [
      "Automate project bids for faster responses.",
      "Track project status with our client portal.",
      "Simplify compliance with digital solutions."
    ],
    "offer": "Mention Precision Facades for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Precision Facades delivers unforgettable experiences.",
    "address": "Unknown",
    "email": "",
    "socials": [
      {
