const appData = {
  "brand": {
    "name": "Line Side Const.",
    "tagline": "Building Rail Excellence",
    "category": "Rail Infrastructure",
    "location": "United Kingdom",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Rail Experts",
    "title": "Streamline your rail projects efficiently.",
    "description": "We solve scheduling, management, and lead challenges with expert solutions.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Decades of experience ensure every project is delivered flawlessly."
      },
      {
        "title": "Advanced Solutions",
        "description": "Utilizing cutting-edge technology to manage and execute projects efficiently."
      },
      {
        "title": "Trusted Partners",
        "description": "Accredited and trusted by the industry's leading organizations."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive rail and civils solutions.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Rail Construction",
        "description": "Delivering top-tier rail infrastructure with precision and safety."
      },
      {
        "icon": "🔧",
        "title": "Civil Engineering",
        "description": "Expert civils handling for robust and efficient project execution."
      },
      {
        "icon": "💼",
        "title": "Consultancy",
        "description": "Strategic consultancy to optimize your infrastructure investments."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "The Line Side Legacy",
    "paragraphs": [
      "Line Side Construction Ltd has been a trusted name in rail infrastructure, delivering quality and precision for decades.",
      "We align efficiency with compliance, offering unmatched expertise and a commitment to excellence in every project."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Line Side Construction streamlined our project management with exceptional results.",
        "name": "John Smith",
        "role": "Rail Asset Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their expertise in rail construction is unmatched. We highly recommend them.",
        "name": "Emily Clarke",
  ...
  "visit": {
    "eyebrow": "Find Us",
    "title": "Headquarters",
    "description": "Located in the heart of the UK's rail network, ensuring easy access and collaboration.",
    "address": "United Kingdom",
    "website": "linesideconstruction.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
  ...
  "byronCallout": {
    ...
    "description": "Enhance efficiency and compliance with our AI-driven solutions.",
    "bullets": [
      "Automate lead generation for consistent inquiries.",
      "Streamline workforce scheduling and compliance tracking.",
      "Optimize project management with automated reporting."
    ],
    "offer": "Mention Line Side Const. for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Line Side Const. delivers unforgettable experiences.",
    "address": "United Kingdom",
    "email": "",
    "socials": [
      {
