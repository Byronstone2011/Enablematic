const appData = {
  "brand": {
    "name": "Upright Prop. Group",
    "tagline": "Building luxury homes",
  ...
  "hero": {
    ...
    "title": "Streamline your property development journey.",
    "description": "We enhance lead capture and client communication with automation solutions for seamless development.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our luxury branding reflects sophistication and style."
      },
      {
        "title": "Visual Hierarchy",
        "description": "Our structured sections highlight important information."
      },
      {
        "title": "High-End Imagery",
        "description": "Professional photos showcase our exquisite properties."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services for luxury property development.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Construction",
        "description": "Expert building services for high-end residential projects."
      },
      {
        "icon": "📐",
        "title": "Architectural",
        "description": "Innovative designs tailored to your luxury lifestyle."
      },
      {
        "icon": "🗺",
        "title": "Planning",
        "description": "Strategic planning to bring your vision to life."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Upright Property Group specializes in luxury residential development. We create exceptional homes tailored to discerning clients.",
      "We offer personalized service and innovative solutions, ensuring every project is a masterpiece. Our focus is on client satisfaction and excellence."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Upright Property Group transformed our dream into reality with seamless communication.",
        "name": "Emma Johnson",
        "role": "Homeowner",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their automated systems made project updates a breeze, saving us time.",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Explore Surrey",
    "description": "Located in the heart of Surrey, discover the blend of luxury and comfort.",
    "address": "",
    "website": "www.uprightconstruction.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us",
    "description": "Schedule a consultation to discuss your luxury property needs.",
    "consent": "I consent to receiving communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Success",
    "description": "Leverage AI to enhance your development processes.",
    "bullets": [
      "Automate CRM for efficient lead follow-ups.",
      "Track construction milestones effortlessly.",
      "Enhance marketing with automated campaigns."
    ],
    "offer": "Mention Upright Prop. Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Upright Prop. Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
