const appData = {
  "brand": {
    "name": "Surveyhands Eng.",
    "tagline": "Precision in 3D",
    "category": "Engineering",
    "location": "Unknown",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Cutting-edge solutions",
    "title": "Eliminate data inaccuracy with 3D scanning.",
    "description": "Get precise data and streamline your projects with our advanced laser scanning services.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Bold Branding",
        "description": "Our vibrant teal creates memorable recognition in the industry."
      },
      {
        "title": "Efficient Navigation",
        "description": "Our site’s clean structure ensures you find what you need quickly."
      },
      {
        "title": "Expert Imagery",
        "description": "Professional images showcase our commitment to quality and detail."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Transform your projects with our high-resolution data services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Measured Surveys",
        "description": "Accurate as-built surveys for seamless project execution."
      },
      {
        "icon": "🔍",
        "title": "3D Laser Scanning",
        "description": "Capture detailed point-clouds with cutting-edge technology."
      },
      {
        "icon": "💻",
        "title": "BIM Modelling",
        "description": "Convert scans to BIM models using AutoDesk for easy integration."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "At Surveyhands, we transform how construction projects are managed. Our advanced laser scanning ensures precision.",
      "We integrate digital automation to streamline processes, enhancing efficiency and client outcomes."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Surveyhands solved our data accuracy issues, expediting our project timelines effortlessly.",
        "name": "Alex Johnson",
        "role": "Architect",
        "avatar": "https://images.pexels.com/photos/8090141/pexels-photo-8090141.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their BIM services transformed our raw data into actionable models. Impressive!",
        "name": "Emily Carter",
  ...
  "visit": {
    ...
    "description": "Explore our innovative solutions in person.",
    "address": "",
    "website": "www.surveyhands.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Request a Quote",
    "description": "Contact us to transform your projects with precision data.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Efficiency Through Automation",
    "description": "Optimize workflows with our tailored automation solutions.",
    "bullets": [
      "Instant quotes and easy booking increase project speed.",
      "Automated scan-to-BIM reduces manual processing time.",
      "CRM integration ensures timely follow-ups."
    ],
    "offer": "Mention Surveyhands Eng. for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Surveyhands Eng. delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
