const appData = {
  "brand": {
    "name": "Featherstone Homes",
    "tagline": "Crafting Future Living",
    "category": "Residential Development",
    "location": "South East",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Bespoke Developments",
    "title": "Maximize land value with expert planning.",
    "description": "We specialize in maximizing your property's potential with tailored solutions and expert project management.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our minimalist design ensures your properties stand out with elegance and precision."
      },
      {
        "title": "Visual Excellence",
        "description": "High-quality photography showcases the beauty and detail of each project."
      },
      {
        "title": "Clear Communication",
        "description": "We maintain a strong typographic hierarchy to ensure clients are always informed."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We offer comprehensive services to meet all your development needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Bespoke Homes",
        "description": "Creating high-spec homes tailored to your vision with precision and care."
      },
      {
        "icon": "🌍",
        "title": "Land Acquisition",
        "description": "We identify and secure prime locations, ensuring profitable developments."
      },
      {
        "icon": "🛠",
        "title": "Project Management",
        "description": "Our team expertly manages every aspect of your development project."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Featherstone Homes Ltd (South East) excels in bespoke residential developments, bringing dreams to life with expert craftsmanship and strategic land acquisition.",
      "We leverage cutting-edge technology and skilled professionals to streamline processes, delivering exceptional value and client satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Featherstone Homes transformed our land into a thriving development with unmatched expertise.",
        "name": "Alice Bennett",
        "role": "Landowner",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their project management was seamless; we were informed at every stage.",
        "name": "John Harris",
  ...
  "visit": {
    ...
    "description": "Explore our projects and meet the team that brings visions to life in the South East.",
    "address": "",
    "website": "www.featherstonehomes.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us Today",
    "description": "Reach out to discuss your development needs and how we can help achieve your goals.",
    "consent": "I agree to the terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate for Success",
    "description": "Leverage AI to streamline your development process.",
    "bullets": [
      "Automate lead capture for landowner inquiries.",
      "Track planning permissions with ease.",
      "Enhance client communication via portals."
    ],
    "offer": "Mention Featherstone Homes for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Featherstone Homes delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
