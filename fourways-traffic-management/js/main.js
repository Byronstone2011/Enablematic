const appData = {
  "brand": {
    "name": "Fourways TM",
    "tagline": "Efficient Traffic Solutions",
    "category": "Traffic Management",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Innovative traffic control",
    "title": "Streamline your traffic management needs today",
    "description": "We simplify traffic solutions, reducing reliance on manual processes and improving efficiency.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/1727004/pexels-photo-1727004.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Decades of experience ensure top-quality traffic management solutions."
      },
      {
        "title": "Comprehensive Services",
        "description": "From consultations to road closures, we cover all traffic control needs."
      },
      {
        "title": "Innovative Technology",
        "description": "Leverage the latest tech for efficient and safe traffic management."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Providing a full range of traffic management services tailored to your needs.",
    "cards": [
      {
        "icon": "🚦",
        "title": "Traffic Control",
        "description": "Expert teams manage traffic flow with precision and care."
      },
      {
        "icon": "📋",
        "title": "Consultation",
        "description": "Tailored advice to optimize traffic management strategies."
      },
      {
        "icon": "🔧",
        "title": "Road Closures",
        "description": "Seamless execution of road closures and diversions for safety."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Leading the Way in Traffic Management",
    "paragraphs": [
      "Fourways Traffic Management has become a leader in UK traffic solutions by focusing on high-quality service delivery.",
      "Our commitment to reducing manual processes sets us apart, ensuring efficient and reliable project execution."
    ],
    "image": "https://images.pexels.com/photos/31325025/pexels-photo-31325025.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Fourways streamlined our project with seamless traffic solutions.",
        "name": "Alex Carter",
        "role": "Project Manager, Construction Co.",
        "avatar": "https://images.pexels.com/photos/34596886/pexels-photo-34596886.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Efficient and reliable, their service greatly improved our workflow.",
        "name": "Laura Smith",
        "role": "Event Coordinator, City Events",
        "avatar": "https://images.unsplash.com/photo-1736187904052-42382bf3e2e9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxUcmFmZmljJTIwbWFuYWdlbWVudCUyMCUyRiUyMFRyYWZmaWMlMjBjb250cm9sJTIwc2VydmljZXMlMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODM4Mnww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Located in the UK, we serve nationwide with expert traffic management solutions.",
    "address": "",
    "website": "fourwaystm.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us Today",
    "description": "Reach out for a consultation or to request a service quote.",
    "consent": "I agree to the terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation Excellence",
    "description": "Enhance your traffic management with advanced automation.",
    "bullets": [
      "Instant online quotes for quick project planning.",
      "Automated crew scheduling for efficient staffing.",
      "Digital document management simplifies compliance."
    ],
    "offer": "Mention Fourways TM for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Fourways TM delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
