const appData = {
  ...
  "hero": {
    ...
    "title": "Streamline your construction process seamlessly",
    "description": "M&P Contractors Wales Ltd optimizes your project management and compliance with cutting-edge solutions.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "ISO certifications showcase our commitment to quality and safety in construction."
      },
      {
        "title": "Structured Solutions",
        "description": "Clear organizational structure ensures streamlined project execution."
      },
      {
        "title": "Visual Clarity",
        "description": "Hero images with overlay text provide immediate context about services."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Specializing in comprehensive interior and exterior contracting.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Suspended Ceilings",
        "description": "Expert installation of suspended ceilings for enhanced aesthetics and acoustics."
      },
      {
        "icon": "🏢",
        "title": "Partition Systems",
        "description": "Custom partition systems tailored to your space and design needs."
      },
      {
        "icon": "🔧",
        "title": "SFS Framing",
        "description": "Robust steel framing systems for durable and reliable construction."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "M&P Contractors Wales Ltd has been at the forefront of construction, delivering high-quality interior and exterior solutions.",
      "Our expertise in project management and compliance makes us the ideal partner for complex construction needs."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "M&P streamlined our project workflow, saving us time and money.",
        "name": "John Smith",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/236698/pexels-photo-236698.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their compliance management is top-notch, ensuring safety at every step.",
        "name": "Sarah Brown",
        "role": "Safety Officer",
  ...
  "visit": {
    ...
    "description": "Discover M&P Contractors' commitment to excellence in every project.",
    "address": "Unavailable",
    "website": "Unavailable",
    "mapEmbed": ""
  },
  ...
  "byronCallout": {
    ...
    "description": "Harness the power of AI to optimize construction processes.",
    "bullets": [
      "Implement CRM for seamless client interaction.",
      "Automate estimates and quotes for faster responses.",
      "Digital compliance management ensures safety."
    ],
    "offer": "Mention M&P Contractors for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "M&P Contractors delivers unforgettable experiences.",
    "address": "Unavailable",
    "email": "",
    "socials": [
      {
