const appData = {
  "brand": {
    "name": "Complete Roofing",
    "tagline": "Roofing excellence guaranteed",
  ...
  "hero": {
    ...
    "title": "Eliminate leaks and ensure durability",
    "description": "We install durable roofs and cladding to prevent disruptions. Our systems ensure compliance and longevity.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Authority & Reliability",
        "description": "Our bold blue branding signifies trust and expertise in the industry."
      },
      {
        "title": "Clear Categorization",
        "description": "Icon-based navigation simplifies finding the right service quickly."
      },
      {
        "title": "Exceptional Clarity",
        "description": "Clean design with ample whitespace enhances user experience."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our comprehensive services ensure your roofing and cladding needs are met with precision.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Roof Installation",
        "description": "Expert installation for new roofing systems tailored to your needs."
      },
      {
        "icon": "🛠",
        "title": "Roof Maintenance",
        "description": "Regular maintenance and repairs to extend roof life and prevent leaks."
      },
      {
        "icon": "🏢",
        "title": "Cladding Solutions",
        "description": "Durable cladding supply and installation for robust building protection."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Complete Roofing Systems is a full-service contractor specializing in roofing and cladding. We ensure long-term durability and compliance.",
      "Our solutions meet industrial challenges with automation and expertise, providing peace of mind and superior service."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Complete Roofing transformed our facility. No more leaks or disruptions!",
        "name": "Alex Turner",
        "role": "Facilities Manager",
        "avatar": "https://images.pexels.com/photos/11929024/pexels-photo-11929024.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their maintenance service keeps our operations smooth and worry-free.",
        "name": "Samantha Green",
        "role": "Operations Director",
        "avatar": "https://images.unsplash.com/photo-1604335847349-3d4c91bb0533?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxSb29maW5nJTIwJTI2JTIwQ2xhZGRpbmclMjAlMjhDb21tZXJjaWFsJTJGSW5kdXN0cmlhbCUyOSUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4MzY2fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Discover our commitment to quality in person. We're proud to serve across the UK.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us today to discuss your roofing and cladding needs.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Roofing Needs",
    "description": "Streamline your roofing projects with our AI solutions.",
    "bullets": [
      "Instant online quotes save time and effort.",
      "Automated scheduling ensures timely maintenance.",
      "Efficient service contract management."
    ],
    "offer": "Mention Complete Roofing for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Complete Roofing delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
