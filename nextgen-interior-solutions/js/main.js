const appData = {
  "brand": {
    ...
    "tagline": "Innovative fit-outs, seamless",
  ...
  "hero": {
    ...
    "description": "Nextgen Interior Solutions Ltd delivers efficient fit-out solutions, enhancing productivity and aesthetics. Experience seamless project management and superior",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We offer a full range of interior fit-out solutions tailored to your needs."
      },
      {
        "title": "Industry Certifications",
        "description": "Certified expertise ensures quality and compliance in every project."
      },
      {
        "title": "Visual Clarity",
        "description": "Our clear service categorization simplifies decision-making."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our services cover a wide range of interior fit-out needs, ensuring excellence in every project.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Drylining Solutions",
        "description": "Expert drylining services for commercial and industrial spaces."
      },
      {
        "icon": "🔨",
        "title": "Suspended Ceilings",
        "description": "Innovative ceiling systems for modern and functional spaces."
      },
      {
        "icon": "🎨",
        "title": "Paint & Decorating",
        "description": "Enhance your space with our professional painting and decorating services."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Excellence in Interiors",
    "paragraphs": [
      "Nextgen Interior Solutions Ltd was founded to deliver exceptional fit-out services. With a focus on quality and innovation, we transform spaces across the South Coast.",
      "Our expertise in interior solutions makes us a perfect partner for developers. We implement digital tools to boost efficiency and lead generation."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Nextgen made our office fit-out seamless. Their project management is top-notch.",
        "name": "Jane Smith",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/16552838/pexels-photo-16552838.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their attention to detail and efficiency exceeded our expectations.",
        "name": "John Doe",
  ...
  "visit": {
    ...
    "description": "Discover our completed projects and see our quality in action.",
    "address": "Serving Portsmouth, Southampton,",
    "website": "www.nextgen-is.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us Today",
    "description": "Reach out for a consultation or quote. Let's discuss your next project.",
    "consent": "I consent to receiving communications from Nextgen Interior Solutions Ltd."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Efficiency with AI",
    "description": "Discover how automation can elevate your interior fit-out projects.",
    "bullets": [
      "Automate lead capture and routing for faster response.",
      "Implement online quoting to streamline client interactions.",
      "Optimize scheduling with automated project management."
    ],
    "offer": "Mention Nextgen Interiors for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Nextgen Interiors delivers unforgettable experiences.",
    "address": "Serving Portsmouth, Southampton,",
    "email": "",
    "socials": [
      {
