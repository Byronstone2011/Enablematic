const appData = {
  "brand": {
    "name": "Quinn Groundworks",
    "tagline": "Solid Foundations, Built Fast",
    "category": "Construction",
    "location": "Dunstable Area",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Expert Construction Services",
    "title": "Beat Deadlines with Seamless Coordination",
    "description": "We streamline construction projects, ensuring timely delivery and minimal downtime.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/26107203/pexels-photo-26107203.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our aerial photography adds credibility and showcases our expertise effectively."
      },
      {
        "title": "Certified Excellence",
        "description": "Industry certifications displayed on our site build trust with clients and partners."
      },
      {
        "title": "Visible Branding",
        "description": "Our clear branding ensures easy recognition and a professional presence."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive groundworks and construction services tailored for efficiency.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Groundworks",
        "description": "Expert cut & fill, foundations, drainage, and infrastructure services."
      },
      {
        "icon": "💼",
        "title": "Project Management",
        "description": "End-to-end construction management ensuring top-notch results."
      },
      {
        "icon": "🚜",
        "title": "Fleet Support",
        "description": "Reliable fleet and plant provisioning for seamless site operations."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Quinn Groundworks & Construction Ltd has grown into a respected name in construction, known for delivering projects on time and within budget.",
      "We're committed to digital transformation, enhancing efficiency and client satisfaction through advanced project management and automation."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Quinn's team kept our project on schedule, handling all procurement smoothly.",
        "name": "Sarah Thompson",
        "role": "Project Manager, ABC Developers",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their fleet support minimized downtime, keeping our site running smoothly.",
        "name": "John Mitchell",
        "role": "Site Supervisor, XYZ Construction",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Explore Our Local Expertise",
    "description": "Located near Dunstable, we serve a wide radius with top-tier construction services.",
    "address": "",
    "website": "quinngroundworks.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Start Your Project Today",
    "description": "Contact us for a consultation or to get a quote for your next project.",
    "consent": "We respect your privacy and keep your data secure."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Projects",
    "description": "Enhance your construction efficiency with our AI solutions.",
    "bullets": [
      "Automate project scheduling to avoid costly delays.",
      "Manage procurement with a seamless supplier portal.",
      "Track fleet maintenance with integrated telematics."
    ],
    "offer": "Mention Quinn Groundworks for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Quinn Groundworks delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
