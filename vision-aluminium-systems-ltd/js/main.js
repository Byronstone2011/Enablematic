const appData = {
  ...
  "hero": {
    ...
    "title": "Streamline Your Projects with Us",
    "description": "We optimize lead capture, automate quoting, and ensure compliance with seamless coordination.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/12986423/pexels-photo-12986423.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Focused exclusively on commercial glazing projects with expert services."
      },
      {
        "title": "Professional Imagery",
        "description": "Showcasing real projects with high-quality, professional photography."
      },
      {
        "title": "Trust and Credibility",
        "description": "Accreditations and comprehensive contact info build client trust."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Delivering top-tier aluminium systems for diverse commercial needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Curtain Walling",
        "description": "Our aluminium curtain walling system enhances aesthetics and performance."
      },
      {
        "icon": "🛡",
        "title": "Commercial Doors",
        "description": "Robust doors designed for durability and security in high-traffic areas."
      },
      {
        "icon": "💼",
        "title": "Design & Surveying",
        "description": "Comprehensive design and surveying services ensure project success."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Vision Aluminium Systems Ltd began with a mission to revolutionize commercial glazing. Our expertise in aluminium systems has driven us to the forefront of the industry.",
      "By integrating cutting-edge technology and automation, we offer unmatched efficiency and compliance. Our services provide significant ROI for commercial clients."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Vision Aluminium streamlined our projects, vastly improving efficiency and compliance.",
        "name": "Emma Clarke",
        "role": "Architect",
        "avatar": "https://images.pexels.com/photos/33734763/pexels-photo-33734763.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their automated systems saved us time and ensured flawless execution.",
        "name": "John Davis",
        "role": "Project Manager",
        "avatar": "https://images.unsplash.com/photo-1677930075348-5933c68cd46d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb21tZXJjaWFsJTIwZ2xhemluZyUyMCUyRiUyMGFsdW1pbml1bSUyMHN5c3RlbXMlMjAlMkYlMjBjb25zdHJ1Y3Rpb24lMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODMzN3ww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Located in the UK, we serve a diverse range of commercial projects.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Reach out for consultations or project inquiries with our expert team.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Success",
    "description": "Leverage AI to revolutionize your project workflows.",
    "bullets": [
      "Automated lead capture boosts efficiency.",
      "Online quoting tool speeds up approvals.",
      "Automated compliance ensures reliability."
    ],
    "offer": "Mention Vision Aluminium for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Vision Aluminium delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
