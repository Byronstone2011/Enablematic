const appData = {
  "brand": {
    "name": "EvaBuild Ltd",
    "tagline": "Crafting Tomorrow's Infrastructure",
  ...
  "hero": {
    ...
    "title": "Streamline projects with our expert solutions",
    "description": "EvaBuild Ltd removes delays with automated quoting and seamless project management.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our team brings years of experience to every construction project."
      },
      {
        "title": "Innovative Solutions",
        "description": "We utilize the latest technology for efficient project delivery."
      },
      {
        "title": "Trusted Partnerships",
        "description": "Strong relationships with clients ensure successful outcomes."
      }
    ]
  },
  "offerings": {
    ...
    "description": "From civil engineering to groundworks, we cover all your construction needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Civil Engineering",
        "description": "Comprehensive services from feasibility studies to construction."
      },
      {
        "icon": "🛠",
        "title": "Modular Groundworks",
        "description": "We offer temporary and permanent groundwork solutions."
      },
      {
        "icon": "🚧",
        "title": "General Groundworks",
        "description": "Services include site clearance, excavation, and drainage."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "EvaBuild Ltd specializes in civil engineering, construction, and project management. We are committed to excellence in every project.",
      "Our well-established offline presence and accreditations show our dedication to adopting innovative solutions for our clients."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "EvaBuild streamlined our project, saving us time and effort.",
        "name": "John Smith",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their innovative solutions made our construction process seamless.",
        "name": "Sarah Johnson",
        "role": "Contractor",
        "avatar": "https://images.unsplash.com/photo-1650420790218-e910e7b2268a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMkYlMjBHcm91bmR3b3JrcyUyMCUyNiUyMENpdmlsJTIwRW5naW5lZXJpbmclMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjcyNTU1OHww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Explore our work across the UK and see how we can transform your spaces.",
    "address": "",
    "website": "www.evabuild.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us for a Quote",
    "description": "Reach out to EvaBuild today to discuss your project needs.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Success",
    "description": "Harness the power of automation to transform your construction process.",
    "bullets": [
      "Integrate CRM for seamless lead capture and follow-ups.",
      "Implement online quoting for faster project initiation.",
      "Digitize compliance tracking for efficient management."
    ],
    "offer": "Mention EvaBuild Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "EvaBuild Ltd delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
