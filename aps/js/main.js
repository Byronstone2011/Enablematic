const appData = {
  "brand": {
    ...
    "category": "Commercial Property Services",
    "location": "Nationwide",
    "phone": "0800-APS-HELP"
  },
  "hero": {
    "eyebrow": "Nationwide Specialists",
    "title": "Solving your complex property issues",
    "description": "APS Limited provides comprehensive solutions for property maintenance and safety compliance.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Clear service categories enhance client understanding and decision-making."
      },
      {
        "title": "Real Work Showcase",
        "description": "Our photography highlights real projects, building trust and showing expertise."
      },
      {
        "title": "Consistent Branding",
        "description": "Unified branding ensures immediate recognition and reliability."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services tailored to protect and enhance commercial properties.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Property Refurbishment",
        "description": "Expert refurbishment for both interior and exterior spaces."
      },
      {
        "icon": "🏛",
        "title": "Heritage Restoration",
        "description": "Preserve history with our specialized restoration services."
      },
      {
        "icon": "💧",
        "title": "Leaky Repairs",
        "description": "Advanced solutions for water ingress and building integrity."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "APS Limited is known for comprehensive property maintenance across the nation. We provide all trades needed to enhance and protect your assets.",
      "Our services are perfectly suited for complex, project-driven needs. Automation and digital improvements ensure exceptional results and client satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "APS solved our safety compliance issues quickly and efficiently.",
        "name": "Emma Johnson",
        "role": "Facility Manager",
        "avatar": "https://images.pexels.com/photos/8293673/pexels-photo-8293673.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their refurbishment work revitalized our commercial space.",
        "name": "Mark Thompson",
        "role": "Property Developer",
        "avatar": "https://images.unsplash.com/photo-1566821594226-cdc9cb42a4c8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb21tZXJjaWFsJTIwcHJvcGVydHklMjByZW1lZGlhdGlvbiUyMCUyRiUyMGJ1aWxkaW5nJTIwbWFpbnRlbmFuY2UlMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODcyOHww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Our services are available across the country, ensuring local expertise with national support.",
    "address": "Contact us for your local branch",
    "website": "www.aps-limited.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Request a Consultation",
    "description": "Contact us today to discuss your property needs and schedule a consultation.",
    "consent": "By contacting us, you consent to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance with Automation",
    "description": "Streamline operations with our AI-driven solutions.",
    "bullets": [
      "Automate project scheduling for efficient execution.",
      "CRM systems enhance lead conversion and follow-ups.",
      "Preventive maintenance scheduling boosts property longevity."
    ],
    "offer": "Mention APS Limited for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "APS Limited delivers unforgettable experiences.",
    "address": "Contact us for your local branch",
    "email": "",
    "socials": [
      {
