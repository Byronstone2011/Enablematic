const appData = {
  "brand": {
    "name": "2Seck Recruit",
    "tagline": "Connecting Talent & Opportunity",
    "category": "Construction Recruitment",
    "location": "London & Home Coun",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Expertise in Construction",
    "title": "Streamline hiring with precision and speed.",
    "description": "We specialize in finding the right talent for Quantity Surveyors and Estimators. Our digital solutions ensure quick placements.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/15640957/pexels-photo-15640957.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We focus exclusively on Quantity Surveyors and Estimators, delivering unmatched insight."
      },
      {
        "title": "Digital Precision",
        "description": "Our automated systems ensure efficient candidate sourcing and placement."
      },
      {
        "title": "Proven Success",
        "description": "Our track record in construction recruitment speaks for itself."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Tailored recruitment solutions for the construction industry.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Executive Search",
        "description": "Identify top-tier candidates for senior roles in construction."
      },
      {
        "icon": "📋",
        "title": "Placement Services",
        "description": "Specializing in placing Quantity Surveyors and Estimators."
      },
      {
        "icon": "💼",
        "title": "Career Advisory",
        "description": "Guidance for candidates seeking career advancement."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded by Mark Seckerson, 2Seck Recruitment is dedicated to connecting top talent with leading construction firms.",
      "Our niche focus and digital innovation provide unmatched recruitment efficiency in the QS and Estimators market."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "2Seck Recruitment streamlined our hiring process, saving us time and effort.",
        "name": "John Doe",
        "role": "HR Manager",
        "avatar": "https://images.pexels.com/photos/34628260/pexels-photo-34628260.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their expertise in construction recruitment is unparalleled.",
        "name": "Jane Smith",
  ...
  "visit": {
    ...
    "title": "Visit Us",
    "description": "Located in the heart of London, serving the vibrant construction market.",
    "address": "London, United Kingdom",
    "website": "www.2seck.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us",
    "description": "Reach out to discuss your recruitment needs today.",
    "consent": "By contacting us, you agree to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Recruitment",
    "description": "Leverage AI for efficient recruitment processes.",
    "bullets": [
      "Automated candidate sourcing with LinkedIn integration.",
      "Seamless scheduling for interviews and meetings.",
      "CRM automation for client follow-ups and vacancy tracking."
    ],
    "offer": "Mention 2Seck Recruit for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "2Seck Recruit delivers unforgettable experiences.",
    "address": "London, United Kingdom",
    "email": "",
    "socials": [
      {
