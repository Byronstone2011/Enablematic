const appData = {
  "brand": {
    "name": "Watson Towers",
    "tagline": "Steel solutions, built strong",
    "category": "Steel Fabrication",
    "location": "UK",
    "phone": "Unavailable"
  },
  "hero": {
    "eyebrow": "Precision steel services",
    "title": "Streamline your steel procurement today",
    "description": "Watson Towers simplifies your steel needs with comprehensive in-house solutions. Boost efficiency and reduce costs now.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Superior Imagery",
        "description": "Our large hero images showcase the strength and precision of our steel products."
      },
      {
        "title": "Simple Navigation",
        "description": "Navigate easily through our site with our clean and intuitive structure."
      },
      {
        "title": "Social Integration",
        "description": "Stay connected through our integrated social media platforms."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive steel services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Structural Fabrication",
        "description": "We offer precision structural steel fabrication for diverse projects."
      },
      {
        "icon": "🗼",
        "title": "Steel Tower Manufacture",
        "description": "Manufacture and supply robust steel towers for any infrastructure."
      },
      {
        "icon": "🔧",
        "title": "Steel Components",
        "description": "Supply custom steel components for various assemblies."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Excellence in Steel",
    "paragraphs": [
      "Watson Towers is a steel stockholder and process center offering a wide range of in-house services. Our expertise lies in profiling, machining, and more.",
      "We modernize steel procurement with an emphasis on efficiency and automation, ensuring seamless integration and satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Watson Towers transformed our steel procurement process. Their streamlined approach saved us time and money.",
        "name": "John Taylor",
        "role": "Construction Manager",
        "avatar": "https://images.pexels.com/photos/33367148/pexels-photo-33367148.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their precision and reliability in steel fabrication made them our top choice for all projects.",
        "name": "Emily Smith",
  ...
  "visit": {
    "eyebrow": "Find Us",
    "title": "Visit Watson Towers",
    "description": "Located in the UK, we serve nationwide with our steel solutions.",
    "address": "Unavailable",
    "website": "watson-towers.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Request a Quote",
    "description": "Contact us today to discuss your steel needs and get a custom quote.",
    "consent": "I consent to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Boost Efficiency with AI",
    "description": "Harness our AI-driven solutions to streamline your steel operations.",
    "bullets": [
      "Automate quote requests and capture leads instantly.",
      "Integrate CRM for seamless communication management.",
      "Enable e-commerce for real-time inventory access."
    ],
    "offer": "Mention Watson Towers for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Watson Towers delivers unforgettable experiences.",
    "address": "Unavailable",
    "email": "",
    "socials": [
      {
