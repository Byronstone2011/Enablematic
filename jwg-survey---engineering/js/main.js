const appData = {
  "brand": {
    "name": "JWG Survey & Eng.",
    "tagline": "Precision in Every Survey",
    "category": "Land Surveying",
    "location": "North West, UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Your Surveying Partner",
    "title": "Streamline your projects with fast, accurate surveys.",
    "description": "We provide efficient survey services to accelerate your project timelines and ensure precision.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/34367779/pexels-photo-34367779.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        "title": "Expert Team",
        "description": "Our experienced team delivers top-notch surveying solutions."
      },
      {
        "title": "Modern Tools",
        "description": "We use the latest technology for precise and reliable results."
      },
      {
        "title": "Custom Solutions",
        "description": "Tailored services to meet specific project needs and demands."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive surveying services for various industries.",
    "cards": [
      {
        "icon": "📐",
        "title": "Topographic Surveys",
        "description": "Detailed land surveys to support planning and development."
      },
      {
        "icon": "🏗",
        "title": "Construction Layout",
        "description": "Accurate site layouts to guide construction projects."
      },
      {
        "icon": "🖥",
        "title": "Design Support",
        "description": "Engineering design with CAD/GIS for efficient planning."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Building Trust Across the UK",
    "paragraphs": [
      "JWG Survey & Engineering, a one-stop shop, operates throughout the UK from the North West. We offer comprehensive surveying services.",
      "With automation, we enhance efficiency, offering fast, reliable surveys. Our modern tools and expert team ensure precise results."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "JWG's quick service significantly improved our project timelines.",
        "name": "Tom H.",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/7170722/pexels-photo-7170722.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "The precision and speed of their surveys are unmatched.",
        "name": "Sarah L.",
        "role": "Architect",
        "avatar": "https://images.unsplash.com/photo-1654643353084-10e62e05b9bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxMYW5kJTIwc3VydmV5aW5nJTIwJTJGJTIwRW5naW5lZXJpbmclMjBzZXJ2aWNlcyUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4Mjc2fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Located in the North West, we serve clients across the UK, bringing expert survey solutions to your doorstep.",
  ...
  "inquiry": {
    ...
    "description": "Contact us for a consultation or to schedule a survey. We're here to assist you.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Efficiency with AI",
    "description": "Our AI solutions improve your project workflow.",
    "bullets": [
      "Instant online booking for site visits.",
      "Automated report delivery in PDF/GIS.",
      "CRM integration for seamless follow-ups."
    ],
    "offer": "Mention JWG Survey & Eng. for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "JWG Survey & Eng. delivers unforgettable experiences.",
    "address": "North West, UK",
    "email": "",
    "socials": [
      {
