const appData = {
  "brand": {
    "name": "Site Labour UK Ltd",
    "tagline": "Connecting talent to opportunities",
  ...
  "hero": {
    ...
    "title": "Streamline recruitment for construction roles",
    "description": "We simplify hiring with automated tools, CV support, and expert coaching to save time and ensure quality hires.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We offer tailored solutions including CV building and interview coaching for candidates."
      },
      {
        "title": "Automated Tools",
        "description": "Streamlined processes like applicant tracking and scheduling save time and boost efficiency."
      },
      {
        "title": "Industry Focus",
        "description": "Specializing in construction recruitment ensures the best matches for employers and job seekers."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive recruitment services tailored to the construction industry.",
    "cards": [
      {
        "icon": "📄",
        "title": "CV Building Support",
        "description": "Enhance your resume to stand out in the competitive construction job market."
      },
      {
        "icon": "🎤",
        "title": "Interview Coaching",
        "description": "Get expert guidance to ace interviews and land your ideal construction role."
      },
      {
        "icon": "🏗",
        "title": "Job Placement",
        "description": "We connect skilled candidates with top employers in the construction industry."
      }
    ]
  },
  "story": {
    "eyebrow": "Our journey",
    "title": "Built to empower construction hiring",
    "paragraphs": [
      "Site Labour UK Ltd was founded to bridge the gap between construction employers and skilled workers. We understand the challenges of finding the right talent.",
      "Our automated tools and tailored services streamline hiring for employers while empowering candidates to succeed in their careers."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Thanks to Site Labour UK, we filled key roles quickly and efficiently. Their tools saved us hours of manual work.",
        "name": "John Davis",
        "role": "Construction Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "The CV support and coaching helped me land my dream job. Their team is truly exceptional.",
        "name": "Sarah Jenkins",
        "role": "Job Seeker",
        "avatar": "https://images.unsplash.com/photo-1659353587655-27e7d242c1f6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjByZWNydWl0bWVudCUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNTM4NDU1fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Partner with us for seamless hiring solutions and career support in the UK construction industry.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get started",
    "title": "Request recruitment support",
    "description": "Contact us today to discuss your hiring needs and start building your workforce or career.",
    "consent": "By submitting, you agree to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate recruitment processes",
    "description": "Leverage AI tools to simplify hiring and scale your construction workforce faster.",
    "bullets": [
      "Automate CV parsing and candidate matching for faster placements.",
      "Enable online interview scheduling to save time and reduce admin work.",
      "Improve job posting reach with multi-platform automation."
    ],
    "offer": "Mention Site Labour UK Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Site Labour UK Ltd delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
