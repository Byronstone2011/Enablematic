const appData = {
  "brand": {
    "name": "Specter Recruit.",
    "tagline": "Building Careers Fast",
    "category": "Recruitment",
    "location": "West & East Midlan",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Expert Recruitment Service",
    "title": "Streamline your hiring process now.",
    "description": "Specter Recruitment reduces hiring time and finds skilled candidates for construction roles.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our team is featured in clean, professional photography, ensuring trust."
      },
      {
        "title": "Service Clarity",
        "description": "Clear content structuring makes understanding our services easy."
      },
      {
        "title": "Corporate Aesthetic",
        "description": "We maintain a professional aesthetic with warm accent colors."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We specialize in recruitment for the built environment, offering tailored services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Construction Roles",
        "description": "We source candidates for residential and commercial construction roles."
      },
      {
        "icon": "🔍",
        "title": "Candidate Matching",
        "description": "We expertly match candidates to the right positions seamlessly."
      },
      {
        "icon": "🤝",
        "title": "HR Partner",
        "description": "We extend HR teams' capabilities by managing recruitment flow."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Specter Recruitment specializes in sourcing talent for the built environment. Our focus is on matching the right candidates with the right roles.",
      "With a boutique approach, we streamline recruitment processes, enhancing efficiency with ATS and CRM automation. This keeps us ahead in serving our clients."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Specter Recruitment made our hiring process seamless. They saved us time and effort.",
        "name": "John Mason",
        "role": "HR Manager",
        "avatar": "https://images.pexels.com/photos/34628260/pexels-photo-34628260.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Finding skilled candidates was a breeze with Specter. Highly recommended!",
        "name": "Emma White",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Our Location",
    "description": "Located in the heart of the Midlands, we serve the construction industry with dedication.",
    "address": "West & East Midlands, UK",
    "website": "www.specterrecruitment.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Contact Us Today",
    "description": "Reach out to us for tailored recruitment solutions. Let's build your team.",
    "consent": "I consent to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Hiring",
    "description": "Leverage AI to enhance efficiency and effectiveness in recruitment.",
    "bullets": [
      "Automate job posting and track applications.",
      "Use CRM tools for candidate nurturing.",
      "Schedule interviews with automated reminders."
    ],
    "offer": "Mention Specter Recruit. for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Specter Recruit. delivers unforgettable experiences.",
    "address": "West & East Midlands, UK",
    "email": "",
    "socials": [
      {
