const appData = {
  ...
  "hero": {
    ...
    "title": "Pioneering Carbon-Negative Homes in the UK",
    "description": "HEMSPAN Ltd transforms construction with sustainable, hemp-based materials. We overcome regulatory and supply-chain challenges to deliver eco-friendly homes.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our minimalist layouts and bold typography redefine sustainable living."
      },
      {
        "title": "Visual Excellence",
        "description": "Full-width imagery showcases the beauty of bio-based materials."
      },
      {
        "title": "Strategic Partnerships",
        "description": "Collaborations with UK farmers ensure high-quality hemp supplies."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our groundbreaking bio-based construction solutions.",
    "cards": [
      {
        "icon": "🏗",
        "title": "BIOHAUS System",
        "description": "We design and deliver carbon-negative homes with our BIOHAUS panellised system."
      },
      {
        "icon": "🌿",
        "title": "R&D Innovations",
        "description": "Researching bio-based weather-boarding and insulated cladding for enhanced sustainability."
      },
      {
        "icon": "🤝",
        "title": "Partnerships",
        "description": "We support UK hemp farming through scaling and distribution collaborations."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "HEMSPAN Ltd is revolutionizing construction with eco-friendly, hemp-based materials. Our mission is to disrupt conventional methods and lead the industry toward sustainability.",
      "Our innovative approach accelerates scaling, enhances digital marketing, and automates production. We leverage a strong partner network and clear vision to drive growth."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "HEMSPAN's innovative BIOHAUS system has transformed our projects, reducing carbon footprints significantly.",
        "name": "Alice Green",
        "role": "Architect",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their commitment to sustainable materials and supply chain efficiency is unmatched in the industry.",
        "name": "John Smith",
        "role": "Homebuilder",
  ...
  "visit": {
    ...
    "description": "Discover our sustainable innovations and meet our expert team in the heart of the UK.",
    "address": "",
    "website": "www.hemspan.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us",
    "description": "Ready to transform your construction projects? Reach out for consultations.",
    "consent": "By contacting us, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Growth",
    "description": "Leverage AI to enhance efficiency and scale effectively.",
    "bullets": [
      "Automate CRM for streamlined B2B sales cycles.",
      "Utilize digital tools for fast BIOHAUS panel specs.",
      "Optimize production with automated scheduling."
    ],
    "offer": "Mention HEMSPAN for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "HEMSPAN delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
