const appData = {
  "brand": {
    "name": "Heroes Awards",
    "tagline": "Celebrating true heroes",
    "category": "Events / Awards",
    "location": "Global",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Recognizing bravery",
    "title": "Streamline nominations, boost engagement.",
    "description": "Heroes Awards simplifies the nomination process, enhances event engagement, and optimizes sponsor relations.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7648306/pexels-photo-7648306.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our ceremonies feature a premium aesthetic that highlights the honor of our heroes."
      },
      {
        "title": "Visual Excellence",
        "description": "We use professional photography and lighting to capture unforgettable moments."
      },
      {
        "title": "Luxury Accents",
        "description": "Gold accents throughout reinforce the prestige of our events."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Recognize unsung heroes with our expert services.",
    "cards": [
      {
        "icon": "🏆",
        "title": "Awards Ceremony",
        "description": "We organize impactful events to honor heroes who overcome adversity."
      },
      {
        "icon": "📝",
        "title": "Nomination Management",
        "description": "Streamline submissions with our efficient nomination management."
      },
      {
        "icon": "🤝",
        "title": "Sponsorship Programs",
        "description": "Connect with sponsors to support and enhance our events."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Honoring Unsung Heroes",
    "paragraphs": [
      "Heroes Awards was created to honor those who show courage in adversity. We celebrate individuals whose stories inspire us all.",
      "Our events attract sponsors and attendees worldwide, offering unique opportunities to engage and recognize true heroes."
    ],
    "image": "https://images.pexels.com/photos/7648231/pexels-photo-7648231.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Heroes Awards made the nomination process a breeze. Our heroes got the recognition they deserve.",
        "name": "Emily Thompson",
        "role": "Event Attendee",
        "avatar": "https://images.pexels.com/photos/7648239/pexels-photo-7648239.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Sponsoring Heroes Awards was a rewarding experience. The event's professionalism was top-notch.",
  ...
  "visit": {
    ...
    "description": "Join us at our next event to witness inspiring stories and meet remarkable individuals.",
    "address": "Various global locations",
    "website": "www.heroesawards.org",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Involved",
    "title": "Nominate or Sponsor",
    "description": "Contact us to nominate a hero or explore sponsorship opportunities.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance with AI",
    "description": "Automate and innovate your event experience.",
    "bullets": [
      "Automate nominations with tracking and confirmations.",
      "Streamline ticketing with integrated e-tickets.",
      "Effortlessly manage sponsors with CRM integration."
    ],
    "offer": "Mention Heroes Awards for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Heroes Awards delivers unforgettable experiences.",
    "address": "Various global locations",
    "email": "",
    "socials": [
      {
