const appData = {
  "brand": {
    "name": "GASJACK Group",
    "tagline": "Heating solutions made easy",
    "category": "Heating & Plumbing",
    "location": "Plymouth, Devon",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Trusted Heating Experts",
    "title": "Reliable boiler services, transparent pricing.",
    "description": "We offer rapid response to emergencies, punctual service, and fixed prices for peace of mind.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our certified engineers ensure top-quality service every time."
      },
      {
      ...
      },
      {
        ...
        "description": "We respond swiftly to all urgent heating and plumbing needs."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive heating and plumbing services tailored to your needs.",
    "cards": [
      {
        "icon": "🔥",
        "title": "Boiler Installations",
        "description": "Expert installation of energy-efficient boilers for homes and businesses."
      },
      {
        "icon": "🚿",
        "title": "Heating Solutions",
        "description": "Installations and repairs for radiators and central heating systems."
      },
      {
        "icon": "🛠",
        "title": "Emergency Repairs",
        "description": "Fast, reliable repairs for boiler breakdowns and heating emergencies."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded in Plymouth, GASJACK Group has become a trusted name in heating services across South West England.",
      "We pride ourselves on delivering reliable, expert solutions with a focus on customer satisfaction and lasting partnerships."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "GASJACK Group was there when my boiler broke down. Fast and professional service.",
        "name": "Emily R.",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/7937300/pexels-photo-7937300.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their transparent pricing and punctuality are unmatched. Highly recommend!",
        "name": "James T.",
        "role": "Landlord",
        "avatar": "https://images.unsplash.com/photo-1646227655718-dd721b681d91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxIZWF0aW5nJTIwJTI2JTIwUGx1bWJpbmclMjAlMjhCb2lsZXIlMjAlMjYlMjBIVkFDJTIwc2VydmljZXMlMjklMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODIzM3ww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Explore Our Service Area",
    "description": "Serving Plymouth and surrounding areas in South West England with expert heating solutions.",
    "address": "",
    "website": "gasjack.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Schedule Your Consultation",
    "description": "Contact us for a free quote or to book an appointment with our experts.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Comfort",
    "description": "Leverage AI to enhance your heating services.",
    "bullets": [
      "Book engineers online with real-time scheduling.",
      "Automate quotes and follow-ups to boost conversions.",
      "Schedule maintenance and register warranties effortlessly."
    ],
    "offer": "Mention GASJACK Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "GASJACK Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
