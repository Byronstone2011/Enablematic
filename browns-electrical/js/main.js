const appData = {
  "brand": {
    "name": "Browns Electrical",
    "tagline": "Your trusted local electricians",
    "category": "Electrical Services",
    "location": "Serving local comm",
    "phone": "Contact for inquiries"
  },
  "hero": {
    "eyebrow": "Family-run expertise",
    "title": "Streamlined services for home and business needs",
    "description": "Browns Electrical makes booking easy and efficient. Get reliable service fast.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our work is showcased with clear project photos."
      },
      {
        "title": "Comprehensive Reviews",
        "description": "Client feedback builds our credibility and trust."
      },
      {
        "title": "Accessible Contact",
        "description": "Multiple contact methods ensure easy communication."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We provide comprehensive electrical solutions.",
    "cards": [
      {
        "icon": "🏠",
        "title": "Domestic Services",
        "description": "Efficient repairs and installations for homes."
      },
      {
        "icon": "🏢",
        "title": "Commercial Services",
        "description": "Maintenance and upgrades for businesses."
      },
      {
        "icon": "🚨",
        "title": "Emergency Services",
        "description": "Fast, reliable responses to urgent issues."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Browns Electrical is a family-run business, delivering top-notch electrical services to homes and businesses.",
      "Our trusted reputation is built on quality service and strong client relationships. We aim to enhance our online presence."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Prompt and professional service every time. Browns Electrical never disappoints.",
        "name": "John Doe",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/10186692/pexels-photo-10186692.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their reliable and efficient service has been vital for our business.",
        "name": "Jane Smith",
        "role": "Business Owner",
  ...
  "visit": {
    ...
    "description": "Proudly serving local communities with expert electrical services.",
  ...
  "byronCallout": {
    ...
    "description": "Leverage automation for better service.",
    "bullets": [
      "Online bookings simplify scheduling.",
      "Automated follow-ups boost client engagement.",
      "Quick quotes and invoicing enhance efficiency."
    ],
    "offer": "Mention Browns Electrical for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Browns Electrical delivers unforgettable experiences.",
    "address": "Local service area",
    "email": "",
    "socials": [
      {
