const appData = {
  "brand": {
    "name": "NTP Access",
    "tagline": "Raising safety standards",
  ...
  "hero": {
    ...
    "title": "Eliminate downtime with our hoists",
    "description": "NTP Access ensures timely installations and maintenance, keeping your projects on track and compliant.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/12430806/pexels-photo-12430806.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We offer a full range of hoist solutions to meet any project needs."
      },
      {
        "title": "Expert Team",
        "description": "Our skilled team ensures seamless installations and maintenance."
      },
      {
        "title": "Proven Track Record",
        "description": "Thousands of satisfied clients trust us with their equipment needs."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Tailored hoist solutions for every construction project.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Hoist Hire",
        "description": "Flexible rental options for modern construction hoists."
      },
      {
        "icon": "🔧",
        "title": "Hoist Installation",
        "description": "Expert installation and rigging services for any site."
      },
      {
        "icon": "🛠",
        "title": "Maintenance & Repairs",
        "description": "Regular servicing to minimize downtime and ensure safety."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Leading the Hoist Industry",
    "paragraphs": [
      "NTP Access provides top-tier hoist hire, service, and maintenance. We're committed to supporting projects nationwide with our comprehensive equipment range.",
      "Our focus on reliability and automation ensures projects run smoothly. We minimize downtime and enhance coordination with advanced solutions."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "NTP Access kept our project on schedule with their reliable hoists and timely service.",
        "name": "Sarah Johnson",
        "role": "Site Manager",
        "avatar": "https://images.pexels.com/photos/6196233/pexels-photo-6196233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their automated scheduling minimized our downtime, boosting efficiency significantly.",
        "name": "Tom Richards",
        "role": "Project Coordinator",
        "avatar": "https://images.unsplash.com/photo-1566821594226-cdc9cb42a4c8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjBob2lzdCUyMGhpcmUlMjAlMjYlMjBzZXJ2aWNlJTIwJTI4Y29uc3RydWN0aW9uJTIwZXF1aXBtZW50JTIwcmVudGFsJTJGYWNjZXNzJTIwc29sdXRpb25zJTI5JTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI3MjU1OTZ8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Experience our dedication to quality service and see our equipment firsthand.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us for personalized hoist solutions tailored to your project needs.",
    "consent": "By contacting us, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Efficiency",
    "description": "Leverage AI to enhance your construction project management.",
    "bullets": [
      "Real-time availability and instant quoting streamline planning.",
      "Automated maintenance reminders reduce unexpected downtime.",
      "Digital compliance documents ensure safety and adherence."
    ],
    "offer": "Mention NTP Access for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "NTP Access delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
