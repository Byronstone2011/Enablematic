const appData = {
  "brand": {
    "name": "Levismar",
    "tagline": "Built to last, every time",
    "category": "Construction Services",
    "location": "Harrow, North Lond",
    "phone": "Call us today!"
  },
  "hero": {
    "eyebrow": "Reliable construction services",
    "title": "We prevent delays and control costs.",
    "description": "Expert formwork and groundworks solutions for seamless, on-time construction. Your trusted partner in North London and beyond.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/6788272/pexels-photo-6788272.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We deliver flawless execution in formwork and concrete, ensuring safety and quality."
      },
      {
        "title": "Dependable Solutions",
        "description": "Our team ensures projects run on schedule and within budget every time."
      },
      {
        "title": "Client Focused",
        "description": "We prioritize communication and satisfaction for every client we serve."
      }
    ]
  },
  "offerings": {
    ...
    "description": "From foundations to renovations, we offer tailored construction solutions.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Formwork",
        "description": "High-quality formwork solutions for reinforced concrete structures."
      },
      {
        "icon": "🛠",
        "title": "Groundworks",
        "description": "Expert groundworks for stable foundations and site preparation."
      },
      {
        "icon": "🏡",
        "title": "Home Extensions",
        "description": "Tailored home renovations and extensions to transform your space."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded in Harrow, we specialize in delivering formwork, groundworks, and renovations across North London. We pride ourselves on reliability and precision.",
      "By combining expertise and technology, we streamline construction processes, ensuring timely delivery and exceptional results for contractors and homeowners."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Levismar kept our project on schedule and delivered top-notch results. Highly recommended!",
        "name": "John Davies",
        "role": "Property Developer",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their attention to detail and cost control made our home extension stress-free.",
        "name": "Sarah Patel",
        "role": "Homeowner",
        "avatar": "https://images.unsplash.com/photo-1603516270950-26e4f5004ffd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMjhmb3Jtd29yayUyQyUyMHJlaW5mb3JjZWQlMjBjb25jcmV0ZSUyQyUyMGdyb3VuZHdvcmtzJTI5JTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjIzNTg1Mjh8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Harrow-Based Excellence",
    "description": "Serving North London and beyond with reliable construction solutions.",
    "address": "Harrow, North London",
    "website": "www.levismar.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Levismar Today",
    "description": "Reach out for quotes, consultations, or project inquiries. Let's build together.",
    "consent": "By contacting us, you agree to our terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Construction",
    "description": "Leverage AI to save time, reduce costs, and improve project oversight.",
    "bullets": [
      "Automated project scheduling and updates.",
      "Instant online quotes and lead tracking.",
      "Client portals for seamless communication."
    ],
    "offer": "Mention Levismar for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Levismar delivers unforgettable experiences.",
    "address": "Harrow, North London",
    "email": "",
    "socials": [
      {
