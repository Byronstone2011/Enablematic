const appData = {
  ...
  "hero": {
    "eyebrow": "Innovative modular systems",
    "title": "Reduce installation times and risks.",
    "description": "Our balustrade systems save time, cut costs, and improve safety with pre-installed solutions for precast stairs.",
    "highlights": [
      {
        "label": "Install Time Saved",
        "value": "30%+"
      },
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Multi-axis adjustability",
        "description": "Flexible fixings designed for easy installation on precast stairs."
      },
      {
        "title": "Pre-installed systems",
        "description": "Save time by delivering prefabricated, ready-to-use solutions."
      },
      {
        "title": "Safety-focused design",
        "description": "Reduce risks with compliant, hot works-free installations."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our modular balustrade systems streamline construction processes.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Modular Systems",
        "description": "Customizable K100 and K200 systems for versatile stair applications."
      },
      {
        "icon": "🛡",
        "title": "Prefabrication",
        "description": "Offsite pre-installation ensures faster, safer onsite assembly."
      },
      {
        "icon": "💼",
        "title": "Project Support",
        "description": "Specification guidance and risk reduction for optimal outcomes."
      }
    ]
  },
  "story": {
    "eyebrow": "Our journey",
    "title": "Revolutionizing stair systems",
    "paragraphs": [
      "Konnekt Offsite Ltd specializes in modular balustrade systems with multi-axis adjustability. Designed for precast stairs, our products save time and reduce risks.",
      "By focusing on efficiency and safety, we empower architects, contractors, and developers to streamline projects with innovative solutions."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Konnekt's pre-installed systems cut our project time by weeks. Incredible efficiency!",
        "name": "Sarah Mitchell",
        "role": "Project Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their modular designs ensured compliance and eliminated safety risks onsite.",
        "name": "James Carter",
        "role": "Architect",
  ...
  "visit": {
    "eyebrow": "Visit us",
    "title": "Connect with Konnekt",
    "description": "Explore how our systems can transform your next project. Contact us today.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Reach out to discuss your project needs and receive tailored solutions.",
    "consent": "Your information will remain secure."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "AI-driven solutions",
    "description": "Streamline project planning with smart automation tools.",
    "bullets": [
      "Instant quotes with a product configurator.",
      "Automated specification downloads.",
      "Integrated CRM for lead management."
    ],
    "offer": "Mention Konnekt Offsite for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Konnekt Offsite delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
