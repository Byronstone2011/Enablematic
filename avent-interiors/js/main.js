const appData = {
  "brand": {
    "name": "Avent Interiors",
    "tagline": "Transforming Workspaces",
    "category": "Office Interiors",
    "location": "Bristol, Cheltenha",
    "phone": ""
  },
  "hero": {
    "eyebrow": "FIS Accredited Experts",
    "title": "Optimize Your Workspace Efficiently",
    "description": "We deliver seamless office transformations, minimizing delays and maximizing space.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Bold Design",
        "description": "Our distinctive style ensures your workplace stands out with clarity and purpose."
      },
      {
        "title": "Quality Imagery",
        "description": "High-quality photography showcases real transformations for your inspiration."
      },
      {
        "title": "Client Focus",
        "description": "We prioritize your experience with transparent processes and communication."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive office fit-out and refurbishment services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Office Fit-Out",
        "description": "Complete office fit-out from concept to delivery, ensuring a smooth transition."
      },
      {
        "icon": "💼",
        "title": "Interior Design",
        "description": "Strategic space planning and design to optimize functionality and aesthetics."
      },
      {
        "icon": "🛠",
        "title": "Partitioning",
        "description": "Expert installation of partitioning, glazing, and furniture for a cohesive look."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Family Business with Expertise",
    "paragraphs": [
      "Avent Interiors Ltd has been transforming offices for over 30 years. Our family-run approach ensures personalized attention and outstanding results.",
      "We excel in medium-to-large projects, offering tailored solutions to enhance client experience and foster repeat business."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Avent Interiors optimized our workspace efficiently. Delays were minimal, and communication was excellent.",
        "name": "Sarah Mitchell",
        "role": "Facilities Manager",
        "avatar": "https://images.pexels.com/photos/8382591/pexels-photo-8382591.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their design transformed our office! The process was smooth, and the outcome exceeded expectations.",
        "name": "James Clarke",
        "role": "Office Manager",
        "avatar": "https://images.unsplash.com/photo-1758630737361-ca7532fb5e7f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb21tZXJjaWFsJTIwb2ZmaWNlJTIwaW50ZXJpb3JzJTIwJTJGJTIwZml0LW91dCUyMCUyNiUyMHJlZnVyYmlzaG1lbnQlMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjcyNTY3M3ww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Our Locations",
    "description": "Serving Bristol, Cheltenham, and Swindon. Discover vibrant communities with a rich history.",
    "address": "",
    "website": "aventinteriors.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Book a Free Survey",
    "description": "Contact us today to schedule your free site survey and consultation.",
    "consent": "I consent to be contacted by Avent Interiors."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Process",
    "description": "Streamline operations with our advanced automation solutions.",
    "bullets": [
      "Instant online quotes with e-signatures.",
      "Automated client updates and approvals.",
      "Efficient job scheduling and inventory tracking."
    ],
    "offer": "Mention Avent Interiors for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Avent Interiors delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
