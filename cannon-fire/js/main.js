const appData = {
  ...
  "hero": {
    "eyebrow": "Empowering Innovation",
    "title": "Fuel Your Growth with Cannon Fire",
    "description": "Discover cutting-edge solutions designed to propel your business forward. We deliver results that matter.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/9862136/pexels-photo-9862136.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We craft personalized solutions to meet your unique business needs and drive measurable success."
      },
      {
        "title": "Proven Results",
        "description": "Our track record speaks for itself, with hundreds of satisfied clients and impactful outcomes."
      },
      {
        "title": "Expert Team",
        "description": "Our dedicated professionals bring unmatched expertise and passion to every project we undertake."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Cannon Fire offers innovative solutions to help businesses thrive. Explore our services below.",
    "cards": [
      {
        "icon": "🛋️",
        "title": "Strategic Consulting",
        "description": "Gain insights and strategies tailored to your goals, ensuring sustainable growth and success."
      },
      {
        "icon": "🛠️",
        "title": "Tech Integration",
        "description": "Leverage cutting-edge technology to streamline operations and enhance productivity effortlessly."
      },
      {
        "icon": "🎥",
        "title": "Creative Solutions",
        "description": "Innovative approaches to problem-solving that drive your business forward in competitive markets."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Cannon Fire was founded with a mission to empower businesses through innovation. Over the years, we've grown into a trusted partner for companies worldwide, delivering solutions that make a difference.",
      "Our team is driven by a passion for excellence and a commitment to our clients' success. We believe in pushing boundaries, embracing challenges, and creating opportunities for growth and transformation."
    ],
    "image": "https://images.pexels.com/photos/33357440/pexels-photo-33357440.png?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Cannon Fire transformed our business with their innovative strategies. Highly recommend!",
        "name": "Alex Johnson",
        "role": "CEO, TechCorp",
        "avatar": "https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their expertise and dedication are unmatched. Our growth has been phenomenal.",
        "name": "Maria Lopez",
        "role": "Founder, Green Solutions",
        "avatar": "https://images.unsplash.com/photo-1758599543154-76ec1c4257df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBwb3J0cmFpdCUyMGhlYWRzaG90JTIwYnVzaW5lc3MlMjBwZXJzb258ZW58MHx8fHwxNzYxMDkwMDgwfDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Cannon Fire operates globally, delivering tailored solutions to businesses across industries.",
    "address": "123 Innovation Lane, USA",
    "website": "www.cannonfire.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started Today",
    "title": "Let's Transform Your Business",
    "description": "Contact us to discuss your goals and discover how Cannon Fire can help you achieve them.",
    "consent": "By submitting, you agree to our terms and privacy policy. Your information is safe with us."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Revolutionize Your Business with AI",
    "description": "Cannon Fire leverages AI to deliver smarter, faster, and more efficient solutions tailored to your needs.",
    "bullets": [
      "Automate processes for increased efficiency.",
      "Gain actionable insights with AI analytics.",
      "Enhance decision-making with predictive tools."
    ],
    "offer": "Mention Cannon Fire for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Cannon Fire delivers unforgettable experiences.",
    "address": "123 Innovation Lane, USA",
    "email": "",
    "socials": [
      {
