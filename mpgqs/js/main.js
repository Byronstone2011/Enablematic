const appData = {
  ...
  "hero": {
    "eyebrow": "Expert solutions delivered",
    "title": "Mastering cost control and dispute resolution",
    "description": "MPGQS excels in managing complex projects, ensuring cost efficiency and smooth dispute resolution.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "RICS accreditation underscores our commitment to excellence and professionalism."
      },
      {
        "title": "Visual Clarity",
        "description": "Professional visuals enhance our service presentations, ensuring clear communication."
      },
      {
        "title": "Client Trust",
        "description": "Testimonials reflect our dedication to client satisfaction and reliable service delivery."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services for construction needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Quantity Surveying",
        "description": "Expert cost management and budget control for all project phases."
      },
      {
        "icon": "💼",
        "title": "Dispute Resolution",
        "description": "Effective mediation and arbitration services to resolve conflicts smoothly."
      },
      {
        "icon": "⚙️",
        "title": "MEP Consultancy",
        "description": "Detailed engineering support to optimize your mechanical and electrical systems."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "MPGQS has been a leader in construction consultancy, serving regions across the UK, Europe, and the Middle East. Our expertise ensures clients achieve their project goals.",
      "We excel in document-heavy and compliance-sensitive processes, leveraging automation for efficiency. Our high contract values make us a preferred partner."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "MPGQS transformed our project with their expert cost control and timely dispute resolution.",
        "name": "John Smith",
        "role": "Developer",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their MEP consultancy was instrumental in optimizing our building systems.",
        "name": "Sarah Lee",
        "role": "Contractor",
  ...
  "visit": {
    ...
    "description": "Serving the UK, Europe, and Middle East. Contact us to learn more.",
    "address": "",
    "website": "mpgqs.com",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us today for expert advice and project support.",
    "consent": "I consent to receive communications from MPGQS."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Efficiency Through AI",
    "description": "Harness automation to streamline your projects.",
    "bullets": [
      "Automate lead capture with CRM integration.",
      "Use templates for instant proposals and quotes.",
      "Client portal for secure document sharing."
    ],
    "offer": "Mention MPGQS for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "MPGQS delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
