const appData = {
  "brand": {
    "name": "RSP Sprinklers",
    "tagline": "Protecting Lives, Always",
    "category": "Fire Protection",
    "location": "Location Unknown",
    "phone": "Contact via Email"
  },
  "hero": {
    "eyebrow": "Expert Fire Safety Solutions",
    "title": "Ensure safety, reduce downtime, comply now.",
    "description": "RSP Fire Sprinkler Systems delivers rapid, compliant fire protection solutions with minimal disruption.",
    "highlights": [
      {
        "label": "Sprinkler Heads Instal",
        "value": "569+"
      },
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Bold Identity",
        "description": "Our striking brand colors convey trust and professionalism."
      },
      {
        "title": "Clear Navigation",
        "description": "Easily find services with our intuitive icon-based navigation."
      },
      {
        "title": "Credible Stats",
        "description": "We use real numbers to demonstrate our expertise and reliability."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive fire sprinkler services tailored for safety and efficiency.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Design & Installation",
        "description": "Custom fire sprinkler systems for residential and domestic properties."
      },
      {
        "icon": "🏙",
        "title": "High-rise Retrofit",
        "description": "Expert retrofitting and new build installations for high-rise buildings."
      },
      {
        "icon": "🛠",
        "title": "Emergency Response",
        "description": "Rapid response to restore systems and minimize downtime."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "RSP Fire Sprinkler Systems has been dedicated to protecting lives and properties with top-notch fire safety solutions. We pride ourselves on our precision and reliability.",
      "Our focus on institutional property owners ensures repeatable, efficient projects. We integrate advanced CRM systems for seamless communication and project management."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "RSP made our retrofit project seamless, with minimal tenant disruption and quick compliance.",
        "name": "Jane Doe",
        "role": "Housing Association Manager",
        "avatar": "https://images.pexels.com/photos/12237450/pexels-photo-12237450.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their emergency response was swift, restoring our system in no time.",
        "name": "Mark Smith",
        "role": "Property Manager",
        "avatar": "https://images.unsplash.com/photo-1734629813216-31ba94b4badd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxGaXJlJTIwcHJvdGVjdGlvbiUyMCUyRiUyMFNwcmlua2xlciUyMHN5c3RlbSUyMGluc3RhbGxhdGlvbiUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4NjQ5fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Find Us",
    "title": "Visit RSP",
    "description": "Contact us to learn more about our comprehensive fire protection services.",
    "address": "Location Unknown",
    "website": "www.rspsprinklersystems.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Book a Consultation",
    "description": "Reach out to schedule your fire safety assessment today.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate & Protect",
    "description": "Leverage AI-driven solutions for seamless operations.",
    "bullets": [
      "Schedule assessments with ease using our online booking tool.",
      "Automate tenant communications for effective project updates.",
      "Track emergency teams' ETAs with real-time dispatch tools."
    ],
    "offer": "Mention RSP Sprinklers for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "RSP Sprinklers delivers unforgettable experiences.",
    "address": "Location Unknown",
    "email": "",
    "socials": [
      {
