const appData = {
  "brand": {
    "name": "Green Roofers",
    "tagline": "Sustainable Roofing Solutions",
    "category": "Green Roofing",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Eco-friendly excellence",
    "title": "Boost your project's sustainability today!",
    "description": "Green Roofers Ltd enhances your eco-impact with tailored green roofs. Elevate your project visibility and conversion rates.",
    "highlights": [
      {
        "label": "Green Roofs Installed",
        "value": "1,000+"
      },
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Impressive Imagery",
        "description": "Our site features stunning visuals of our projects, highlighting our expertise."
      },
      {
        "title": "Eco-Friendly Designs",
        "description": "We create sustainable and environmentally conscious roofing systems."
      },
      {
        "title": "Minimal Design",
        "description": "Our clean, white-space-optimized website showcases our green identity."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We provide comprehensive green roofing services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Green Roof Installation",
        "description": "We install high-quality green roofs that blend with your environment."
      },
      {
        "icon": "💼",
        "title": "Design & Consultancy",
        "description": "Our experts design and consult on green roof systems for optimal results."
      },
      {
        "icon": "🌿",
        "title": "Maintenance & Managem",
        "description": "We ensure your green roof stays healthy and thriving with expert care."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Green Spaces Above",
    "paragraphs": [
      "Green Roofers Ltd collaborates with architects and contractors to create innovative green roofing solutions tailored to each project's unique needs.",
      "Our specialized offerings and local expertise make us a perfect fit for enhancing your sustainability and project success."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Green Roofers transformed our building into an eco-friendly landmark.",
        "name": "Alex Johnson",
        "role": "Architect",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their design and installation were seamless and professional.",
        "name": "Emma Clarke",
  ...
  "visit": {
    ...
    "description": "See our work in action and discover how we can transform your space.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us for a personalized consultation to elevate your project.",
    "consent": "I agree to the privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Success",
    "description": "Leverage AI to enhance your green roofing projects effortlessly.",
    "bullets": [
      "Automate quotes and site visit requests.",
      "Boost local SEO and online presence.",
      "Streamline lead nurturing workflows."
    ],
    "offer": "Mention Green Roofers for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Green Roofers delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
