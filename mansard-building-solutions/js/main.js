const appData = {
  ...
  "hero": {
    ...
    "title": "Streamlined solutions for timely projects",
    "description": "Mansard solves delays with automated quoting and project management.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7078859/pexels-photo-7078859.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our team brings decades of experience to ensure quality builds."
      },
      {
        "title": "Visual Impact",
        "description": "Bold designs with eye-catching accents enhance every project."
      },
      {
        "title": "Efficient Processes",
        "description": "Streamlined project management for timely and effective delivery."
      }
    ]
  },
  "offerings": {
    ...
    "description": "From new builds to renovations, we cover all your construction needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Commercial Builds",
        "description": "We deliver office fit-outs, new builds, and retail refurbishments."
      },
      {
        "icon": "🏠",
        "title": "Residential Projects",
        "description": "Custom homes, extensions, and renovations tailored to you."
      },
      {
        "icon": "🚧",
        "title": "Infrastructure Works",
        "description": "Expertise in groundworks, drainage, and roadworks."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Built on a foundation of quality",
    "paragraphs": [
      "Mansard Building Solutions, based in South West London, excels in property development. We offer commercial, residential, and infrastructure services.",
      "Our tailored solutions and automated processes ensure efficiency and client satisfaction, making us a trusted name in the industry."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Mansard's automated quoting saved us time and ensured a smooth project start.",
        "name": "John Fisher",
        "role": "Property Developer",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their project management kept us updated and on schedule. Highly recommend!",
        "name": "Sarah Collins",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Experience Our Projects",
    "description": "Discover our projects in vibrant South West London.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Contact us for a consultation and take the first step to your new build.",
    "consent": "I agree to the terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Harness AI for Better Builds",
    "description": "Automate processes and enhance efficiency with AI.",
    "bullets": [
      "Automate lead capture and follow-ups for faster responses.",
      "Streamline quoting and scheduling to shorten project timelines.",
      "Integrate project management for seamless client communication."
    ],
    "offer": "Mention Mansard for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Mansard delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
