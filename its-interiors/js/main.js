const appData = {
  "brand": {
    "name": "ITS Interiors",
    "tagline": "Crafting Commercial Excellence",
    "category": "Interior Fit-Out",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Bespoke Interior Solutions",
    "title": "Transform your space with ease and precision.",
    "description": "ITS Interiors streamlines your fit-out process with expert design, reducing delays and enhancing quality.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our team ensures flawless execution and top-tier quality in every project."
      },
      {
        "title": "Trusted Credentials",
        "description": "ISO certifications and safety accreditations guarantee excellence and trust."
      },
      {
        "title": "Proven Portfolio",
        "description": "Showcasing diverse projects ensures our capability to meet unique needs."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our range of services tailored to exceed your expectations.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Office Fit-Out",
        "description": "We transform workspaces into inspiring environments that boost productivity."
      },
      {
        "icon": "🛠",
        "title": "Bespoke Joinery",
        "description": "Custom joinery solutions crafted to fit your unique vision and space."
      },
      {
        "icon": "🏢",
        "title": "Interior Refit",
        "description": "Revitalize existing spaces with innovative designs and seamless execution."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "ITS Interiors started with a vision to redefine commercial spaces. We have evolved to become a leader in bespoke fit-outs.",
      "Our client-focused approach ensures that each project is tailored to specific needs, creating spaces that inspire."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "ITS Interiors transformed our office with unparalleled precision and creativity.",
        "name": "Sarah James",
        "role": "Corporate Client",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their attention to detail and efficiency surpassed our expectations.",
        "name": "John Smith",
  ...
  "visit": {
    ...
    "description": "Experience our projects in prime locations throughout the UK and Europe.",
    "address": "",
    "website": "www.itsinteriors.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Book a Consultation",
    "description": "Contact us to discuss how we can bring your vision to life.",
    "consent": "I agree to receive communications from ITS Interiors."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Success",
    "description": "Streamline processes and enhance client engagement with AI.",
    "bullets": [
      "Automate lead capture and follow-ups with CRM integration.",
      "Use dynamic galleries for effortless portfolio management.",
      "Schedule discovery calls with ease using automated tools."
    ],
    "offer": "Mention ITS Interiors for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "ITS Interiors delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
