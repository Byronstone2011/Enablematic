const appData = {
  ...
  "hero": {
    ...
    "title": "On-time, on-budget roofing solutions.",
    "description": "Highview Group ensures timely, budget-friendly roofing with clear communication.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Navigate our services easily with icon-based organization."
      },
      {
        "title": "Project Showcase",
        "description": "Explore a gallery of varied projects showcasing our expertise."
      },
      {
        "title": "Certified Quality",
        "description": "NFRC certification ensures top-tier service and credibility."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive roofing solutions tailored to commercial needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Flat Roof Installation",
        "description": "Precision flat roof installations for durability and performance."
      },
      {
        "icon": "🏗",
        "title": "Pre-construction Design",
        "description": "Expert design support to streamline your construction process."
      },
      {
        "icon": "🏗",
        "title": "Post-completion Suppo",
  ...
  "story": {
    ...
    "paragraphs": [
      "Highview Group has established itself as a leader in commercial roofing, providing reliable and high-quality services for over 20 years.",
      "Our commitment to innovation and client satisfaction positions us as a preferred choice, enhancing communication through advanced technology."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Highview Group delivered our project on time and budget with excellent communication.",
        "name": "John Smith",
        "role": "Property Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their transparency and professionalism made project management seamless.",
        "name": "Emily Brown",
  ...
  "visit": {
    ...
    "description": "We welcome you to visit our office to discuss your roofing needs.",
    "address": "",
    "website": "www.highviewgroup.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request a Consultation",
    "description": "Contact us to schedule a consultation and discuss your project.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline with AI",
    "description": "Enhance efficiency and transparency with AI-driven solutions.",
    "bullets": [
      "Automate lead capture and qualification.",
      "Use instant quoting for faster estimates.",
      "Client portal for real-time updates."
    ],
    "offer": "Mention Highview Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Highview Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
