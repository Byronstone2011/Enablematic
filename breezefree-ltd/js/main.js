const appData = {
  ...
  "hero": {
    "eyebrow": "Outdoor living experts",
    "title": "Streamline your outdoor space projects",
    "description": "Breezefree Ltd simplifies your outdoor projects with automated systems, enhancing efficiency and client satisfaction.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Experience our diverse outdoor projects through a stunning visual portfolio."
      },
      {
        "title": "Quality Photography",
        "description": "High-quality images showcase the professionalism and craftsmanship of our work."
      },
      {
        "title": "Clear Typography",
        "description": "Our clean typography ensures easy navigation and readability for all visitors."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Transform your outdoor spaces with our expert design and construction services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Designing Spaces",
        "description": "We design beautiful, functional outdoor spaces tailored to your needs."
      },
      {
        "icon": "🏗",
        "title": "Manufacturing Structure",
        "description": "Our structures, like pergolas and awnings, are crafted for durability and style."
      },
      {
        "icon": "🏗",
        "title": "Installation Services",
        "description": "Professional installation ensures your outdoor spaces are built to last."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Creating Outdoor Masterpieces",
    "paragraphs": [
      "Breezefree Ltd specializes in crafting outdoor spaces with retractable structures, pergolas, and more.",
      "Our solutions are perfect for homeowners and businesses, offering visual portfolios and easy booking."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Breezefree transformed our garden into a stunning oasis. The process was seamless!",
        "name": "John Smith",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/19443350/pexels-photo-19443350.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their innovative designs and professional service exceeded our expectations.",
        "name": "Emma Johnson",
  ...
  "visit": {
    ...
    "description": "Explore our range of outdoor solutions and experience our craftsmanship firsthand.",
    "address": "",
    "website": "www.breezefree.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Book Your Consultation",
    "description": "Contact us today to transform your outdoor space into a functional haven.",
    "consent": "By submitting, you agree to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Outdoor Projects",
    "description": "Harness the power of AI to enhance your outdoor living projects.",
    "bullets": [
      "Online quoting for consultations.",
      "CRM integration for client management.",
      "E-commerce for easy part purchases."
    ],
    "offer": "Mention Breezefree Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Breezefree Ltd delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
