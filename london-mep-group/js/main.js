const appData = {
  "brand": {
    "name": "London MEP Group",
    "tagline": "Efficient Solutions Delivered",
    "category": "MEP Contracting",
    "location": "Loughton, UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Trusted MEP Contractors",
    "title": "Eliminate Downtime with Expert Coordination",
    "description": "We streamline complex projects, reduce costs, and ensure energy efficiency.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our clean, professional design supports seamless project management."
      },
      {
        "title": "Technical Expertise",
        "description": "Industrial photography showcases our technical proficiency."
      },
      {
        "title": "Clear Communication",
        "description": "Strong visual hierarchy ensures clear, effective communication."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive MEP services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "New Build MEP",
        "description": "Residential, commercial, and co-living MEP projects expertly handled."
      },
      {
        "icon": "🏢",
        "title": "Office Fit-Outs",
        "description": "Transform office spaces with our tailored fit-out services."
      },
      {
        "icon": "🔧",
        "title": "Maintenance Services",
        "description": "Planned preventative maintenance for seamless operations."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded in Loughton, London MEP Group Ltd excels in mechanical, electrical, and public health works. We serve central and greater London with pride.",
      "Our focus on quality and automation aligns with modern needs, reducing costs and enhancing project success."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "London MEP Group's coordination saved us time and money. Highly recommend!",
        "name": "Julie Thompson",
        "role": "Property Developer",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their maintenance services are top-notch. We no longer face unexpected downtimes.",
        "name": "David Lee",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Our Location",
    "description": "Based in Loughton, we serve the vibrant London and surrounding areas.",
    "address": "",
    "website": "londonmep.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us Today",
    "description": "Reach out to discuss your project needs and how we can help.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance Your Efficiency",
    "description": "Leverage AI solutions for better project outcomes.",
    "bullets": [
      "Automated maintenance scheduling reduces downtime.",
      "Energy dashboards optimize compliance and savings.",
      "Client portal streamlines project updates and management."
    ],
    "offer": "Mention London MEP Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "London MEP Group delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
