const appData = {
  "brand": {
    "name": "JBS Mechanical",
    "tagline": "Reliable Heating Solutions",
  ...
  "hero": {
    ...
    "title": "Say goodbye to breakdowns and stay compliant.",
    "description": "JBS Mechanical Ltd ensures your plumbing and heating systems run smoothly while keeping you compliant with safety regulations.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our skilled team delivers top-notch plumbing and heating solutions."
      },
      {
        "title": "Clean Design",
        "description": "Enjoy a clean, organized service experience with clear categories."
      },
      {
        "title": "Visual Excellence",
        "description": "Professional photography showcases our quality work."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our comprehensive plumbing and heating services designed for homeowners and contractors.",
    "cards": [
      {
        "icon": "🔥",
        "title": "Boiler Installation",
        "description": "Expert boiler installation and replacement services for efficient heating."
      },
      {
        "icon": "🛁",
        "title": "Bathroom Renovation",
        "description": "Transform your bathroom with our bespoke installation services."
      },
      {
        "icon": "🔧",
        "title": "Safety Certification",
        "description": "Ensure compliance with our landlord safety and gas certification."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "JBS Mechanical Ltd is a team of professionals offering top-notch plumbing, heating, and renewable energy solutions. We are committed to providing exceptional service to our clients.",
      "Our services are tailored to meet the needs of homeowners and contractors. We focus on efficiency and compliance, ensuring peace of mind for our clients."
    ],
    "image": "https://images.pexels.com/photos/29226620/pexels-photo-29226620.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "JBS Mechanical saved us during a boiler emergency. Their expertise was invaluable.",
        "name": "Emily Turner",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/11447054/pexels-photo-11447054.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "As a landlord, I rely on JBS for all safety certifications. They're the best!",
        "name": "Martin Lewis",
        "role": "Landlord",
        "avatar": "https://images.unsplash.com/photo-1647356097831-65559f4459d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxQbHVtYmluZyUyMCUyNiUyMEhlYXRpbmclMjAlMjhIVkFDJTJGcGx1bWJpbmclMjklMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODcxNnww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "We provide top-tier plumbing solutions across the region. Contact us to learn more.",
    "address": "",
    "website": "",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "description": "Reach out today to book a service or get a free quote.",
    "consent": "I consent to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Experience",
    "description": "Enhance service efficiency with our AI-driven solutions.",
    "bullets": [
      "Book online for convenience.",
      "Receive automated service reminders.",
      "Get digital quotes instantly."
    ],
    "offer": "Mention JBS Mechanical for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "JBS Mechanical delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
