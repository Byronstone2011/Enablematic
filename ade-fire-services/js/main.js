const appData = {
  ...
  "hero": {
    ...
    "title": "Complete Fire Safety Solutions Made Simple",
    "description": "Stay compliant with UK fire safety laws effortlessly. ADE Fire Services provides trusted inspections, training, and maintenance, ensuring your workplace is safe and",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Decades of fire safety experience ensure your business receives trusted guidance and services."
      },
      {
        "title": "Comprehensive Solutions",
        "description": "From inspections to training, we offer all-inclusive fire safety support tailored to your needs."
      },
      {
        "title": "Dedicated Support",
        "description": "We work closely with you to ensure your staff and premises stay safe and compliant."
      }
    ]
  },
  "offerings": {
    ...
    "description": "ADE Fire Services ensures fire safety compliance through expert services and tailored solutions.",
    "cards": [
      {
        "icon": "🛋️",
        "title": "Fire Equipment Services",
        "description": "We supply, install, inspect, and maintain fire extinguishers and emergency lighting systems."
      },
      {
        "icon": "🛠️",
        "title": "Fire Risk Assessments",
        "description": "Detailed, documented risk assessments to identify hazards and ensure compliance."
      },
      {
        "icon": "🎥",
        "title": "Professional Training",
        "description": "Onsite fire warden and extinguisher training to empower your team with essential safety skills."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Protecting UK Businesses Since Day One",
    "paragraphs": [
      "ADE Fire Services was founded with a mission to make fire safety compliance straightforward and accessible for businesses across the UK. With a range of services from equipment installation to professional training, we ensure",
      "Our focus on recurring compliance work and training allows us to provide consistent, high-quality services to businesses of all sizes. By combining expertise with reliable service, ADE Fire Services is your partner in safeguarding lives and property."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "ADE Fire Services made compliance stress-free. Their inspections and training gave us confidence in our fire safety setup.",
        "name": "Sarah Thompson",
        "role": "Operations Manager",
        "avatar": "https://images.pexels.com/photos/8774427/pexels-photo-8774427.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "The team at ADE Fire Services provided excellent training and guidance, ensuring our staff are prepared for any emergency.",
        "name": "James Carter",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Serving Milton Keynes and Beyond",
    "description": "Located in Milton Keynes, ADE Fire Services proudly supports businesses across the UK with reliable fire safety solutions.",
    "address": "Milton Keynes, England",
    "website": "www.adefireservices.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Book Your Consultation Today",
    "description": "Contact us to schedule your fire safety service or training and ensure compliance with UK regulations.",
    "consent": "By submitting, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Smart Fire Safety Solutions",
    "description": "Transform your compliance process with AI-driven tools and automation.",
    "bullets": [
      "Automated reminders for inspections and training scheduling.",
      "Digital certificates and reports stored in a secure client portal.",
      "Streamlined workflows for engineers with mobile inspection apps."
    ],
    "offer": "Mention ADE Fire Services for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "ADE Fire Services delivers unforgettable experiences.",
    "address": "Milton Keynes, England",
    "email": "",
    "socials": [
      {
