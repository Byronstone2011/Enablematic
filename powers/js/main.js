const appData = {
  "brand": {
    "name": "Powers",
    "tagline": "Precision in surveying",
    "category": "Land surveying",
    "location": "Cheshire, UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Expert Land Surveyors",
    "title": "Streamline your surveys with Powers' tech.",
    "description": "Powers simplifies land surveying with automation, saving you time and reducing errors.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Real Work Imagery",
        "description": "See our team in action with real project images that build trust and transparency."
      },
      {
        "title": "Structured Layout",
        "description": "Our clear navigation helps you find the services you need quickly and efficiently."
      },
      {
        "title": "Certified Trust",
        "description": "Prominent certification badges assure you of our commitment to quality."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our diverse range of high-precision surveying services tailored to your needs.",
    "cards": [
      {
        "icon": "📏",
        "title": "Land Surveys",
        "description": "We offer precision land surveys to provide accurate site data for your projects."
      },
      {
        "icon": "📐",
        "title": "3D Surveys",
        "description": "Utilize our 3D surveying services for detailed and comprehensive site analysis."
      },
      {
        "icon": "🚧",
        "title": "Site Engineering",
        "description": "Our site engineering services ensure your project foundations are solid and secure."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Powers has been delivering top-notch land surveying services in Cheshire, ensuring precision and quality in every project.",
      "With our B2B-focused approach, we integrate automation to enhance efficiency and provide measurable ROI."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Powers streamlined our processes with their automated systems, saving us valuable time.",
        "name": "John Smith",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/11174192/pexels-photo-11174192.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their precision and attention to detail are unmatched. Powers exceeds expectations every time.",
        "name": "Emma Brown",
        "role": "Architect",
  ...
  "visit": {
    "eyebrow": "Find Us",
    "title": "Visit Powers",
    "description": "Located in Cheshire, we serve the North West and beyond with exceptional surveying solutions.",
    "address": "Cheshire, UK",
    "website": "powersuk.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Request a Quote",
    "description": "Contact us for a no obligation quote and discover how we can assist your next project.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Surveys",
    "description": "Discover the power of automation with Powers.",
    "bullets": [
      "Online quoting and booking system for efficiency.",
      "Automated CRM for seamless lead capture.",
      "Secure portal for easy access to survey data."
    ],
    "offer": "Mention Powers for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Powers delivers unforgettable experiences.",
    "address": "Cheshire, UK",
    "email": "",
    "socials": [
      {
