const appData = {
  "brand": {
    "name": "Domna",
    "tagline": "Efficient retrofits made easy",
  ...
  "hero": {
    ...
    "title": "Streamline retrofits with Domna",
    "description": "We simplify assessments, funding, and installations to boost property efficiency. Save time and reduce energy costs.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "From assessment to installation, we cover every stage for seamless retrofits."
      },
      {
        "title": "Funding Expertise",
        "description": "We navigate complex grants and finance options to maximize savings."
      },
      {
        "title": "Technology Driven",
        "description": "Our AI-powered tools ensure accuracy, speed, and better outcomes."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Domna offers tailored energy efficiency solutions for residential and commercial properties.",
    "cards": [
      {
        "icon": "📋",
        "title": "Remote Assessments",
        "description": "AI-powered evaluations simplify energy efficiency planning for portfolios."
      },
      {
        "icon": "🏗",
        "title": "Retrofit Design",
        "description": "PAS 2035-compliant surveys ensure quality and regulatory compliance."
      },
      {
        "icon": "💰",
        "title": "Funding Assistance",
        "description": "We secure ECO, GBIS, and other grants to lower upgrade costs."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Empowering energy efficiency",
    "paragraphs": [
      "Domna was founded to simplify retrofits, helping property owners drive efficiency gains. We deliver end-to-end solutions tailored to your needs.",
      "Through innovation and expertise, we solve complex challenges in funding, design, and coordination. Our tools streamline every step for better results."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Domna made retrofits simple by handling funding and design. Saved us time and stress!",
        "name": "James Carter",
        "role": "Landlord",
        "avatar": "https://images.pexels.com/photos/4921128/pexels-photo-4921128.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their AI tools and support helped us upgrade efficiently. Highly recommend Domna!",
        "name": "Sarah Lewis",
        "role": "Property Manager",
        "avatar": "https://images.unsplash.com/photo-1700964396663-4f91ec376285?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxSZXNpZGVudGlhbCUyMCUyNiUyMGNvbW1lcmNpYWwlMjByZXRyb2ZpdCUyMCUyRiUyMGVuZXJneSUyMGVmZmljaWVuY3klMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjQzMzI4NXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Learn more about Domna",
    "description": "Discover how we transform properties with efficient, tailored solutions.",
    "address": "",
    "website": "www.domna.homes",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Request Your Retrofit Consultation",
    "description": "Contact us for expert advice and customized energy efficiency solutions.",
    "consent": "We respect your privacy. No spam."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "AI-Powered Solutions",
    "description": "Domna leverages automation for smarter, faster retrofits.",
    "bullets": [
      "Instant property assessments for quick insights.",
      "Automated funding checks streamline applications.",
      "Digital EPC issuance saves time and reduces errors."
    ],
    "offer": "Mention Domna for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Domna delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
