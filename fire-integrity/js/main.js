const appData = {
  "brand": {
    "name": "FIRE INTEGRITY",
    "tagline": "Protection Evolved",
    "category": "Fire Safety",
    "location": "United Kingdom",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Innovating Since 2005",
    "title": "Ensure Compliance with Expert Solutions",
    "description": "We provide seamless fire protection to meet evolving regulations. Trust our experience to manage all inspections and documentation.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Decades of experience ensure flawless fire protection solutions every time."
      },
      {
        "title": "Client Trust",
        "description": "Our impressive portfolio highlights our commitment to safety and client satisfaction."
      },
      {
        "title": "Innovative Design",
        "description": "We use cutting-edge techniques to deliver superior fire safety systems."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive fire protection services catering to all your safety needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "System Design",
        "description": "We design and install bespoke passive fire protection systems for your safety."
      },
      {
        "icon": "🔥",
        "title": "Firestopping",
        "description": "Our firestopping solutions and intumescent coatings secure your premises."
      },
      {
        "icon": "💼",
        "title": "Consultancy",
        "description": "Expert consultancy for inspection, testing, and compliance across all projects."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Since 2005, FIRE INTEGRITY LIMITED has protected life and assets through expert passive fire protection. Our team is fully accredited.",
      "We integrate automation to enhance efficiency. By focusing on digital solutions, we improve compliance tracking and client satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "FIRE INTEGRITY LTD streamlined our compliance process effortlessly.",
        "name": "John Smith",
        "role": "Building Manager",
        "avatar": "https://images.pexels.com/photos/7831936/pexels-photo-7831936.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their expertise in fire safety is unparalleled. Highly recommend!",
        "name": "Sarah Johnson",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Our Location",
    "description": "We are based in the United Kingdom, serving nationwide with pride.",
    "address": "",
    "website": "fireintegrity.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us Today",
    "description": "Reach out for consultations or to schedule a site visit. We're here to help.",
    "consent": "By contacting us, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Harness Automation",
    "description": "Streamline operations with AI-driven solutions.",
    "bullets": [
      "Book inspections online with ease.",
      "Get instant project estimates.",
      "Access digital compliance records anytime."
    ],
    "offer": "Mention FIRE INTEGRITY for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "FIRE INTEGRITY delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
