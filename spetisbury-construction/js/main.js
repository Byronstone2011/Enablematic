const appData = {
  "brand": {
    "name": "Spetisbury Construc",
    "tagline": "Crafting Quality Builds",
    "category": "Construction",
    "location": "South Coast, Engla",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Award-winning service",
    "title": "Streamlined projects, timely updates.",
    "description": "We simplify construction with automated updates and efficient communication. Experience seamless project management.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/34640157/pexels-photo-34640157.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our team excels in delivering high-quality builds with precision."
      },
      {
        "title": "Stunning Projects",
        "description": "We showcase our craftsmanship with every project, big or small."
      },
      {
        "title": "Award Winning",
        "description": "Recognized for excellence and innovation in construction."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Discover our diverse range of services tailored to meet your needs.",
    "cards": [
      {
        "icon": "🏠",
      ...
      },
      {
        ...
        "description": "We create functional and aesthetic spaces for businesses."
      },
      {
        "icon": "🔨",
        "title": "Restoration & Renovat",
        "description": "Transform and restore properties with our skilled renovation team."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Spetisbury Construction is a regional contractor renowned for its quality service and superior final products.",
      "We blend tradition with innovation, ensuring each project delivers lasting value and satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Spetisbury made our renovation stress-free with constant updates.",
        "name": "Michael Thompson",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their attention to detail and project management was exceptional.",
        "name": "Sarah Collins",
        "role": "Property Developer",
        "avatar": "https://images.unsplash.com/photo-1644657711115-ee46e8dd7c7d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMkYlMjBCdWlsZGluZyUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4NzgyfDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Our Office",
    "description": "Located in the scenic South Coast, we serve the Bournemouth area and beyond.",
    "address": "South Coast, England",
    "website": "www.spetisburyconstruction.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us Today",
    "description": "Reach out for consultations or project inquiries. Let's build your future together.",
    "consent": "I consent to the terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Projects",
    "description": "Leverage AI for efficient construction management.",
    "bullets": [
      "Automated project updates streamline communications.",
      "Lead capture forms boost client engagement.",
      "AI-driven CRM optimizes client onboarding."
    ],
    "offer": "Mention Spetisbury Construc for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Spetisbury Construc delivers unforgettable experiences.",
    "address": "South Coast, England",
    "email": "",
    "socials": [
      {
