const appData = {
  "brand": {
    "name": "Northern Table",
    "tagline": "Modern dining rooted in Manchester",
    "category": "Seasonal kitchen & cocktail bar",
    "location": "Manchester, UK",
    "phone": "+44 161 555 0199"
  },
  "hero": {
    "eyebrow": "Chef-led neighborhood dining",
    "title": "Experience Manchester's freshest seasonal plates.",
    "description": "Gather for tasting menus, late-night plates, and local pours in a warm Northern hideaway.",
    "highlights": [
      {
  ...
  "visit": {
    ...
    "title": "Find us in Manchester's Northern Quarter.",
    "description": "Minutes from the tram and canal, surrounded by street art and indie shops. Drop in before shows or stay for nightcaps.",
    "address": "18 Tib Street, Manchester M4 1SH",
    "website": "https://northerntable.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Reserve a table or takeover",
    "title": "Let's craft your Manchester dining moment.",
    "description": "Tell us about your celebration, dietary notes, and preferred vibe. We'll curate menus, drinks, and playlists tailored for your crew.",
    "consent": "By submitting, you agree to hear from Northern Table about bookings, tasting menus, and seasonal events."
  },
  "byronCallout": {
  ...
  "footer": {
    "blurb": "Northern Table delivers unforgettable experiences.",
    "address": "18 Tib Street, Manchester M4 1SH",
    "email": "",
    "socials": [
      {
