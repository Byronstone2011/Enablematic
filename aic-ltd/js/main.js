const appData = {
  "brand": {
    "name": "AIC Ltd",
    "tagline": "Insulation and Safety Experts",
    "category": "Industrial Contractor",
    "location": "Global Services",
    "phone": "Contact via Email"
  },
  "hero": {
    "eyebrow": "Trusted Industrial Partner",
    "title": "Solve fire risks and access challenges effectively.",
    "description": "AIC Ltd provides top-notch solutions for insulation, fireproofing, and rope access challenges, ensuring safety and efficiency.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our service cards clearly differentiate our offerings with engaging visuals."
      },
      {
        "title": "Strong Hero Section",
        "description": "Our hero section showcases a clear value proposition with impact."
      },
      {
        "title": "Project Showcase",
        "description": "We use imagery to highlight successful projects and client satisfaction."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our specialized industrial services tailored for safety and efficiency.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Insulation Solutions",
        "description": "Protect your assets with our advanced industrial insulation options for thermal efficiency."
      },
      {
        "icon": "🔥",
        "title": "Fireproofing",
        "description": "Ensure safety and compliance with our reliable fireproofing services."
      },
      {
        "icon": "💼",
        "title": "Rope Access Services",
        "description": "Reach inaccessible areas safely and efficiently with our expert rope access team."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "From Foundation to Innovation",
    "paragraphs": [
      "AIC Ltd was founded to tackle industrial challenges with innovative insulation and fireproofing solutions. We have grown into a trusted industry leader.",
      "Our focus on efficiency, safety, and cost reduction sets us apart. We integrate digital solutions for streamlined operations and better client experiences."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "AIC Ltd solved our thermal inefficiency issues effectively, reducing our costs significantly.",
        "name": "John Doe",
        "role": "Plant Manager",
        "avatar": "https://images.pexels.com/photos/3831164/pexels-photo-3831164.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their rope access services made maintenance at heights simple and safe.",
        "name": "Jane Smith",
        "role": "Facility Owner",
        "avatar": "https://images.unsplash.com/photo-1646227655718-dd721b681d91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxJbmR1c3RyaWFsJTIwY29udHJhY3RvciUyMCUyRiUyMGluc3VsYXRpb24lMjBhbmQlMjBmaXJlcHJvb2ZpbmclMjBzZXJ2aWNlcyUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjUwMDQ2fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "AIC Ltd operates globally, bringing top-tier solutions to industrial facilities everywhere.",
    "address": "Global Presence",
    "website": "www.aicltd.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request a Consultation",
    "description": "Contact us to discuss your insulation and safety needs. Email Naser Haghamed at naser@tic-int.co.uk.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation for Efficiency",
    "description": "Enhance your operations with our automation solutions.",
    "bullets": [
      "Automate lead capture and follow-ups seamlessly.",
      "Streamline project quoting and scheduling with ease.",
      "Digitize inspections for better maintenance tracking."
    ],
    "offer": "Mention AIC Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "AIC Ltd delivers unforgettable experiences.",
    "address": "Global Presence",
    "email": "",
    "socials": [
      {
