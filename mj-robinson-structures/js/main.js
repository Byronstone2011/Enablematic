const appData = {
  ...
  "hero": {
    ...
    "title": "Streamline Your Projects with Precision",
    "description": "We enhance efficiency with automated processes, ensuring timely delivery and superior quality.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our team delivers exceptional structural solutions nationwide."
      },
      {
        "title": "Award-Winning Quality",
        "description": "Recognized for excellence with multiple industry awards."
      },
      {
        "title": "Comprehensive Services",
        "description": "From design to installation, we cover all your steelwork needs."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Our services cover every stage of structural steelwork.",
    "cards": [
      {
        "icon": "🛠",
        "title": "Design",
        "description": "We create precise designs tailored to your project needs."
      },
      {
        "icon": "📐",
        "title": "Detailing",
        "description": "Our detailed drawings ensure accurate fabrication and assembly."
      },
      {
        "icon": "🏗",
        "title": "Fabrication",
        "description": "We produce high-quality steel components for any structure."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Since our inception, we've been committed to delivering superior steelwork across the UK.",
      "Our automation expertise enhances efficiency, making us a trusted partner for contractors."
    ],
    "image": "https://images.pexels.com/photos/33851309/pexels-photo-33851309.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "M J Robinson streamlined our project with their efficient processes.",
        "name": "John Smith",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/8960994/pexels-photo-8960994.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their automation solutions saved us time and effort.",
        "name": "Sarah Lee",
        "role": "Construction Lead",
        "avatar": "https://images.unsplash.com/photo-1564062743395-9f7e0f33aeb1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxTdHJ1Y3R1cmFsJTIwc3RlZWwlMjBmYWJyaWNhdGlvbiUyMCUyRiUyMGNvbnN0cnVjdGlvbiUyMHN1YmNvbnRyYWN0b3IlMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY1MDAxNXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Discover our projects and see our craftsmanship in action.",
    "address": "All over the UK",
    "website": "mjrobinson.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Contact Us",
  ...
  "byronCallout": {
    ...
    "description": "Our AI solutions simplify and optimize your workflow.",
    "bullets": [
      "Automate estimates integrating CAD outputs.",
      "Boost lead nurturing with CRM automation.",
      "Improve project tracking and invoicing."
    ],
    "offer": "Mention MJ Robinson for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "MJ Robinson delivers unforgettable experiences.",
    "address": "All over the UK",
    "email": "",
    "socials": [
      {
