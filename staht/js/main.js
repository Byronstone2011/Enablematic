const appData = {
  "brand": {
    "name": "Staht",
    "tagline": "Safety through innovation",
    "category": "Industrial Equipment",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Revolutionizing Safety",
    "title": "Streamline testing with Staht's automation",
    "description": "Staht simplifies testing with digital tools and flexible payments, reducing friction.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our clean product grid ensures easy navigation and selection."
      },
      {
        "title": "Professional Imagery",
        "description": "High-quality photos showcase our equipment in detail."
      },
      {
        "title": "Credibility Boost",
        "description": "Partner logos enhance trust and showcase our industry connections."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Staht offers cutting-edge testing solutions and expert training.",
    "cards": [
      {
        "icon": "🛡",
        "title": "Pull Testers",
        "description": "Our T25, T60, and LT models ensure safety and reliability in testing."
      },
      {
        "icon": "💻",
        "title": "Digital Tools",
        "description": "Capture data effortlessly with our connected digital hardware and apps."
      },
      {
        "icon": "📚",
        "title": "Training Courses",
        "description": "Master product use with our in-depth courses and best practices."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Staht was founded to revolutionize safety in testing. We blend tradition with innovation to meet industry needs.",
      "Our solutions cater to high-value products, enhancing sales flows and CRM integration for seamless operations."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Staht's digital tools cut down our testing time significantly.",
        "name": "John Davis",
        "role": "Site Tester",
        "avatar": "https://images.pexels.com/photos/9242291/pexels-photo-9242291.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Flexible payments made it easy to upgrade our equipment.",
        "name": "Sarah Thompson",
        "role": "Safety Manager",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Explore Staht",
    "description": "Discover our equipment and training solutions to enhance your safety protocols.",
    "address": "",
    "website": "www.staht.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Staht",
    "description": "Reach out for bookings, demos, or more info on our services.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate with Staht",
    "description": "Enhance efficiency with Staht's automation solutions.",
    "bullets": [
      "Implement online checkouts and automated invoicing.",
      "Automate booking and reminders for courses.",
      "Integrate analytics to track marketing ROI."
    ],
    "offer": "Mention Staht for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Staht delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
