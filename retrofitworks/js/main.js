const appData = {
  "brand": {
    "name": "RetrofitWorks",
    "tagline": "Simplifying Sustainable Solutions",
    "category": "Home Energy Retrofit",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Expert Renewable Solutions",
    "title": "Streamline Your Home Retrofit Journey",
    "description": "We simplify retrofits, connect you with trusted installers, and guide you through funding options.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Clear Layout",
        "description": "Our organized layout ensures homeowners find information effortlessly."
      },
      {
        "title": "Real Projects",
        "description": "Photography showcases real people and projects for genuine insights."
      },
      {
        "title": "Visual Clarity",
        "description": "Strong contrasts and typography enhance readability and engagement."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive solutions to make your home energy-efficient. Explore our key services.",
    "cards": [
      {
        "icon": "🏠",
        "title": "Home Energy Assessments",
        "description": "Thorough assessments to identify energy-saving opportunities in your home."
      },
      {
        "icon": "🛠",
        "title": "Retrofit Planning",
        "description": "Personalized plans tailored to each home's unique energy needs and circumstances."
      },
      {
        "icon": "🤝",
        "title": "Installer Coordinatio",
        "description": "We coordinate trusted installers and manage your project from start to finish."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "RetrofitWorks Co-operative was founded to simplify sustainable home improvements. We focus on making retrofits accessible and efficient for UK homeowners.",
      "Our collaborative structure and technology-driven approach streamline processes, making us a trusted partner for homeowners and professionals alike."
    ],
    "image": "https://images.pexels.com/photos/9875412/pexels-photo-9875412.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "RetrofitWorks made the daunting retrofit process seamless and stress-free.",
        "name": "Jane Smith",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/6707148/pexels-photo-6707148.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their expert guidance and reliable installers were invaluable.",
        "name": "John Doe",
        "role": "Homeowner",
        "avatar": "https://images.unsplash.com/photo-1664127379716-829859074475?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxIb21lJTIwZW5lcmd5JTIwcmV0cm9maXQlMjAlMkYlMjBzdXN0YWluYWJsZSUyMGhvbWUlMjBpbXByb3ZlbWVudCUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNzI5MjU4fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Explore how we make eco-friendly living easy and accessible across the UK.",
    "address": "N/A",
    "website": "retrofitworks.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Book a Consultation",
    "description": "Contact us to discuss your energy retrofit needs and start your journey to sustainability.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Embrace Innovation",
    "description": "Automation empowers efficiency and clarity in your retrofit projects.",
    "bullets": [
      "Online booking and scheduling simplify the process.",
      "Automated project updates keep you informed.",
      "Funding calculators streamline eligibility checks."
    ],
    "offer": "Mention RetrofitWorks for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "RetrofitWorks delivers unforgettable experiences.",
    "address": "N/A",
    "email": "",
    "socials": [
      {
