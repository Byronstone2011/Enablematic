const appData = {
  "brand": {
    "name": "PAS-Powered Access",
    "tagline": "Access Solutions Simplified",
    "category": "Equipment Rental",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Streamlined Equipment Hire",
    "title": "Effortless access equipment rental online",
    "description": "Say goodbye to booking delays. Seamless online quotes, fast scheduling, and reliable service.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/32437338/pexels-photo-32437338.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our consistent yellow and green branding ensures trust and recognition."
      },
      {
        "title": "Clear Categorization",
        "description": "Prominent sections for hire and sales make decision-making easy for users."
      },
      {
        "title": "Effective CTAs",
        "description": "Multiple calls to action guide customers smoothly throughout the site."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive equipment hire and safety training with expert support.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Equipment Hire",
        "description": "Rent scissor lifts, boom lifts, and telehandlers for any project."
      },
      {
        "icon": "🛠",
        "title": "Operator Training",
        "description": "Boost safety with our certified training courses for all operators."
      },
      {
        "icon": "📝",
        "title": "Site Surveys",
        "description": "Free surveys and equipment advice tailored to your needs."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Leading the Way in Access Solutions",
    "paragraphs": [
      "PAS-Powered Access Services offers a wide range of equipment for hire, perfect for any environment. Our platforms and telehandlers are versatile and reliable.",
      "We excel with robust digital solutions. Our automated systems streamline bookings and maintenance, enhancing efficiency and customer satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "PAS streamlined our equipment hire, reducing downtime and increasing project efficiency.",
        "name": "John Smith",
        "role": "Construction Manager",
        "avatar": "https://images.pexels.com/photos/4124367/pexels-photo-4124367.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their online booking system saved us time and hassle. Truly efficient!",
        "name": "Sarah Linton",
  ...
  "visit": {
    ...
    "description": "Located across the UK, access our services wherever your project is.",
    "address": "UK",
    "website": "poweredaccessservices.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request a Quote Today",
    "description": "Contact us for bookings or consultations. We're ready to assist.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Unlock Efficiency with AI",
    "description": "Enhance your rental experience with automated solutions.",
    "bullets": [
      "Instant online quoting and booking system for quick access.",
      "Automated maintenance scheduling to ensure equipment reliability.",
      "Smart CRM for seamless follow-ups and customer engagement."
    ],
    "offer": "Mention PAS-Powered Access for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "PAS-Powered Access delivers unforgettable experiences.",
    "address": "UK",
    "email": "",
    "socials": [
      {
