const appData = {
  ...
  "hero": {
    ...
    "title": "Revolutionize Your Housing Projects",
    "description": "We streamline capital and simplify modular home delivery, ensuring quality and compliance.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7579402/pexels-photo-7579402.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our modular homes boast cutting-edge design and functionality."
      },
      {
        "title": "Trusted Partners",
        "description": "We collaborate with leading financial institutions for secure investments."
      },
      {
        "title": "Seamless Process",
        "description": "Effortless integration with automated client and investor solutions."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our comprehensive modular housing services.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Modular Home Design",
        "description": "Innovative design and delivery of high-quality modular homes."
      },
      {
        "icon": "💼",
        "title": "Housing Finance",
        "description": "Access finance and investment options like sukuk for modular projects."
      },
      {
        "icon": "📸",
        "title": "Virtual Tours",
        "description": "Experience homes virtually with our immersive tours."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Moduliv Limited is at the forefront of modular housing innovation. We provide sustainable building solutions that redefine modern living.",
      "Our approach combines technology and expertise to optimize investor engagement and streamline construction processes."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Moduliv's innovative solutions helped us secure large-scale funding effortlessly.",
        "name": "John Smith",
        "role": "Property Investor",
        "avatar": "https://images.pexels.com/photos/458825/pexels-photo-458825.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their modular homes exceeded our expectations in quality and delivery speed.",
        "name": "Sarah Lee",
        "role": "Housing Authority Director",
        "avatar": "https://images.unsplash.com/flagged/photo-1594651538933-259de3386be5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxNb2R1bGFyJTIwaG91c2luZyUyMCUyOG9mZnNpdGUlMjBjb25zdHJ1Y3Rpb24lMjklMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjcyOTIyMXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Discover Our Work",
    "title": "Visit Our Portfolio",
    "description": "Explore our project locations to see our modular homes in action.",
    "address": "",
    "website": "www.moduliv.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Contact Us Today",
    "description": "Reach out for consultations on modular housing solutions.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhancing Efficiency",
    "description": "Leverage AI to streamline your modular housing projects.",
    "bullets": [
      "Automated onboarding simplifies investor management.",
      "CRM automation captures leads from virtual tours.",
      "Track grants and mortgages with automated systems."
    ],
    "offer": "Mention Moduliv for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Moduliv delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
