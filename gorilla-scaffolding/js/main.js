const appData = {
  "brand": {
    "name": "Gorilla Scaffold",
    "tagline": "Reliable Scaffolding Experts",
    "category": "Construction",
    "location": "Birmingham, West",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Leading Scaffolding Service",
    "title": "Effortless Scaffolding Solutions in Birmingham",
    "description": "Get instant quotes and bookings online. Safe, certified, and efficient scaffolding services tailored to your needs.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/29498002/pexels-photo-29498002.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our distinct yellow and black theme ensures easy recognition and trust."
      },
      {
        "title": "Visual Trust Signals",
        "description": "Safety badges and certifications demonstrate our commitment to quality."
      },
      {
        "title": "Service Clarity",
        "description": "Clear categorization helps clients find the exact service they need swiftly."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive scaffolding services for all your construction needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Scaffold Hire",
        "description": "Flexible scaffold hire options for residential and commercial projects."
      },
      {
        "icon": "🔧",
        "title": "Installation & Dismantl",
        "description": "Expert installation and dismantling by certified operatives."
      },
      {
        "icon": "🏠",
        "title": "Residential Projects",
        "description": "Tailored solutions for residential scaffolding needs."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Building with Safety and Precision",
    "paragraphs": [
      "Gorilla Scaffolding is a leading scaffolding company based in Birmingham, providing comprehensive services for construction projects. Our focus on safety and quality has made us a trusted name.",
      "With a strong offline reputation, we leverage digital tools to enhance service delivery. Our online systems streamline processes, ensuring efficient and hassle-free experiences."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Gorilla Scaffolding made our project seamless with their quick online quoting system.",
        "name": "Sarah Thompson",
        "role": "Property Developer",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their automated updates kept us informed at every step. Highly recommend!",
        "name": "John Davis",
  ...
  "visit": {
    ...
    "description": "Located in the heart of Birmingham, we serve clients across the West Midlands with reliable scaffolding solutions.",
    "address": "",
    "website": "gorillascaffolding.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Request a Free Quote Today",
    "description": "Contact us to discuss your scaffolding needs and receive a no-obligation quote.",
    "consent": "I agree to the terms and privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Projects",
    "description": "Embrace automation for efficiency and convenience.",
    "bullets": [
      "Instant online quoting and booking reduces wait times.",
      "Automated follow-ups ensure timely project management.",
      "Receive safety compliance reminders automatically."
    ],
    "offer": "Mention Gorilla Scaffold for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Gorilla Scaffold delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
