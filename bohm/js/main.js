const appData = {
  "brand": {
    "name": "BOHM",
    "tagline": "Streamline AEC processes",
    "category": "Construction Software",
    "location": "Global",
    "phone": "Unavailable"
  },
  "hero": {
    "eyebrow": "Revolutionize Your Workflow",
    "title": "Automate, Validate, and Optimize AEC Tasks",
    "description": "BOHM enhances efficiency by automating workflows, securing validations, and optimizing processes. Reduce waste and improve outcomes.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/4440200/pexels-photo-4440200.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our intuitive interface ensures a seamless user experience in AEC software."
      },
      {
        "title": "Bold Typography",
        "description": "Clear, impactful text highlights key information effectively."
      },
      {
        "title": "Geometric Elements",
        "description": "Design elements reinforce our cutting-edge technology identity."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Transform your AEC processes with BOHM's advanced technology solutions.",
    "cards": [
      {
        "icon": "🔄",
        "title": "Transaction Automation",
        "description": "Streamline procurement, payments, and contracts with automated workflows."
      },
      {
        "icon": "🛡",
        "title": "Secure Validation",
        "description": "Ensure compliance with secure audit trails and cryptographic verification."
      },
      {
        "icon": "📊",
        "title": "Process Optimization",
        "description": "Reduce waste and improve efficiency with analytics-driven insights."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Innovating AEC Solutions",
    "paragraphs": [
      "BOHM was founded to revolutionize the AEC industry with cutting-edge software solutions that streamline operations and enhance project outcomes.",
      "Our expertise in transaction automation and process optimization makes us a perfect fit for projects aiming to maximize efficiency and reduce waste."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "BOHM transformed our procurement process, saving us time and costs.",
        "name": "Alex Turner",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/5257776/pexels-photo-5257776.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their secure validation process gives us peace of mind on every project.",
        "name": "Samantha Lee",
  ...
  "visit": {
    ...
    "title": "Global Reach",
    "description": "BOHM operates worldwide, connecting industry leaders with innovative technology.",
    "address": "Unavailable",
    "website": "www.bohmtech.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Schedule a Consultation",
    "description": "Contact us to learn how BOHM can transform your AEC operations.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "AI-Powered Solutions",
    "description": "Leverage AI for smarter, faster AEC operations.",
    "bullets": [
      "Automate procurement and payment workflows.",
      "Implement secure contract validation processes.",
      "Optimize processes with data-driven insights."
    ],
    "offer": "Mention BOHM for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "BOHM delivers unforgettable experiences.",
    "address": "Unavailable",
    "email": "",
    "socials": [
      {
