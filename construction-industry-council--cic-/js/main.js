const appData = {
  "brand": {
    "name": "CIC",
    "tagline": "Connecting the built environment",
    "category": "Professional Association",
    "location": "United Kingdom",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Driving industry excellence",
    "title": "Uniting construction for a stronger future",
    "description": "CIC empowers professionals with training, resources, and collaboration to shape the built environment.",
    "highlights": [
      {
        "label": "Years Representing",
        "value": "35+"
      },
      {
    ...
    "items": [
      {
        ...
        "description": "Decades of industry leadership ensure trusted guidance and reliable solutions."
      },
      {
        "title": "Innovative Resources",
        "description": "Access cutting-edge tools and training for seamless professional development."
      },
      {
        "title": "Strong Connections",
        "description": "Build powerful networks through our events, webinars, and partnerships."
      }
    ]
  },
  "offerings": {
    ...
    "description": "CIC provides essential services to support the UK construction industry.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Health & Safety Certificat",
        "description": "Ensure CSCS compliance with our comprehensive e-learning platform."
      },
      {
        "icon": "💼",
        "title": "Professional Networking",
        "description": "Connect with members to share expertise and foster collaboration."
      },
      {
        "icon": "📅",
        "title": "Events & Advocacy",
        "description": "Join webinars and industry events to stay informed and influence policy."
      }
    ]
  },
  "story": {
    "eyebrow": "Our mission",
    "title": "Shaping the construction industry",
    "paragraphs": [
      "Since its founding, CIC has been the voice for the UK’s construction professionals, uniting associations and fostering collaboration.",
      "By leveraging resources, advocacy, and networking, CIC empowers members to drive innovation and excellence in the built environment."
    ],
    "image": "https://images.pexels.com/photos/8082525/pexels-photo-8082525.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    "eyebrow": "What our members say",
    "title": "Voices from the industry",
    "list": [
      {
        "quote": "CIC's e-learning tools made health & safety compliance seamless for our team.",
        "name": "Sarah Brown",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/14663574/pexels-photo-14663574.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their events help us connect with experts and stay ahead in the industry.",
        "name": "John Taylor",
        "role": "Architect",
        "avatar": "https://images.unsplash.com/photo-1730791979207-583e51851e2a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMkYlMjBCdWlsdCUyMEVudmlyb25tZW50JTIwJTJGJTIwUHJvZmVzc2lvbmFsJTIwQXNzb2NpYXRpb25zJTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI1Mzg0NjV8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Our location",
    "title": "Connecting the UK construction sector",
    "description": "Our members span the UK, providing local expertise and national impact.",
    "address": "",
  ...
  "inquiry": {
    ...
    "title": "Join CIC today",
    "description": "Contact us for membership, certifications, or event details. Let’s build together.",
    "consent": "By submitting, you agree to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "AI for smarter construction",
    "description": "Transform processes with automation tailored to the industry.",
    "bullets": [
      "Automate certification issuance and e-learning management.",
      "Streamline event registrations and member communications.",
      "Centralize member expertise with searchable directories."
    ],
    "offer": "Mention CIC for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "CIC delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
