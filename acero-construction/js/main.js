const appData = {
  "brand": {
    "name": "Acero Construction",
    "tagline": "Precision in Foundations",
    "category": "Construction",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Reliable Piling Experts",
    "title": "Streamlining projects, avoiding delays.",
    "description": "Acero Construction UK Ltd eliminates schedule slippage with expert planning and efficient site delivery.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/8906956/pexels-photo-8906956.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our structured project planning ensures on-time completion and seamless execution."
      },
      {
        "title": "Specialized Support",
        "description": "We offer tailored piling expertise to meet unique project needs and overcome challenges."
      },
      {
        "title": "Efficient Delivery",
        "description": "Our team excels in managing site delivery to avoid delays and maintain momentum."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Acero Construction UK Ltd provides comprehensive support from planning to execution.",
    "cards": [
      {
        "icon": "🗺",
        "title": "Project Planning",
        "description": "Strategic planning to prepare and organize every aspect of your construction project."
      },
      {
        "icon": "🏗",
        "title": "Piling Support",
        "description": "Expert support for all piling projects, ensuring stability and safety."
      },
      {
        "icon": "📅",
        "title": "Site Management",
        "description": "On-site management to keep projects on track and within deadlines."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Acero Construction UK Ltd began as a vision to provide exceptional piling and foundation services across the UK. We are committed to excellence in every project.",
      "Our expertise and dedication to client satisfaction make us a trusted partner. We leverage advanced planning and management to ensure project success."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Acero's planning expertise saved us from costly delays. Their team is reliable and efficient.",
        "name": "James Turner",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their specialized support was crucial to our project's success. Highly recommend Acero.",
        "name": "Sarah Collins",
        "role": "Developer",
  ...
  "visit": {
    ...
    "title": "Visit Us",
    "description": "Located in the UK, Acero Construction is easily accessible for consultations and site visits.",
    "address": "",
    "website": "www.aceroconstruction.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Contact Us Today",
    "description": "Reach out for a consultation or to discuss your project needs with our expert team.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhancing Efficiency",
    "description": "Explore how AI transforms construction management.",
    "bullets": [
      "Automate lead capture and qualification seamlessly.",
      "Streamline project scheduling and resource allocation.",
      "Ensure consistent client updates with automated reporting."
    ],
    "offer": "Mention Acero Construction for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Acero Construction delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
