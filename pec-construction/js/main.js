const appData = {
  "brand": {
    "name": "P.E.C.",
    "tagline": "Precision in every fit",
    "category": "Construction & Shopfitting",
    "location": "N/A",
    "phone": "N/A"
  },
  "hero": {
    "eyebrow": "Quality craftsmanship",
    "title": "Reliable, on-time, on-budget solutions",
    "description": "P.E.C. ensures timely and budget-friendly construction with top-notch service.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7937359/pexels-photo-7937359.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        "title": "Real Work Environments",
        "description": "Showcase your projects with strong imagery of actual work sites."
      },
      {
        "title": "Clear Value Message",
        "description": "Communicate your unique value with industry-specific messaging."
      },
      {
        "title": "Professional Photograph",
        "description": "Enhance your brand with high-quality, professional imagery."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services for all your construction needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Commercial Construction",
        "description": "We deliver expert construction solutions tailored for commercial properties."
      },
      {
        "icon": "🛍",
        "title": "Shopfitting & Retail",
        "description": "Transform your retail space with custom shopfitting and design."
      },
      {
        "icon": "📝",
        "title": "Project Planning",
        "description": "Comprehensive project management and in-house contracting services."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "P.E.C. offers premium shopfitting, manufacturing, and building services across different sectors.",
      "Our digital transformation enhances client interactions and streamlines project processes."
    ],
    "image": "https://images.pexels.com/photos/8961003/pexels-photo-8961003.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "P.E.C. delivered on their promise, on time and within budget. Highly recommend!",
        "name": "John Doe",
        "role": "Retail Owner",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Exceptional craftsmanship and attention to detail. P.E.C. is our go-to contractor.",
        "name": "Jane Smith",
        "role": "Commercial Property Manager",
        "avatar": "https://images.unsplash.com/photo-1603516270950-26e4f5004ffd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMjYlMjBTaG9wZml0dGluZyUyMENvbnRyYWN0b3JzJTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI3MjkyNzJ8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Explore our projects and see the P.E.C. difference in action.",
    "address": "N/A",
    "website": "www.p-e-c.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Contact Us",
    "title": "Let's Build Together",
    "description": "Get in touch today for consultations or quotes.",
    "consent": "Yes, I agree to the terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Smart Construction Solutions",
    "description": "Enhance your project efficiency with innovative AI solutions.",
    "bullets": [
      "Automate lead capture with CRM integration.",
      "Streamline quoting with online tools.",
      "Automate scheduling and client updates."
    ],
    "offer": "Mention P.E.C. for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "P.E.C. delivers unforgettable experiences.",
    "address": "N/A",
    "email": "",
    "socials": [
      {
