const appData = {
  ...
  "hero": {
    ...
    "title": "Safeguard your space from asbestos risks",
    "description": "Innov8 Group ensures safe asbestos removal while minimizing disruption. Trust us to handle compliance and safety.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our team is accredited with top certifications, ensuring you trust our skilled professionals."
      },
      {
        "title": "Clear Layout",
        "description": "Our services are clearly organized, making it easy to find exactly what you need."
      },
      {
        "title": "Real Results",
        "description": "See our work in action through professional photography and client testimonials."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Innov8 Group offers comprehensive asbestos solutions tailored for safety and compliance.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Asbestos Removal",
        "description": "Expert removal services to eliminate health risks from your property."
      },
      {
        "icon": "💼",
        "title": "Consultancy",
        "description": "Professional guidance to manage asbestos and ensure compliance with regulations."
      },
      {
        "icon": "🛡",
        "title": "Waste Disposal",
        "description": "Safe and compliant handling and disposal of asbestos materials."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Innov8 Group began with a mission to protect communities from hazardous materials. Our skilled team delivers unrivaled service.",
      "With a focus on local expertise and advanced technology, we streamline processes for regulatory compliance and customer satisfaction."
    ],
    "image": "https://images.pexels.com/photos/3771074/pexels-photo-3771074.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Innov8 handled everything professionally, ensuring our safety and compliance. Highly recommend!",
        "name": "John D.",
        "role": "Homeowner",
        "avatar": "https://images.pexels.com/photos/9246019/pexels-photo-9246019.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Efficient and knowledgeable team. They minimized disruption and kept us informed throughout.",
        "name": "Sarah K.",
  ...
  "visit": {
    ...
    "title": "Visit Us",
    "description": "Serving Manchester and the North West, known for its industrial heritage and vibrant community.",
    "address": "N/A",
    "website": "N/A",
    "mapEmbed": ""
  },
  "inquiry": {
    ...
    "title": "Contact Us",
    "description": "Schedule a consultation for safe asbestos solutions tailored to your needs.",
    "consent": "Your information is safe with us."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Efficiency with AI",
    "description": "Innovate your asbestos management with our AI solutions.",
    "bullets": [
      "Automated compliance certificates ensure you always meet legal requirements.",
      "Online booking simplifies scheduling site surveys and jobs.",
      "CRM integration nurtures leads with timely follow-ups."
    ],
    "offer": "Mention Innov8 Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Innov8 Group delivers unforgettable experiences.",
    "address": "N/A",
    "email": "",
    "socials": [
      {
