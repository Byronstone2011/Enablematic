const appData = {
  ...
  "hero": {
    "eyebrow": "Safety & Compliance Experts",
    "title": "Stay compliant with fire safety standards.",
    "description": "LFS ensures your buildings are compliant and safe with minimal disruption. Protect your assets with our expert solutions.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our striking red branding ensures immediate recognition and trust."
      },
      {
        "title": "Proven Expertise",
        "description": "Real-world experience showcased through professional photography."
      },
      {
        "title": "Credibility",
        "description": "Comprehensive client logos display our trusted partnerships."
      }
    ]
  },
  "offerings": {
    ...
    "description": "LFS provides essential fire protection services with expert care.",
    "cards": [
      {
        "icon": "🛡",
        "title": "Fire Door Surveys",
        "description": "Expert assessments ensure compliance and safety for your properties."
      },
      {
        "icon": "🏗",
        "title": "Manufacture & Install",
        "description": "Custom FD30 and FD60 doors, expertly installed for maximum protection."
      },
      {
        "icon": "⚠️",
        "title": "Fire Stopping",
        "description": "Comprehensive solutions to prevent the spread of fire and smoke."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "London Fire Solutions proudly serves London with robust fire safety solutions. Our dedication to safety is unmatched.",
      "We excel with digital certifications and reliable reporting. Our clients value our seamless service integration."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "LFS made compliance easy. Their team was professional and efficient.",
        "name": "Sarah J.",
        "role": "Facility Manager",
        "avatar": "https://images.pexels.com/photos/7831936/pexels-photo-7831936.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their fire door installation was flawless. Highly recommend!",
        "name": "Mike T.",
        "role": "Building Owner",
        "avatar": "https://images.unsplash.com/photo-1713689824343-77d2f99e19b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxQYXNzaXZlJTIwZmlyZSUyMHByb3RlY3Rpb24lMjAlMkYlMjBmaXJlJTIwZG9vciUyMG1hbnVmYWN0dXJpbmclMjBhbmQlMjBpbnN0YWxsYXRpb24lMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjY0ODUxMXww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Located in London's heart, we are ready to serve your fire protection needs.",
    "address": "London, UK",
  ...
  "inquiry": {
    ...
    "description": "Contact us to discuss your fire safety needs and schedule a survey.",
  ...
  "byronCallout": {
    ...
    "bullets": [
      "Schedule surveys online with ease.",
      "Access digital certifications anytime.",
      "Receive automated maintenance alerts."
    ],
    "offer": "Mention LFS for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "LFS delivers unforgettable experiences.",
    "address": "London, UK",
    "email": "",
    "socials": [
      {
