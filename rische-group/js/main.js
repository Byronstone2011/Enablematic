const appData = {
  "brand": {
    "name": "Rische Group",
    "tagline": "Transforming spaces seamlessly",
  ...
  "hero": {
    ...
    "title": "Visualize and execute your dream workspace.",
    "description": "Rische Group turns your vision into reality with precision management and minimal downtime.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "We deliver clean, professional designs with effective use of space."
      },
      {
        "title": "Showcasing Team",
        "description": "Our team is showcased through professional photography and detailed profiles."
      },
      {
        "title": "Organized Services",
        "description": "Our services are clearly organized with a strategic visual hierarchy."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Rische Group offers comprehensive fit-out and refurbishment services tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Fit-Out Services",
        "description": "From shell to finished workspace, we manage every aspect of the fit-out process."
      },
      {
        "icon": "🔧",
        "title": "Refurbishment",
        "description": "Our refurbishment services include project management and technical installations."
      },
      {
        "icon": "🖌",
        "title": "Design & CGI",
        "description": "In-house design with CAD, SketchUp, and photorealistic renderings to visualize your space."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "Crafting Spaces with Precision",
    "paragraphs": [
      "Rische Group specializes in transforming commercial spaces with meticulous attention to detail and design.",
      "Our seamless integration of technology and design ensures efficient project management and client satisfaction."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Rische Group made our office renovation effortless. Their design clarity and execution were spot on.",
        "name": "Jessica Thompson",
        "role": "Facilities Manager",
        "avatar": "https://images.pexels.com/photos/5201930/pexels-photo-5201930.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their project management minimized our downtime, keeping us on schedule and budget.",
        "name": "David Morris",
  ...
  "visit": {
    ...
    "title": "Discover Our Headquarters",
    "description": "Visit us to explore our innovative solutions and discuss your next project.",
  ...
  "inquiry": {
    ...
    "description": "Contact us to discuss how we can transform your space with precision.",
    "consent": "I agree to receive communications."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Empowering Your Projects",
    "description": "Leverage AI and automation to streamline your project management.",
    "bullets": [
      "Automate CRM lead capture for seamless follow-ups.",
      "Use online quoting tools for accurate proposals.",
      "Coordinate projects with automated scheduling."
    ],
    "offer": "Mention Rische Group for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Rische Group delivers unforgettable experiences.",
    "address": "London, United Kingdom",
    "email": "",
    "socials": [
      {
