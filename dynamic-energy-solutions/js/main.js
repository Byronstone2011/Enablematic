const appData = {
  ...
  "hero": {
    "eyebrow": "Reliable energy solutions",
    "title": "Minimize downtime, maximize efficiency",
    "description": "We specialize in solar PV, EV charging, and high-voltage systems to keep your operations running smoothly.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Over 5,000 installations completed with unmatched technical precision."
      },
      {
        "title": "Innovative Solutions",
        "description": "Custom designs tailored to your business needs and future goals."
      },
      {
        "title": "Reliable Support",
        "description": "Comprehensive maintenance to ensure uninterrupted performance."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Dynamic Energy Solutions provides tailored energy services for businesses.",
    "cards": [
      {
        "icon": "☀️",
        "title": "Solar PV Installation",
        "description": "Optimize energy generation with our custom solar PV solutions."
      },
      {
        "icon": "⚡",
        "title": "EV Charging Infrastruct",
        "description": "Deploy scalable EV charging stations across multiple sites."
      },
      {
        "icon": "🏗",
        "title": "High Voltage Systems",
        "description": "Ensure compliance and seamless grid connections for your operations."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Dynamic Energy Solutions was founded to transform commercial energy systems. We deliver efficient, scalable solutions in renewable energy and electrical contracting.",
      "Our expertise in automation and maintenance keeps systems running at peak performance. We are trusted by businesses for reliability and innovation."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Dynamic Energy saved us from costly downtime with their fast, reliable service.",
        "name": "Michael T.",
        "role": "Facility Manager",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "Their EV charging rollout made scaling seamless across our business parks.",
        "name": "Sarah W.",
  ...
  "visit": {
    ...
    "description": "We serve businesses worldwide, ensuring personalized support wherever you are.",
    "address": "",
    "website": "dynamic-energy-solutions.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get started",
    "title": "Request a consultation",
    "description": "Contact us to discuss your energy needs and get a custom quote today.",
    "consent": "Your privacy matters. We will never share your information."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate your energy management",
    "description": "AI tools simplify energy operations, saving time and costs.",
    "bullets": [
      "Automate lead capture for faster project quoting.",
      "Schedule technicians efficiently to reduce downtime.",
      "Monitor assets remotely to detect issues instantly."
    ],
    "offer": "Mention Dynamic Energy for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Dynamic Energy delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
