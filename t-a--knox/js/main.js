const appData = {
  "brand": {
    "name": "T A Knox Ltd",
    "tagline": "Expert fit-outs, on time",
    "category": "Commercial Fit-Out",
    "location": "United Kingdom",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Trusted UK Fit-Outs",
    "title": "Eliminate delays and stay on budget",
    "description": "We manage complex projects with precision, ensuring timely delivery and cost control.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/8961154/pexels-photo-8961154.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "Our branding reflects our commitment to quality and consistency."
      },
      {
        "title": "Professional Imagery",
        "description": "We showcase our work through professional photography."
      },
      {
        "title": "Engaging CTAs",
        "description": "Multiple CTAs guide your journey smoothly on our site."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our range of fit-out services tailored for various commercial spaces.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Commercial Fit-Outs",
        "description": "We specialize in office, retail, and hospitality fit-outs across the UK."
      },
      {
        "icon": "🏢",
        "title": "Refurbishments",
        "description": "Our team expertly manages refurbishments and strip-out projects."
      },
      {
        "icon": "🛠",
        "title": "Project Management",
        "description": "Comprehensive management ensures seamless coordination and execution."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "T A Knox Limited transforms spaces across the UK with expert fit-out services for hotels, shops, and offices.",
      "Our focus on automation and efficiency drives project success, meeting client needs with precision."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "T A Knox delivered on time and within budget. Their team was professional and efficient.",
        "name": "Sarah Williams",
        "role": "Property Developer",
        "avatar": "https://images.pexels.com/photos/17482906/pexels-photo-17482906.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Seamless coordination and excellent service. Highly recommend T A Knox for any fit-out project.",
        "name": "John Davies",
        "role": "Retail Manager",
        "avatar": "https://images.unsplash.com/photo-1646227655718-dd721b681d91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxDb21tZXJjaWFsJTIwZml0LW91dCUyMCUyRiUyMENvbnN0cnVjdGlvbiUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4MjQ4fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Explore our completed projects across the UK to see our quality craftsmanship.",
    "address": "Various Locations, UK",
    "website": "www.taknox.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in Touch",
    "title": "Start Your Project",
    "description": "Contact us to discuss your commercial fit-out needs today.",
    "consent": "By submitting, you agree to our terms."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamlined Processes",
    "description": "Our automation solutions enhance efficiency and accuracy in all projects.",
    "bullets": [
      "Automated CRM for quick responses.",
      "Digital quoting to speed up sales.",
      "Real-time updates with mobile reporting."
    ],
    "offer": "Mention T A Knox Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "T A Knox Ltd delivers unforgettable experiences.",
    "address": "Various Locations, UK",
    "email": "",
    "socials": [
      {
