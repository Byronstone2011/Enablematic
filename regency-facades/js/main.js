const appData = {
  "brand": {
    "name": "Regency Facades",
    "tagline": "Facade systems perfected.",
    "category": "Construction",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Expert facade solutions",
    "title": "Transforming buildings with precision.",
    "description": "We deliver tailored facade systems, ensuring efficiency, compliance, and seamless integration for your project needs.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/7078629/pexels-photo-7078629.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We create bespoke facade solutions to match your project’s unique specifications."
      },
      {
        "title": "Seamless execution",
        "description": "Our experienced team ensures flawless integration and timely delivery."
      },
      {
        "title": "Proven expertise",
        "description": "Over 15 years of experience delivering quality facade systems."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We specialize in innovative facade systems and cladding solutions tailored to your needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Rainscreen Cladding",
        "description": "Durable, weather-resistant cladding for modern architectural designs."
      },
      {
        "icon": "🛡",
        "title": "External Wall Insulatio",
        "description": "Enhance energy efficiency with advanced insulation systems."
      },
      {
        "icon": "📐",
        "title": "Facade Design",
        "description": "Custom facade solutions designed by our in-house experts."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Founded to address complex facade challenges, we bring precision and innovation to every project. Our designs ensure performance and aesthetic appeal.",
      "With advanced tools and expert staff, we streamline processes for contractors, developers, and architects. Let us elevate your projects."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Regency Facades delivered seamless cladding solutions on time and within budget. Highly recommend their expertise.",
        "name": "John Peterson",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their facade designs transformed our building while meeting strict compliance standards. Exceptional service!",
        "name": "Claire Matthews",
        "role": "Architect",
        "avatar": "https://images.unsplash.com/photo-1577307568474-a94afc05852e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlMjhmYWNhZGUlMjBzeXN0ZW1zJTIwJTJGJTIwY2xhZGRpbmclMjklMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjM4MDA5MHww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Discover innovative facade solutions tailored to your project needs. Contact us today.",
    "address": "",
    "website": "www.regencyfacades.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in touch",
    "title": "Request a consultation.",
    "description": "Contact us for bespoke facade solutions tailored to your needs. We’re here to help.",
    "consent": "By submitting, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline your facade projects.",
    "description": "Harness AI-powered tools to simplify complex workflows and boost efficiency.",
    "bullets": [
      "Automate lead capture and CRM integration.",
      "Speed up quotes with automated estimation tools.",
      "Optimize project management with smart scheduling."
    ],
    "offer": "Mention Regency Facades for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Regency Facades delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
