const appData = {
  "brand": {
    "name": "Arc Tech",
    "tagline": "Innovating Building Services",
    "category": "Building Services",
    "location": "Scotland",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Leaders in Construction",
    "title": "Streamlined projects with expert solutions",
    "description": "Arc Tech (Scotland) Ltd simplifies construction with superior M&E services. Enhance efficiency and sustainability today.",
    "highlights": [
      {
  ...
  "pillars": {
    ...
    "items": [
      {
        "title": "Expertise Visualized",
        "description": "Our projects showcase our leadership in M&E services with stunning visuals."
      },
      {
        "title": "Certified Excellence",
        "description": "Industry certifications ensure our commitment to quality and safety."
      },
      {
        "title": "Comprehensive Support",
        "description": "Multiple contact options provide seamless communication and support."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Providing tailored solutions in mechanical, electrical, and renewable services.",
    "cards": [
      {
        "icon": "⚙️",
        "title": "Mechanical Services",
        "description": "Expert installation and maintenance for all mechanical systems."
      },
      {
        "icon": "💡",
        "title": "Electrical Services",
        "description": "Comprehensive electrical solutions for diverse project needs."
      },
      {
        "icon": "🌿",
        "title": "Renewable Energy",
        "description": "Implement zero-emissions systems for a sustainable future."
      }
    ]
  },
  "story": {
    "eyebrow": "Our Journey",
    "title": "From Local Roots to National Impact",
    "paragraphs": [
      "Arc-Tech (Scotland) Ltd has become a leader in building services. We deliver M&E solutions for a range of projects.",
      "Our innovative approach aligns with modern needs, ensuring efficient workflows and sustainable outcomes."
    ],
    "image": "https://images.pexels.com/photos/6196225/pexels-photo-6196225.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    "eyebrow": "What Clients Say",
    "title": "Real Experiences, Real Feedback",
    "list": [
      {
        "quote": "Arc Tech transformed our project management with seamless M&E integration.",
        "name": "Emily Fraser",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/6196225/pexels-photo-6196225.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their renewable solutions reduced our carbon footprint significantly.",
        "name": "Liam MacDonald",
        "role": "Sustainability Officer",
        "avatar": "https://images.unsplash.com/photo-1646227655718-dd721b681d91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4Mjc2Nzh8MHwxfHNlYXJjaHwxfHxCdWlsZGluZyUyMHNlcnZpY2VzJTIwJTJGJTIwTWVjaGFuaWNhbCUyQyUyMEVsZWN0cmljYWwlMjAlMjYlMjBSZW5ld2FibGUlMjBTZXJ2aWNlcyUyMGhlYWRzaG90JTIwcG9ydHJhaXR8ZW58MHx8fHwxNzYyNjQ4NTU0fDA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Explore our completed projects and see our work in action.",
    "address": "",
    "website": "arctechscotland.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Ready to Transform?",
    "description": "Contact us today for a consultation or to schedule a service.",
    "consent": "By contacting us, you agree to our privacy policy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Enhance with Automation",
    "description": "Streamline processes with AI-driven solutions.",
    "bullets": [
      "Automate follow-ups for faster lead conversion.",
      "Use online quoting for accurate estimates.",
      "Integrate project management for efficiency."
    ],
    "offer": "Mention Arc Tech for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Arc Tech delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
