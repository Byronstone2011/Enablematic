const appData = {
  "brand": {
    "name": "ADAPT FORMWORK LTD",
    "tagline": "Formwork engineered for success",
    "category": "Construction",
    "location": "UK Wide Coverage",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Trusted nationwide provider",
    "title": "Expert formwork solutions delivered on time",
    "description": "We supply high-quality formwork systems across the UK with technical support to ensure safety and efficiency on every project.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our services are accessible anywhere in the UK, ensuring reliable support for all projects."
      },
      {
        "title": "Technical Expertise",
        "description": "We provide ongoing engineering support to guarantee safe and efficient formwork solutions."
      },
      {
        "title": "Tailored Solutions",
        "description": "Customizable systems meet the demands of high-rise and complex concrete structures."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We deliver advanced formwork systems for projects nationwide, supported by expert engineering.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Climbing Formwork",
        "description": "Self-climbing and rail-guided systems for high-rise structures."
      },
      {
        "icon": "🛠",
        "title": "Wall & Column Forms",
        "description": "Single-sided and circular solutions for diverse projects."
      },
      {
        "icon": "🔧",
        "title": "Slab Formwork",
        "description": "Modular and beam systems designed for horizontal structures."
      }
    ]
  },
  "story": {
    "eyebrow": "Our journey",
    "title": "Built to support your vision",
    "paragraphs": [
      "ADAPT FORMWORK LTD is a trusted supplier of formwork systems with UK-wide coverage. We are committed to providing reliable solutions backed by technical expertise.",
      "Our tailored approach ensures contractors and engineers can overcome challenges with precision. We deliver safety, efficiency, and expert support every time."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "ADAPT's formwork systems streamlined our high-rise project. Their engineering support was exceptional.",
        "name": "David Mitchell",
        "role": "Project Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Reliable delivery and tailored solutions made ADAPT our go-to partner for large concrete builds.",
        "name": "Sarah Evans",
        "role": "Civil Engineer",
        "avatar": "https://images.unsplash.com/photo-1602799534033-620e7c52f894?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxDb25zdHJ1Y3Rpb24lMjAlRTIlODAlOTQlMjBmb3Jtd29yayUyMCUyNiUyMGVuZ2luZWVyaW5nJTIwaGVhZHNob3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3NjI0MzMzMDZ8MA&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    "eyebrow": "Visit us",
    "title": "UK-wide service locations",
    "description": "ADAPT FORMWORK LTD provides nationwide coverage, ensuring access to quality and expertise anywhere.",
    "address": "",
  ...
  "inquiry": {
    ...
    "description": "Contact us to discuss your formwork needs. Let us deliver safe, efficient solutions for your next project.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automation for efficiency",
    "description": "Streamline operations with advanced AI solutions tailored to formwork logistics.",
    "bullets": [
      "Automated quoting for custom systems.",
      "24-hour delivery and inventory scheduling.",
      "CRM integration for seamless communication."
    ],
    "offer": "Mention ADAPT FORMWORK LTD for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "ADAPT FORMWORK LTD delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
