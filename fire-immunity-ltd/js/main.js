const appData = {
  ...
  "hero": {
    "eyebrow": "Certified Fire Protection",
    "title": "Ensure Fire Safety Compliance & Protect Lives",
    "description": "Fire Immunity Ltd specializes in passive fire protection solutions designed to meet UK regulations, mitigate risks, and safeguard properties. From fire barriers to",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "SMAS and IFC certified professionals ensuring fire safety compliance for all industries."
      },
      {
        "title": "Broad Service Coverage",
        "description": "From schools to factories, our tailored solutions protect diverse property types."
      },
      {
        "title": "Proven Results",
        "description": "Thousands of successful installations and surveys with unmatched accuracy."
      }
    ]
  },
  "offerings": {
    ...
    "description": "We provide comprehensive passive fire protection services for commercial and industrial properties.",
    "cards": [
      {
        "icon": "🛋️",
        "title": "Compartmentation Surveys",
        "description": "Identify and address gaps in fire safety compliance with expert analysis."
      },
      {
        "icon": "🛠️",
        "title": "Penetration Sealing",
        "description": "Install fire-rated seals to prevent fire spread through walls and floors."
      },
      {
        "icon": "🎥",
        "title": "Structural Steel Prot",
        "description": "Protect steel structures with intumescent coatings to maintain integrity under heat."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Since our inception, Fire Immunity Ltd has been dedicated to protecting lives and properties through expert passive fire protection solutions. With highly trained staff and certifications like SMAS and IFC, we ensure compliance",
      "Our commitment to efficiency, precision, and tailored services makes us a trusted partner for schools, housing, healthcare, and commercial properties across the South West UK."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Fire Immunity Ltd helped us achieve full fire safety compliance quickly and professionally. Their team is outstanding!",
        "name": "Sarah Turner",
        "role": "Facilities Manager, Healthcare",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Thanks to Fire Immunity’s expertise, our factory passed inspections with ease. Highly recommend their services!",
        "name": "James Higgins",
  ...
  "visit": {
    "eyebrow": "Serving the South West",
    "title": "Local Expertise, Regional Impact",
    "description": "Fire Immunity Ltd serves schools, hospitals, and businesses across Bristol and surrounding areas, ensuring safety compliance with local fire regulations.",
    "address": "Bristol, UK",
    "website": "fireimmunity.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started Today",
    "title": "Book a Free Consultation",
    "description": "Contact our experts to discuss your fire protection needs. Get a free consultation and protect your property now.",
    "consent": "We value your privacy and ensure secure communication."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Streamline Your Fire Safety Processes",
    "description": "Leverage automation to enhance client experience and operational efficiency.",
    "bullets": [
      "Automated lead capture and CRM integration for quick responses.",
      "Instant online estimates to speed up conversions.",
      "Compliance reporting and digital certification delivery made effortless."
    ],
    "offer": "Mention Fire Immunity Ltd for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Fire Immunity Ltd delivers unforgettable experiences.",
    "address": "Bristol, UK",
    "email": "",
    "socials": [
      {
