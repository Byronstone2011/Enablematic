const appData = {
  "brand": {
    "name": "Wavensmere",
    "tagline": "Reviving Cityscapes",
    "category": "Real Estate",
    "location": "UK",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Transformative Living",
    "title": "Enhance lead conversion effortlessly.",
    "description": "Integrate seamless bookings and automated updates for enhanced buyer engagement.",
    "highlights": [
      {
        "label": "Homes Built",
        "value": "500+"
    ...
    "items": [
      {
        ...
        "description": "Showcasing stunning architecture in every development."
      },
      {
        "title": "Innovative Designs",
        "description": "Creating vibrant living spaces with modern features."
      },
      {
        "title": "Sustainable Focus",
        "description": "Commitment to eco-friendly solutions like solar and EV charging."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our range of services tailored for urban regeneration.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Home Design",
        "description": "Crafting bespoke homes and apartments with premium quality."
      },
      {
        "icon": "🌆",
        "title": "Urban Regeneration",
        "description": "Transforming cityscapes into vibrant communities."
      },
      {
        "icon": "🔋",
        "title": "Sustainable Developme",
        "description": "Implementing green technologies for a better future."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Wavensmere Homes revitalizes historic cityscapes into modern living areas, ensuring quality and value in every project.",
      "Our focus on automation enhances client experience, driving measurable ROI and seamless operations."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Wavensmere's automation improved our buying process significantly.",
        "name": "John Smith",
        "role": "Home Buyer",
        "avatar": "https://images.pexels.com/photos/11951876/pexels-photo-11951876.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "The new booking system is a game-changer for property viewings.",
        "name": "Sarah Jones",
  ...
  "visit": {
    ...
    "description": "Visit our projects located across the UK, where history meets innovation.",
    "address": "",
    "website": "wavensmere.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get In Touch",
    "title": "Schedule Your Visit",
    "description": "Contact us to book a home viewing or consultation.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Success",
    "description": "Streamline operations with advanced automation.",
    "bullets": [
      "Integrate lead capture to enhance engagement.",
      "Schedule viewings with automated reminders.",
      "Automate updates for property listings."
    ],
    "offer": "Mention Wavensmere for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Wavensmere delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
