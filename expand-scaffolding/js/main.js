const appData = {
  "brand": {
    "name": "Expand Scaffolding",
    "tagline": "Reliable, Safe, Efficient",
    "category": "Scaffolding Services",
    "location": "London, Surrey,",
    "phone": "Unavailable"
  },
  "hero": {
    "eyebrow": "Trustworthy Scaffolding",
    "title": "Get fast, reliable scaffolding quotes",
    "description": "Experience seamless scaffolding services with instant quotes and expert support.",
    "highlights": [
      {
    ...
    "image": "https://images.pexels.com/photos/27806663/pexels-photo-27806663.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "pillars": {
    ...
    "items": [
      {
        ...
        "description": "We showcase the London skyline to underline our local expertise and trust."
      },
      {
        "title": "Clear Navigation",
        "description": "Our icon-based navigation ensures you find the right service quickly."
      },
      {
        "title": "Accredited Trust",
        "description": "Our CHAS, CISRS, and CITB badges demonstrate our commitment to safety."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Explore our comprehensive scaffolding services for all project types.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Scaffolding Hire",
        "description": "Rent reliable scaffolding for any project size, ensuring safety and efficiency."
      },
      {
        "icon": "🛠",
        "title": "Erection & Dismantling",
        "description": "Our team handles setup and takedown with precision and care."
      },
      {
        "icon": "🏰",
        "title": "Heritage Projects",
        "description": "Specialized services for preserving and restoring historical structures."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "At Expand Scaffolding, we provide safe and efficient scaffolding solutions tailored to your needs.",
      "We enhance your experience with digital solutions that streamline service delivery."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Expand Scaffolding made our project seamless with their efficient service.",
        "name": "John Stevens",
        "role": "Construction Manager",
        "avatar": "https://images.pexels.com/photos/3776969/pexels-photo-3776969.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "The team ensured safety and reliability throughout the entire project.",
        "name": "Sarah Hughes",
  ...
  "visit": {
    ...
    "description": "We serve all of London, Surrey, and Kent with expert scaffolding solutions.",
    "address": "Unavailable",
    "website": "expandscaffolding.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get a Quote",
    "title": "Contact Us for Pricing",
    "description": "Reach out today for a personalized scaffolding quote and consultation.",
    "consent": "We respect your privacy."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate Your Scaffolding Needs",
    "description": "Leverage AI to optimize scaffolding services.",
    "bullets": [
      "Instant quote requests with online forms.",
      "Automated follow-ups and scheduling.",
      "Publish reviews to enhance trust."
    ],
    "offer": "Mention Expand Scaffolding for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Expand Scaffolding delivers unforgettable experiences.",
    "address": "Unavailable",
    "email": "",
    "socials": [
      {
