const appData = {
  ...
  "hero": {
    "eyebrow": "Expert Roofing Services",
    "title": "Streamline Your Roofing and Remodeling Needs",
    "description": "Eastern Shore Roofing and Remodeling makes your project easy with instant estimates and scheduling.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our vibrant blue scheme and imagery showcase our quality work."
      },
      {
        "title": "Client Trust",
        "description": "Transparent processes ensure you know exactly what to expect."
      },
      {
        "title": "Proven Results",
        "description": "Thousands of completed projects with high satisfaction rates."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Comprehensive services for all your roofing, siding, and remodeling needs.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Roofing Services",
        "description": "From residential to commercial, we replace roofs with precision."
      },
      {
        "icon": "🏠",
        "title": "Siding Installation",
        "description": "Expert siding services to enhance your home's exterior."
      },
      {
        "icon": "🛠",
        "title": "Concrete Work",
        "description": "Driveways, sidewalks, and more with quality concrete solutions."
      }
    ]
  },
  "story": {
    ...
    "paragraphs": [
      "Eastern Shore Roofing and Remodeling delivers quality roofing, siding, and concrete services with an unwavering commitment to honesty and customer focus.",
      "As a local contractor, we understand the unique needs of Maryland's Eastern Shore community, ensuring personalized service and exceptional craftsmanship."
    ],
    "image": "https://images.pexels.com/photos/6474498/pexels-photo-6474498.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
  },
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Eastern Shore made our roof replacement seamless. Their instant scheduling was a lifesaver!",
        "name": "John D.",
        "role": "Homeowner",
        "avatar": "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=400&q=80"
      },
      {
        "quote": "The team was professional and efficient. The automated process kept us informed throughout.",
        "name": "Sarah L.",
  ...
  "visit": {
    "eyebrow": "Visit Us",
    "title": "Connect with Eastern Shore",
    "description": "Explore our services on the Eastern Shore and see our quality firsthand.",
    "address": "Unavailable",
    "website": "www.easternshorerandr.com",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get Started",
    "title": "Schedule Your Consultation",
    "description": "Reach out to book your roofing or remodeling consultation today.",
    "consent": "I agree to the terms and conditions."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Revolutionize Your Experience",
    "description": "Automation streamlines processes for efficiency and satisfaction.",
    "bullets": [
      "Instant estimates and online scheduling save time.",
      "Automated follow-ups ensure timely project updates.",
      "CRM integration enhances client communication."
    ],
    "offer": "Mention Eastern Shore R&R for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Eastern Shore R&R delivers unforgettable experiences.",
    "address": "Unavailable",
    "email": "",
    "socials": [
      {
