const appData = {
  "brand": {
    "name": "Cavendish & London",
    "tagline": "Transforming spaces, creating value",
    "category": "Property Development",
    "location": "",
    "phone": ""
  },
  "hero": {
    "eyebrow": "Urban regeneration experts",
    "title": "Driving property transformation for investors",
    "description": "We deliver innovative urban regeneration, ensuring successful investments and streamlined communication for stakeholders.",
    "highlights": [
      {
    ...
    "items": [
      {
        ...
        "description": "Our projects showcase stunning architecture and refined aesthetics tailored to urban landscapes."
      },
      {
        "title": "Investor Focus",
        "description": "We prioritize investor relations with clear communications and streamlined onboarding processes."
      },
      {
        "title": "Proven Results",
        "description": "Decades of experience ensure every development meets high standards of quality and profitability."
      }
    ]
  },
  "offerings": {
    ...
    "description": "Innovative property services for investors and communities.",
    "cards": [
      {
        "icon": "🏗",
        "title": "Urban Regeneration",
        "description": "Transforming neighborhoods into vibrant communities with impactful redevelopment projects."
      },
      {
        "icon": "🏢",
        "title": "Property Development",
        "description": "Creating exceptional spaces through refurbishment and new construction tailored to market needs."
      },
      {
        "icon": "🤝",
        "title": "Investment Partnershi",
        "description": "Building strong partnerships with investors to deliver sustainable, profitable projects."
      }
    ]
  },
  "story": {
    "eyebrow": "Our journey",
    "title": "Built on transformation and trust",
    "paragraphs": [
      "Cavendish & London Property Group specializes in urban regeneration, property development, and investor partnerships. We create spaces that inspire and uplift communities.",
      "By aligning with investors and stakeholders, we bring innovative solutions to complex projects, ensuring transparency, efficiency, and long-term success."
    ],
  ...
  "testimonials": {
    ...
    "list": [
      {
        "quote": "Cavendish & London streamlined our investment process and delivered outstanding project results. Highly recommend their expertise!",
        "name": "Jane Davies",
        "role": "Institutional Investor",
        "avatar": "https://images.pexels.com/photos/34558071/pexels-photo-34558071.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
      },
      {
        "quote": "Their approach to urban regeneration is unmatched, combining innovation with community focus. A pleasure to work with.",
        "name": "Mark Thompson",
        "role": "Local Authority Representative",
        "avatar": "https://images.unsplash.com/photo-1750088292550-5893193a7def?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w4MTU1NTB8MHwxfHNlYXJjaHwxfHxQcm9wZXJ0eSUyMGRldmVsb3BtZW50JTIwJTJGJTIwVXJiYW4lMjByZWdlbmVyYXRpb24lMjBoZWFkc2hvdCUyMHBvcnRyYWl0fGVufDB8fHx8MTc2MjQzMzMzOHww&ixlib=rb-4.1.0&q=80&w=1080"
      }
    ]
  },
  "visit": {
    ...
    "description": "Discover how we transform spaces and create value. Contact us to learn more about our developments and partnerships.",
    "address": "",
    "website": "www.cavlon.co.uk",
    "mapEmbed": ""
  },
  "inquiry": {
    "eyebrow": "Get in touch",
    "title": "Partner with us",
    "description": "Contact us today to discuss investment opportunities or regeneration projects. Let’s create something exceptional together.",
    "consent": "I consent to being contacted."
  },
  "byronCallout": {
    "eyebrow": "Enablematic insight",
    "title": "Automate investor relations",
    "description": "Streamline operations with AI-powered tools tailored to property development.",
    "bullets": [
      "Deliver investor packs automatically via workflows.",
      "Integrate CRM for lead generation and nurturing.",
      "Provide secure portals for updates and reporting."
    ],
    "offer": "Mention Cavendish & London for the launch-week optimization kit.",
  ...
  "footer": {
    "blurb": "Cavendish & London delivers unforgettable experiences.",
    "address": "",
    "email": "",
    "socials": [
      {
